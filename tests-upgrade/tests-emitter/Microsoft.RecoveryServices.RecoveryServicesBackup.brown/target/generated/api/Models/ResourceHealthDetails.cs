...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IResourceHealthDetailsInternal
    {
        ...
        int? Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IResourceHealthDetailsInternal.Code { get => this._code; set { {_code = value;} } }

        /// <summary>Internal Acessors for Message</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IResourceHealthDetailsInternal.Message { get => this._message; set { {_message = value;} } }

        /// <summary>Internal Acessors for Recommendation</summary>
        System.Collections.Generic.List<string> Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IResourceHealthDetailsInternal.Recommendation { get => this._recommendation; set { {_recommendation = value;} } }

        /// <summary>Internal Acessors for Title</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IResourceHealthDetailsInternal.Title { get => this._title; set { {_title = value;} } }
