...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models
{
    ...
    public partial class LongTermSchedulePolicy :
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.ILongTermSchedulePolicy,
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.ILongTermSchedulePolicyInternal,
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.IValidates
    {
        ...
        public string Type { get => "LongTermSchedulePolicy"; set => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.ISchedulePolicyInternal)__schedulePolicy).Type = "LongTermSchedulePolicy"; }

        /// <summary>Creates an new <see cref="LongTermSchedulePolicy" /> instance.</summary>
        public LongTermSchedulePolicy()
        {
            this.__schedulePolicy.Type = "LongTermSchedulePolicy";
        }
