...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models
{
    ...
    public partial class MonthlyRetentionSchedule :
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IMonthlyRetentionSchedule,
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IMonthlyRetentionScheduleInternal
    {

        /// <summary>Internal Acessors for RetentionDuration</summary>
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IRetentionDuration Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IMonthlyRetentionScheduleInternal.RetentionDuration { get => (this._retentionDuration = this._retentionDuration ?? new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.RetentionDuration()); set { {_retentionDuration = value;} } }

        /// <summary>Internal Acessors for RetentionScheduleDaily</summary>
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IDailyRetentionFormat Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IMonthlyRetentionScheduleInternal.RetentionScheduleDaily { get => (this._retentionScheduleDaily = this._retentionScheduleDaily ?? new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.DailyRetentionFormat()); set { {_retentionScheduleDaily = value;} } }

        /// <summary>Internal Acessors for RetentionScheduleWeekly</summary>
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IWeeklyRetentionFormat Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IMonthlyRetentionScheduleInternal.RetentionScheduleWeekly { get => (this._retentionScheduleWeekly = this._retentionScheduleWeekly ?? new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.WeeklyRetentionFormat()); set { {_retentionScheduleWeekly = value;} } }
