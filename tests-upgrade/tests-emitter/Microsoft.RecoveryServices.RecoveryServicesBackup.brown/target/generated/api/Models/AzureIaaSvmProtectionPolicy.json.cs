...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models
{
    ...
    public partial class AzureIaaSvmProtectionPolicy
    {
        ...
        internal AzureIaaSvmProtectionPolicy(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonObject json)
        {
            ...
            __protectionPolicy = new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.ProtectionPolicy(json);
            {_instantRpDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonObject>("instantRPDetails"), out var __jsonInstantRpDetails) ? Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.InstantRpAdditionalDetails.FromJson(__jsonInstantRpDetails) : _instantRpDetail;}
            {_schedulePolicy = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonObject>("schedulePolicy"), out var __jsonSchedulePolicy) ? Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.SchedulePolicy.FromJson(__jsonSchedulePolicy) : _schedulePolicy;}
            {_retentionPolicy = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonObject>("retentionPolicy"), out var __jsonRetentionPolicy) ? Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.RetentionPolicy.FromJson(__jsonRetentionPolicy) : _retentionPolicy;}
            {_tieringPolicy = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonObject>("tieringPolicy"), out var __jsonTieringPolicy) ? Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.AzureIaaSvmProtectionPolicyTieringPolicy.FromJson(__jsonTieringPolicy) : _tieringPolicy;}
            {_instantRpRetentionRangeInDay = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonNumber>("instantRpRetentionRangeInDays"), out var __jsonInstantRpRetentionRangeInDays) ? (int?)__jsonInstantRpRetentionRangeInDays : _instantRpRetentionRangeInDay;}
            {_timeZone = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonString>("timeZone"), out var __jsonTimeZone) ? (string)__jsonTimeZone : (string)_timeZone;}
            ...
            {_snapshotConsistencyType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonString>("snapshotConsistencyType"), out var __jsonSnapshotConsistencyType) ? (string)__jsonSnapshotConsistencyType : (string)_snapshotConsistencyType;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IAzureIaaSvmProtectionPolicy.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IAzureIaaSvmProtectionPolicy.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IAzureIaaSvmProtectionPolicy FromJson(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonNode node)
        {
