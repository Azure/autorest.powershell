...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models
{
    ...
    public partial class AzureFileShareRestoreRequest
    {
        ...
        internal AzureFileShareRestoreRequest(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonObject json)
        {
            ...
            {_targetDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonObject>("targetDetails"), out var __jsonTargetDetails) ? Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.TargetAfsRestoreInfo.FromJson(__jsonTargetDetails) : _targetDetail;}
            ...
            {_copyOption = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonString>("copyOptions"), out var __jsonCopyOptions) ? (string)__jsonCopyOptions : (string)_copyOption;}
            {_restoreRequestType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonString>("restoreRequestType"), out var __jsonRestoreRequestType) ? (string)__jsonRestoreRequestType : (string)_restoreRequestType;}
            {_restoreFileSpec = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonArray>("restoreFileSpecs"), out var __jsonRestoreFileSpecs) ? If( __jsonRestoreFileSpecs as Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IRestoreFileSpecs>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IRestoreFileSpecs) (Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.RestoreFileSpecs.FromJson(__u) )) ))() : null : _restoreFileSpec;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IAzureFileShareRestoreRequest.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IAzureFileShareRestoreRequest.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IAzureFileShareRestoreRequest FromJson(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonNode node)
        {
