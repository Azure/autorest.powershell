...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models
{
    ...
    public partial class AzureVMResourceFeatureSupportRequest
    {
        ...
        internal AzureVMResourceFeatureSupportRequest(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonObject json)
        {
            ...
            __featureSupportRequest = new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.FeatureSupportRequest(json);
            {_vMSize = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonString>("vmSize"), out var __jsonVMSize) ? (string)__jsonVMSize : (string)_vMSize;}
            {_vMSku = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonString>("vmSku"), out var __jsonVMSku) ? (string)__jsonVMSku : (string)_vMSku;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IAzureVMResourceFeatureSupportRequest.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IAzureVMResourceFeatureSupportRequest.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IAzureVMResourceFeatureSupportRequest FromJson(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonNode node)
        {
