...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.IValidates
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IEncryptionDetails _encryptionDetail;

        /// <summary>Details needed if the VM was encrypted at the time of backup.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IEncryptionDetails EncryptionDetail { get => (this._encryptionDetail = this._encryptionDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.EncryptionDetails()); set => this._encryptionDetail = value; }
        ...
        public bool? EncryptionDetailEncryptionEnabled { get => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IEncryptionDetailsInternal)EncryptionDetail).EncryptionEnabled; set => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IEncryptionDetailsInternal)EncryptionDetail).EncryptionEnabled = value ?? default(bool); }

        /// <summary>Key Url.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.PropertyOrigin.Inlined)]
        public string EncryptionDetailKekUrl { get => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IEncryptionDetailsInternal)EncryptionDetail).KekUrl; set => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IEncryptionDetailsInternal)EncryptionDetail).KekUrl = value ?? null; }

        /// <summary>ID of Key Vault where KEK is stored.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.PropertyOrigin.Inlined)]
        public string EncryptionDetailKekVaultId { get => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IEncryptionDetailsInternal)EncryptionDetail).KekVaultId; set => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IEncryptionDetailsInternal)EncryptionDetail).KekVaultId = value ?? null; }

        /// <summary>Secret Url.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.PropertyOrigin.Inlined)]
        public string EncryptionDetailSecretKeyUrl { get => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IEncryptionDetailsInternal)EncryptionDetail).SecretKeyUrl; set => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IEncryptionDetailsInternal)EncryptionDetail).SecretKeyUrl = value ?? null; }

        /// <summary>ID of Key Vault where Secret is stored.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.PropertyOrigin.Inlined)]
        public string EncryptionDetailSecretKeyVaultId { get => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IEncryptionDetailsInternal)EncryptionDetail).SecretKeyVaultId; set => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IEncryptionDetailsInternal)EncryptionDetail).SecretKeyVaultId = value ?? null; }

        /// <summary>Backing field for <see cref="ExtendedLocation" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IExtendedLocation _extendedLocation;
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IExtendedLocation ExtendedLocation { get => (this._extendedLocation = this._extendedLocation ?? new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.ExtendedLocation()); set => this._extendedLocation = value; }

        /// <summary>Name of the extended location.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.PropertyOrigin.Inlined)]
        public string ExtendedLocationName { get => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IExtendedLocationInternal)ExtendedLocation).Name; set => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IExtendedLocationInternal)ExtendedLocation).Name = value ?? null; }

        /// <summary>Type of the extended location. Possible values include: 'EdgeZone'</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.PropertyOrigin.Inlined)]
        public string ExtendedLocationType { get => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IExtendedLocationInternal)ExtendedLocation).Type; set => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IExtendedLocationInternal)ExtendedLocation).Type = value ?? null; }

        /// <summary>Backing field for <see cref="IdentityBasedRestoreDetail" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IIdentityBasedRestoreDetails _identityBasedRestoreDetail;

        /// <summary>IaaS VM workload specific restore details for restores using managed identity.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IIdentityBasedRestoreDetails IdentityBasedRestoreDetail { get => (this._identityBasedRestoreDetail = this._identityBasedRestoreDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IdentityBasedRestoreDetails()); set => this._identityBasedRestoreDetail = value; }

        /// <summary>Gets the class type.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.PropertyOrigin.Inlined)]
        public string IdentityBasedRestoreDetailObjectType { get => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IIdentityBasedRestoreDetailsInternal)IdentityBasedRestoreDetail).ObjectType; set => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IIdentityBasedRestoreDetailsInternal)IdentityBasedRestoreDetail).ObjectType = value ?? null; }

        /// <summary>Fully qualified ARM ID of the target storage account.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.PropertyOrigin.Inlined)]
        public string IdentityBasedRestoreDetailTargetStorageAccountId { get => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IIdentityBasedRestoreDetailsInternal)IdentityBasedRestoreDetail).TargetStorageAccountId; set => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IIdentityBasedRestoreDetailsInternal)IdentityBasedRestoreDetail).TargetStorageAccountId = value ?? null; }

        /// <summary>Backing field for <see cref="IdentityInfo" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IIdentityInfo _identityInfo;

        /// <summary>Managed Identity information required to access customer storage account.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IIdentityInfo IdentityInfo { get => (this._identityInfo = this._identityInfo ?? new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IdentityInfo()); set => this._identityInfo = value; }

        /// <summary>To differentiate if the managed identity is system assigned or user assigned</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.PropertyOrigin.Inlined)]
        public bool? IdentityInfoIsSystemAssignedIdentity { get => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IIdentityInfoInternal)IdentityInfo).IsSystemAssignedIdentity; set => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IIdentityInfoInternal)IdentityInfo).IsSystemAssignedIdentity = value ?? default(bool); }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.PropertyOrigin.Inlined)]
        public string IdentityInfoManagedIdentityResourceId { get => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IIdentityInfoInternal)IdentityInfo).ManagedIdentityResourceId; set => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IIdentityInfoInternal)IdentityInfo).ManagedIdentityResourceId = value ?? null; }

        /// <summary>Internal Acessors for EncryptionDetail</summary>
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IEncryptionDetails Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IIaasVMRestoreRequestInternal.EncryptionDetail { get => (this._encryptionDetail = this._encryptionDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.EncryptionDetails()); set { {_encryptionDetail = value;} } }

        /// <summary>Internal Acessors for ExtendedLocation</summary>
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IExtendedLocation Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IIaasVMRestoreRequestInternal.ExtendedLocation { get => (this._extendedLocation = this._extendedLocation ?? new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.ExtendedLocation()); set { {_extendedLocation = value;} } }

        /// <summary>Internal Acessors for IdentityBasedRestoreDetail</summary>
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IIdentityBasedRestoreDetails Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IIaasVMRestoreRequestInternal.IdentityBasedRestoreDetail { get => (this._identityBasedRestoreDetail = this._identityBasedRestoreDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IdentityBasedRestoreDetails()); set { {_identityBasedRestoreDetail = value;} } }

        /// <summary>Internal Acessors for IdentityInfo</summary>
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IIdentityInfo Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IIaasVMRestoreRequestInternal.IdentityInfo { get => (this._identityInfo = this._identityInfo ?? new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IdentityInfo()); set { {_identityInfo = value;} } }

        /// <summary>Internal Acessors for SecuredVMDetail</summary>
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.ISecuredVMDetails Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IIaasVMRestoreRequestInternal.SecuredVMDetail { get => (this._securedVMDetail = this._securedVMDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.SecuredVMDetails()); set { {_securedVMDetail = value;} } }

        /// <summary>Internal Acessors for TargetDiskNetworkAccessSetting</summary>
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.ITargetDiskNetworkAccessSettings Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IIaasVMRestoreRequestInternal.TargetDiskNetworkAccessSetting { get => (this._targetDiskNetworkAccessSetting = this._targetDiskNetworkAccessSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.TargetDiskNetworkAccessSettings()); set { {_targetDiskNetworkAccessSetting = value;} } }
        ...
        public string ObjectType { get => "IaasVMRestoreRequest"; set => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IRestoreRequestInternal)__restoreRequest).ObjectType = "IaasVMRestoreRequest"; }
        ...
        private System.Collections.Generic.List<int> _restoreDiskLunList;

        /// <summary>List of Disk LUNs for partial restore</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<int> RestoreDiskLunList { get => this._restoreDiskLunList; set => this._restoreDiskLunList = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.ISecuredVMDetails _securedVMDetail;

        /// <summary>Stores Secured VM Details</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.ISecuredVMDetails SecuredVMDetail { get => (this._securedVMDetail = this._securedVMDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.SecuredVMDetails()); set => this._securedVMDetail = value; }

        /// <summary>Gets or Sets Disk Encryption Set Id for Secured VM OS Disk</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.PropertyOrigin.Inlined)]
        public string SecuredVMDetailSecuredVmosdiskEncryptionSetId { get => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.ISecuredVMDetailsInternal)SecuredVMDetail).SecuredVmosDiskEncryptionSetId; set => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.ISecuredVMDetailsInternal)SecuredVMDetail).SecuredVmosDiskEncryptionSetId = value ?? null; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.ITargetDiskNetworkAccessSettings _targetDiskNetworkAccessSetting;

        /// <summary>Specifies target network access settings for disks of VM to be restored,</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.ITargetDiskNetworkAccessSettings TargetDiskNetworkAccessSetting { get => (this._targetDiskNetworkAccessSetting = this._targetDiskNetworkAccessSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.TargetDiskNetworkAccessSettings()); set => this._targetDiskNetworkAccessSetting = value; }
        ...
        {
            this.__restoreRequest.ObjectType = "IaasVMRestoreRequest";
        }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IRestoreRequest
    {
        ...
        System.Collections.Generic.List<int> RestoreDiskLunList { get; set; }
        /// <summary>Flag to denote of an Unmanaged disk VM should be restored with Managed disks.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.PSArgumentCompleterAttribute("SameAsOnSourceDisks", "EnablePrivateAccessForAllDisks", "EnablePublicAccessForAllDisks")]
        string TargetDiskNetworkAccessSettingTargetDiskNetworkAccessOption { get; set; }
        /// <summary>
        /// Fully qualified ARM ID of the domain name to be associated to the VM being restored. This applies only to Classic
        /// Virtual Machines.
        /// </summary>
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IRestoreRequestInternal
    {
        ...
        string DiskEncryptionSetId { get; set; }
        /// <summary>Details needed if the VM was encrypted at the time of backup.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IEncryptionDetails EncryptionDetail { get; set; }
        /// <summary>
        /// Identifies whether this backup copy represents an encrypted VM at the time of backup.
        /// </summary>
        bool? EncryptionDetailEncryptionEnabled { get; set; }
        ...
        /// should be null if restore is to be done in public cloud
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IExtendedLocation ExtendedLocation { get; set; }
        /// <summary>Name of the extended location.</summary>
        string ExtendedLocationName { get; set; }
        /// <summary>Type of the extended location. Possible values include: 'EdgeZone'</summary>
        string ExtendedLocationType { get; set; }
        /// <summary>IaaS VM workload specific restore details for restores using managed identity.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IIdentityBasedRestoreDetails IdentityBasedRestoreDetail { get; set; }
        /// <summary>Gets the class type.</summary>
        string IdentityBasedRestoreDetailObjectType { get; set; }
        /// <summary>Fully qualified ARM ID of the target storage account.</summary>
        string IdentityBasedRestoreDetailTargetStorageAccountId { get; set; }
        /// <summary>Managed Identity information required to access customer storage account.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IIdentityInfo IdentityInfo { get; set; }
        /// <summary>To differentiate if the managed identity is system assigned or user assigned</summary>
        bool? IdentityInfoIsSystemAssignedIdentity { get; set; }
        /// <summary>
        /// Managed Identity Resource Id
        ...
        bool? RestoreWithManagedDisk { get; set; }
        /// <summary>Stores Secured VM Details</summary>
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.ISecuredVMDetails SecuredVMDetail { get; set; }
        /// <summary>Gets or Sets Disk Encryption Set Id for Secured VM OS Disk</summary>
        string SecuredVMDetailSecuredVmosdiskEncryptionSetId { get; set; }
        /// <summary>Fully qualified ARM ID of the VM which is being recovered.</summary>
        string SourceResourceId { get; set; }
        ...
        string SubnetId { get; set; }
        /// <summary>Specifies target network access settings for disks of VM to be restored,</summary>
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.ITargetDiskNetworkAccessSettings TargetDiskNetworkAccessSetting { get; set; }
        /// <summary>
        /// Gets or sets the ARM resource ID of the target disk access to be used when TargetDiskNetworkAccessOption is set to TargetDiskNetworkAccessOption.UseNew
        /// </summary>
        string TargetDiskNetworkAccessSettingTargetDiskAccessId { get; set; }
