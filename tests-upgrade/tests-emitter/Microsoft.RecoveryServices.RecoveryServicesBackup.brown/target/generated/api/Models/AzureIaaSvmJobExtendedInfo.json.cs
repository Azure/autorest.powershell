...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models
{
    ...
    public partial class AzureIaaSvmJobExtendedInfo
    {
        ...
        internal AzureIaaSvmJobExtendedInfo(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonObject json)
        {
            ...
            {_tasksList = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonArray>("tasksList"), out var __jsonTasksList) ? If( __jsonTasksList as Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IAzureIaaSvmJobTaskDetails>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IAzureIaaSvmJobTaskDetails) (Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.AzureIaaSvmJobTaskDetails.FromJson(__u) )) ))() : null : _tasksList;}
            {_propertyBag = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonObject>("propertyBag"), out var __jsonPropertyBag) ? Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.AzureIaaSvmJobExtendedInfoPropertyBag.FromJson(__jsonPropertyBag) : _propertyBag;}
            {_internalPropertyBag = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonObject>("internalPropertyBag"), out var __jsonInternalPropertyBag) ? Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.AzureIaaSvmJobExtendedInfoInternalPropertyBag.FromJson(__jsonInternalPropertyBag) : _internalPropertyBag;}
            {_progressPercentage = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonNumber>("progressPercentage"), out var __jsonProgressPercentage) ? (double?)__jsonProgressPercentage : _progressPercentage;}
            {_estimatedRemainingDuration = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonString>("estimatedRemainingDuration"), out var __jsonEstimatedRemainingDuration) ? (string)__jsonEstimatedRemainingDuration : (string)_estimatedRemainingDuration;}
            {_dynamicErrorMessage = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonString>("dynamicErrorMessage"), out var __jsonDynamicErrorMessage) ? (string)__jsonDynamicErrorMessage : (string)_dynamicErrorMessage;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IAzureIaaSvmJobExtendedInfo.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IAzureIaaSvmJobExtendedInfo.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IAzureIaaSvmJobExtendedInfo FromJson(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Json.JsonNode node)
        {
