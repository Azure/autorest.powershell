...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzRecoveryServicesBackupSecurityPiN_GetExpanded", SupportsShouldProcess = true)]
    ...
    public partial class GetAzRecoveryServicesBackupSecurityPiN_GetExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzRecoveryServicesBackupSecurityPiN_GetExpanded" /> cmdlet class.
        /// </summary>
        public GetAzRecoveryServicesBackupSecurityPiN_GetExpanded()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.SecurityPiNsGet(SubscriptionId, ResourceGroupName, VaultName, this.InvocationInformation.BoundParameters.ContainsKey("XmsAuthorizationAuxiliary") ? XmsAuthorizationAuxiliary : null, _parametersBody, onOk, onDefault, this, Pipeline);
