...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Start, @"AzRecoveryServicesBackup_TriggerViaIdentityVaultExpanded", SupportsShouldProcess = true)]
    ...
    public partial class StartAzRecoveryServicesBackup_TriggerViaIdentityVaultExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.IContext
    {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (VaultInputObject?.Id != null)
                    {
                        ...
                        await this.Client.BackupsTriggerViaIdentity(VaultInputObject.Id, _parametersBody, onAccepted, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.BackupsTrigger(VaultInputObject.SubscriptionId ?? null, VaultInputObject.ResourceGroupName ?? null, VaultInputObject.VaultName ?? null, FabricName, ContainerName, ProtectedItemName, _parametersBody, onAccepted, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StartAzRecoveryServicesBackup_TriggerViaIdentityVaultExpanded" /> cmdlet
        /// class.
        /// </summary>
        public StartAzRecoveryServicesBackup_TriggerViaIdentityVaultExpanded()
        {
