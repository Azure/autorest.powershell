...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzRecoveryServicesBackupProtectionContainerRefreshOperationResult_GetViaIdentityVault")]
    ...
    public partial class GetAzRecoveryServicesBackupProtectionContainerRefreshOperationResult_GetViaIdentityVault : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzRecoveryServicesBackupProtectionContainerRefreshOperationResult_GetViaIdentityVault"
        /// /> cmdlet class.
        /// </summary>
        public GetAzRecoveryServicesBackupProtectionContainerRefreshOperationResult_GetViaIdentityVault()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.VaultInputObject.Id += $"/backupFabrics/{(global::System.Uri.EscapeDataString(this.FabricName.ToString()))}/operationResults/{(global::System.Uri.EscapeDataString(this.OperationId.ToString()))}";
                        await this.Client.ProtectionContainerRefreshOperationResultsGetViaIdentity(VaultInputObject.Id, onAccepted, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ProtectionContainerRefreshOperationResultsGet(VaultInputObject.SubscriptionId ?? null, VaultInputObject.ResourceGroupName ?? null, VaultInputObject.VaultName ?? null, FabricName, OperationId, onAccepted, onNoContent, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { FabricName=FabricName,OperationId=OperationId})
                    {
