...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Start, @"AzRecoveryServicesBackupRestore_TriggerViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class StartAzRecoveryServicesBackupRestore_TriggerViaIdentity : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.IContext
    {
        ...
        /// <returns>a duplicate instance of StartAzRecoveryServicesBackupRestore_TriggerViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Cmdlets.StartAzRecoveryServicesBackupRestore_TriggerViaIdentity Clone()
        {
            var clone = new StartAzRecoveryServicesBackupRestore_TriggerViaIdentity();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.RestoresTriggerViaIdentity(InputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("XmsAuthorizationAuxiliary") ? XmsAuthorizationAuxiliary : null, Parameter, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.RestoresTrigger(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.VaultName ?? null, InputObject.FabricName ?? null, InputObject.ContainerName ?? null, InputObject.ProtectedItemName ?? null, InputObject.RecoveryPointId ?? null, this.InvocationInformation.BoundParameters.ContainsKey("XmsAuthorizationAuxiliary") ? XmsAuthorizationAuxiliary : null, Parameter, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StartAzRecoveryServicesBackupRestore_TriggerViaIdentity" /> cmdlet class.
        /// </summary>
        public StartAzRecoveryServicesBackupRestore_TriggerViaIdentity()
        {
