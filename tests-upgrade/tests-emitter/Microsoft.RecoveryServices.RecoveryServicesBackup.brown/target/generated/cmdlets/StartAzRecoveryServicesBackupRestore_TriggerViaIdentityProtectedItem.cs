...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Trigger=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupFabrics/{fabricName}/protectionContainers/{containerName}/protectedItems/{protectedItemName}/recoveryPoints/{recoveryPointId}/restore"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Start, @"AzRecoveryServicesBackupRestore_TriggerViaIdentityProtectedItem", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Description(@"Restores the specified backed up data. This is an asynchronous operation. To know the status of this API call, use\nGetProtectedItemOperationResult API.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupFabrics/{fabricName}/protectionContainers/{containerName}/protectedItems/{protectedItemName}/recoveryPoints/{recoveryPointId}/restore", ApiVersion = "2025-08-01")]
    public partial class StartAzRecoveryServicesBackupRestore_TriggerViaIdentityProtectedItem : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IRestoreRequestResource _parameter;

        /// <summary>
        /// Base class for restore request. Workload-specific restore requests are derived from this class.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Base class for restore request. Workload-specific restore requests are derived from this class.", ValueFromPipeline = true)]
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IRestoreRequestResource) })]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IRestoreRequestResource Parameter { get => this._parameter; set => this._parameter = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IRecoveryServicesBackupIdentity _protectedItemInputObject;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IRecoveryServicesBackupIdentity ProtectedItemInputObject { get => this._protectedItemInputObject; set => this._protectedItemInputObject = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "RecoveryPointID represents the backed up data to be fetched.")]
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// <returns>
        /// a duplicate instance of StartAzRecoveryServicesBackupRestore_TriggerViaIdentityProtectedItem
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Cmdlets.StartAzRecoveryServicesBackupRestore_TriggerViaIdentityProtectedItem Clone()
        {
            var clone = new StartAzRecoveryServicesBackupRestore_TriggerViaIdentityProtectedItem();
            ...
            clone.RecoveryPointId = this.RecoveryPointId;
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'RestoresTrigger' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.ProtectedItemInputObject.Id += $"/recoveryPoints/{(global::System.Uri.EscapeDataString(this.RecoveryPointId.ToString()))}";
                        await this.Client.RestoresTriggerViaIdentity(ProtectedItemInputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("XmsAuthorizationAuxiliary") ? XmsAuthorizationAuxiliary : null, Parameter, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        if (null == ProtectedItemInputObject.FabricName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("ProtectedItemInputObject has null value for ProtectedItemInputObject.FabricName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, ProtectedItemInputObject) );
                        }
                        if (null == ProtectedItemInputObject.ContainerName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("ProtectedItemInputObject has null value for ProtectedItemInputObject.ContainerName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, ProtectedItemInputObject) );
                        }
                        ...
                        await this.Client.RestoresTrigger(ProtectedItemInputObject.SubscriptionId ?? null, ProtectedItemInputObject.ResourceGroupName ?? null, ProtectedItemInputObject.VaultName ?? null, ProtectedItemInputObject.FabricName ?? null, ProtectedItemInputObject.ContainerName ?? null, ProtectedItemInputObject.ProtectedItemName ?? null, RecoveryPointId, this.InvocationInformation.BoundParameters.ContainsKey("XmsAuthorizationAuxiliary") ? XmsAuthorizationAuxiliary : null, Parameter, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { RecoveryPointId=RecoveryPointId,XmsAuthorizationAuxiliary=this.InvocationInformation.BoundParameters.ContainsKey("XmsAuthorizationAuxiliary") ? XmsAuthorizationAuxiliary : null})
                    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StartAzRecoveryServicesBackupRestore_TriggerViaIdentityProtectedItem" />
        /// cmdlet class.
        /// </summary>
        public StartAzRecoveryServicesBackupRestore_TriggerViaIdentityProtectedItem()
        {
