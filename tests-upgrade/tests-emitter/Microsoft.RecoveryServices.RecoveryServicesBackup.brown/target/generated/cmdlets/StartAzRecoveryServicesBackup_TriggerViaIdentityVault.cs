...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Start, @"AzRecoveryServicesBackup_TriggerViaIdentityVault", SupportsShouldProcess = true)]
    ...
    public partial class StartAzRecoveryServicesBackup_TriggerViaIdentityVault : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.IContext
    {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.VaultInputObject.Id += $"/backupFabrics/{(global::System.Uri.EscapeDataString(this.FabricName.ToString()))}/protectionContainers/{(global::System.Uri.EscapeDataString(this.ContainerName.ToString()))}/protectedItems/{(global::System.Uri.EscapeDataString(this.ProtectedItemName.ToString()))}";
                        await this.Client.BackupsTriggerViaIdentity(VaultInputObject.Id, Parameter, onAccepted, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.BackupsTrigger(VaultInputObject.SubscriptionId ?? null, VaultInputObject.ResourceGroupName ?? null, VaultInputObject.VaultName ?? null, FabricName, ContainerName, ProtectedItemName, Parameter, onAccepted, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { FabricName=FabricName,ContainerName=ContainerName,ProtectedItemName=ProtectedItemName})
                    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StartAzRecoveryServicesBackup_TriggerViaIdentityVault" /> cmdlet class.
        /// </summary>
        public StartAzRecoveryServicesBackup_TriggerViaIdentityVault()
        {
