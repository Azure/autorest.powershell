...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupFabrics/{fabricName}/operationResults/{operationId}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzRecoveryServicesBackupProtectionContainerRefreshOperationResult_GetViaIdentityBackupFabric")]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Description(@"Provides the result of the refresh operation triggered by the BeginRefresh operation.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupFabrics/{fabricName}/operationResults/{operationId}", ApiVersion = "2025-08-01")]
    public partial class GetAzRecoveryServicesBackupProtectionContainerRefreshOperationResult_GetViaIdentityBackupFabric : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.IContext
    {
        ...
        /// <summary>Operation ID associated with the operation whose result needs to be fetched.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Operation ID associated with the operation whose result needs to be fetched.")]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzRecoveryServicesBackupProtectionContainerRefreshOperationResult_GetViaIdentityBackupFabric"
        /// /> cmdlet class.
        /// </summary>
        public GetAzRecoveryServicesBackupProtectionContainerRefreshOperationResult_GetViaIdentityBackupFabric()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.BackupFabricInputObject.Id += $"/operationResults/{(global::System.Uri.EscapeDataString(this.OperationId.ToString()))}";
                        await this.Client.ProtectionContainerRefreshOperationResultsGetViaIdentity(BackupFabricInputObject.Id, onAccepted, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ProtectionContainerRefreshOperationResultsGet(BackupFabricInputObject.SubscriptionId ?? null, BackupFabricInputObject.ResourceGroupName ?? null, BackupFabricInputObject.VaultName ?? null, BackupFabricInputObject.FabricName ?? null, OperationId, onAccepted, onNoContent, onDefault, this, Pipeline);
                    }
