...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Cmdlets
{
    ...
    /// [OpenAPI] CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupPolicies/{policyName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzRecoveryServicesBackupProtectionPolicy_UpdateViaIdentityVaultExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Description(@"update or modifies a backup policy. This is an asynchronous operation. Status of the operation can be fetched\nusing GetPolicyOperationResult API.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Generated]
    public partial class UpdateAzRecoveryServicesBackupProtectionPolicy_UpdateViaIdentityVaultExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.IContext
    {
        ...
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IProtectionPolicyResource _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.ProtectionPolicyResource();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Number of items associated with this policy.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Category(global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public int ProtectedItemsCount { get => _parametersBody.ProtectedItemsCount ?? default(int); set => _parametersBody.ProtectedItemsCount = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "ResourceGuard Operation Requests")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Category(global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        SerializedName = @"tags",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IProtectionPolicyResourceTags) })]
        public Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IProtectionPolicyResourceTags Tag { get => _parametersBody.Tag ?? null /* object */; set => _parametersBody.Tag = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ProtectionPoliciesCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.VaultInputObject.Id += $"/backupPolicies/{(global::System.Uri.EscapeDataString(this.PolicyName.ToString()))}";
                        _parametersBody = await this.Client.ProtectionPoliciesGetViaIdentityWithResult(VaultInputObject.Id, this, Pipeline);
                        this.Update_parametersBody();
                        await this.Client.ProtectionPoliciesCreateOrUpdateViaIdentity(VaultInputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("XmsAuthorizationAuxiliary") ? XmsAuthorizationAuxiliary : null, _parametersBody, onOk, onAccepted, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _parametersBody = await this.Client.ProtectionPoliciesGetWithResult(VaultInputObject.SubscriptionId ?? null, VaultInputObject.ResourceGroupName ?? null, VaultInputObject.VaultName ?? null, PolicyName, this, Pipeline);
                        this.Update_parametersBody();
                        await this.Client.ProtectionPoliciesCreateOrUpdate(VaultInputObject.SubscriptionId ?? null, VaultInputObject.ResourceGroupName ?? null, VaultInputObject.VaultName ?? null, PolicyName, this.InvocationInformation.BoundParameters.ContainsKey("XmsAuthorizationAuxiliary") ? XmsAuthorizationAuxiliary : null, _parametersBody, onOk, onAccepted, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.SerializationMode.IncludeUpdate);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { PolicyName=PolicyName,XmsAuthorizationAuxiliary=this.InvocationInformation.BoundParameters.ContainsKey("XmsAuthorizationAuxiliary") ? XmsAuthorizationAuxiliary : null})
                    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzRecoveryServicesBackupProtectionPolicy_UpdateViaIdentityVaultExpanded"
        /// /> cmdlet class.
        /// </summary>
        public UpdateAzRecoveryServicesBackupProtectionPolicy_UpdateViaIdentityVaultExpanded()
        {
        ...
        private void Update_parametersBody()
        {
            ...
            {
                this.Tag = (Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IProtectionPolicyResourceTags)(this.MyInvocation?.BoundParameters["Tag"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("ETag")))
            {
                this.ETag = (string)(this.MyInvocation?.BoundParameters["ETag"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("ProtectedItemsCount")))
            {
                this.ProtectedItemsCount = (int)(this.MyInvocation?.BoundParameters["ProtectedItemsCount"]);
            }
