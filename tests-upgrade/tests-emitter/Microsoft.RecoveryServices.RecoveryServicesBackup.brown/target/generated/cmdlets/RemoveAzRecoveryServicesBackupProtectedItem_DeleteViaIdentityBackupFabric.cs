...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Delete=>DELETE:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupFabrics/{fabricName}/protectionContainers/{containerName}/protectedItems/{protectedItemName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzRecoveryServicesBackupProtectedItem_DeleteViaIdentityBackupFabric", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Description(@"Used to disable backup of an item within a container. This is an asynchronous operation. To know the status of the\nrequest, call the GetItemOperationResult API.")]
    ...
    public partial class RemoveAzRecoveryServicesBackupProtectedItem_DeleteViaIdentityBackupFabric : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.IContext
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ProtectedItemsDelete' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.BackupFabricInputObject.Id += $"/protectionContainers/{(global::System.Uri.EscapeDataString(this.ContainerName.ToString()))}/protectedItems/{(global::System.Uri.EscapeDataString(this.Name.ToString()))}";
                        await this.Client.ProtectedItemsDeleteViaIdentity(BackupFabricInputObject.Id, onOk, onAccepted, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ProtectedItemsDelete(BackupFabricInputObject.SubscriptionId ?? null, BackupFabricInputObject.ResourceGroupName ?? null, BackupFabricInputObject.VaultName ?? null, BackupFabricInputObject.FabricName ?? null, ContainerName, Name, onOk, onAccepted, onNoContent, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ContainerName=ContainerName,Name=Name})
                    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveAzRecoveryServicesBackupProtectedItem_DeleteViaIdentityBackupFabric"
        /// /> cmdlet class.
        /// </summary>
        public RemoveAzRecoveryServicesBackupProtectedItem_DeleteViaIdentityBackupFabric()
        {
