...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Cmdlets
{
    ...
    /// failed. You can refer to the Operation Status enum for all the possible states of an operation. Some operations\nget jobs.
    /// This method returns the list of jobs associated with operation.
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupPolicies/{policyName}/operations/{operationId}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzRecoveryServicesBackupProtectionPolicyOperationStatuses_GetViaIdentityBackupPolicy")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Description(@"Provides the status of the asynchronous operations like backup, restore. The status can be in progress, completed\nor failed. You can refer to the Operation Status enum for all the possible states of an operation. Some operations\nget jobs. This method returns the list of jobs associated with operation.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupPolicies/{policyName}/operations/{operationId}", ApiVersion = "2025-08-01")]
    public partial class GetAzRecoveryServicesBackupProtectionPolicyOperationStatuses_GetViaIdentityBackupPolicy : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.IContext
    {
        ...
        /// <summary>Backing field for <see cref="BackupPolicyInputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IRecoveryServicesBackupIdentity _backupPolicyInputObject;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IRecoveryServicesBackupIdentity BackupPolicyInputObject { get => this._backupPolicyInputObject; set => this._backupPolicyInputObject = value; }
        ...
        /// <summary>The name of the ProtectionPolicyResource</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the ProtectionPolicyResource")]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzRecoveryServicesBackupProtectionPolicyOperationStatuses_GetViaIdentityBackupPolicy"
        /// /> cmdlet class.
        /// </summary>
        public GetAzRecoveryServicesBackupProtectionPolicyOperationStatuses_GetViaIdentityBackupPolicy()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (BackupPolicyInputObject?.Id != null)
                    {
                        this.BackupPolicyInputObject.Id += $"/operations/{(global::System.Uri.EscapeDataString(this.OperationId.ToString()))}";
                        await this.Client.ProtectionPolicyOperationStatusesGetViaIdentity(BackupPolicyInputObject.Id, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == BackupPolicyInputObject.SubscriptionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("BackupPolicyInputObject has null value for BackupPolicyInputObject.SubscriptionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, BackupPolicyInputObject) );
                        }
                        if (null == BackupPolicyInputObject.ResourceGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("BackupPolicyInputObject has null value for BackupPolicyInputObject.ResourceGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, BackupPolicyInputObject) );
                        }
                        if (null == BackupPolicyInputObject.VaultName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("BackupPolicyInputObject has null value for BackupPolicyInputObject.VaultName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, BackupPolicyInputObject) );
                        }
                        if (null == BackupPolicyInputObject.PolicyName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("BackupPolicyInputObject has null value for BackupPolicyInputObject.PolicyName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, BackupPolicyInputObject) );
                        }
                        await this.Client.ProtectionPolicyOperationStatusesGet(BackupPolicyInputObject.SubscriptionId ?? null, BackupPolicyInputObject.ResourceGroupName ?? null, BackupPolicyInputObject.VaultName ?? null, BackupPolicyInputObject.PolicyName ?? null, OperationId, onOk, onDefault, this, Pipeline);
                    }
