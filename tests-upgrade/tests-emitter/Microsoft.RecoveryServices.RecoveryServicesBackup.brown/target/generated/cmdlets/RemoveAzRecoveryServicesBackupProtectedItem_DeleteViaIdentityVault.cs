...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzRecoveryServicesBackupProtectedItem_DeleteViaIdentityVault", SupportsShouldProcess = true)]
    ...
    public partial class RemoveAzRecoveryServicesBackupProtectedItem_DeleteViaIdentityVault : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.IContext
    {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.VaultInputObject.Id += $"/backupFabrics/{(global::System.Uri.EscapeDataString(this.FabricName.ToString()))}/protectionContainers/{(global::System.Uri.EscapeDataString(this.ContainerName.ToString()))}/protectedItems/{(global::System.Uri.EscapeDataString(this.Name.ToString()))}";
                        await this.Client.ProtectedItemsDeleteViaIdentity(VaultInputObject.Id, onOk, onAccepted, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ProtectedItemsDelete(VaultInputObject.SubscriptionId ?? null, VaultInputObject.ResourceGroupName ?? null, VaultInputObject.VaultName ?? null, FabricName, ContainerName, Name, onOk, onAccepted, onNoContent, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { FabricName=FabricName,ContainerName=ContainerName,Name=Name})
                    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveAzRecoveryServicesBackupProtectedItem_DeleteViaIdentityVault" /> cmdlet
        /// class.
        /// </summary>
        public RemoveAzRecoveryServicesBackupProtectedItem_DeleteViaIdentityVault()
        {
