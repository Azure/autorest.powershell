...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsSecurity.Revoke, @"AzRecoveryServicesBackupItemLevelRecoveryConnection_RevokeViaIdentityVault", SupportsShouldProcess = true)]
    ...
    public partial class RevokeAzRecoveryServicesBackupItemLevelRecoveryConnection_RevokeViaIdentityVault : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.IContext
    {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (VaultInputObject?.Id != null)
                    {
                        ...
                        await this.Client.ItemLevelRecoveryConnectionsRevokeViaIdentity(VaultInputObject.Id, onAccepted, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ItemLevelRecoveryConnectionsRevoke(VaultInputObject.SubscriptionId ?? null, VaultInputObject.ResourceGroupName ?? null, VaultInputObject.VaultName ?? null, FabricName, ContainerName, ProtectedItemName, RecoveryPointId, onAccepted, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RevokeAzRecoveryServicesBackupItemLevelRecoveryConnection_RevokeViaIdentityVault"
        /// /> cmdlet class.
        /// </summary>
        public RevokeAzRecoveryServicesBackupItemLevelRecoveryConnection_RevokeViaIdentityVault()
        {
