...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] BmsPrepareDataMove=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupstorageconfig/vaultstorageconfig/prepareDataMove"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzRecoveryServicesBackupPrepare_PrepareViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Description(@"Prepares source vault for Data Move operation")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupstorageconfig/vaultstorageconfig/prepareDataMove", ApiVersion = "2025-08-01")]
    public partial class InvokeAzRecoveryServicesBackupPrepare_PrepareViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IPrepareDataMoveRequest _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.PrepareDataMoveRequest();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "DataMove Level")]
        ...
        public string DataMoveLevel { get => _parametersBody.DataMoveLevel ?? null; set => _parametersBody.DataMoveLevel = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Ignore the artifacts which are already moved.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Category(global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public global::System.Management.Automation.SwitchParameter IgnoreMoved { get => _parametersBody.IgnoreMoved ?? default(global::System.Management.Automation.SwitchParameter); set => _parametersBody.IgnoreMoved = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Source Container ArmIdsThis needs to be populated only if DataMoveLevel is set to container")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Category(global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Info(
        Required = false,
        ReadOnly = false,
        Description = @"Source Container ArmIdsThis needs to be populated only if DataMoveLevel is set to container",
        SerializedName = @"sourceContainerArmIds",
        PossibleTypes = new [] { typeof(string) })]
        public string[] SourceContainerArmId { get => _parametersBody.SourceContainerArmId?.ToArray() ?? null /* fixedArrayOf */; set => _parametersBody.SourceContainerArmId = (value != null ? new System.Collections.Generic.List<string>(value) : null); }

        /// <summary>Target Region</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Target Region")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Category(global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string TargetRegion { get => _parametersBody.TargetRegion ?? null; set => _parametersBody.TargetRegion = value; }

        /// <summary>ARM Id of target vault</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "ARM Id of target vault")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Category(global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// <returns>
        /// a duplicate instance of InvokeAzRecoveryServicesBackupPrepare_PrepareViaIdentityExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Cmdlets.InvokeAzRecoveryServicesBackupPrepare_PrepareViaIdentityExpanded Clone()
        {
            var clone = new InvokeAzRecoveryServicesBackupPrepare_PrepareViaIdentityExpanded();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InvokeAzRecoveryServicesBackupPrepare_PrepareViaIdentityExpanded" /> cmdlet
        /// class.
        /// </summary>
        public InvokeAzRecoveryServicesBackupPrepare_PrepareViaIdentityExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'BmsPrepareDataMove' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.BmsPrepareDataMoveViaIdentity(InputObject.Id, _parametersBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.BmsPrepareDataMove(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.VaultName ?? null, _parametersBody, onOk, onDefault, this, Pipeline);
                    }
