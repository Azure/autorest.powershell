...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Unregister, @"AzRecoveryServicesBackupProtectionContainer_UnregisterViaIdentityVault", SupportsShouldProcess = true)]
    ...
    public partial class UnregisterAzRecoveryServicesBackupProtectionContainer_UnregisterViaIdentityVault : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.IContext
    {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (VaultInputObject?.Id != null)
                    {
                        ...
                        await this.Client.ProtectionContainersUnregisterViaIdentity(VaultInputObject.Id, onOk, onAccepted, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ProtectionContainersUnregister(VaultInputObject.SubscriptionId ?? null, VaultInputObject.ResourceGroupName ?? null, VaultInputObject.VaultName ?? null, FabricName, ContainerName, onOk, onAccepted, onNoContent, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UnregisterAzRecoveryServicesBackupProtectionContainer_UnregisterViaIdentityVault"
        /// /> cmdlet class.
        /// </summary>
        public UnregisterAzRecoveryServicesBackupProtectionContainer_UnregisterViaIdentityVault()
        {
