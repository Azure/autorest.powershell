...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Trigger=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupFabrics/{fabricName}/protectionContainers/{containerName}/protectedItems/{protectedItemName}/backup"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Start, @"AzRecoveryServicesBackup_TriggerViaIdentityBackupFabric", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Description(@"Triggers backup for specified backed up item. This is an asynchronous operation. To know the status of the\noperation, call GetProtectedItemOperationResult API.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupFabrics/{fabricName}/protectionContainers/{containerName}/protectedItems/{protectedItemName}/backup", ApiVersion = "2025-08-01")]
    public partial class StartAzRecoveryServicesBackup_TriggerViaIdentityBackupFabric : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IBackupRequestResource _parameter;

        /// <summary>
        /// Base class for backup request. Workload-specific backup requests are derived from this class.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Base class for backup request. Workload-specific backup requests are derived from this class.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Base class for backup request. Workload-specific backup requests are derived from this class.",
        SerializedName = @"parameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IBackupRequestResource) })]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IBackupRequestResource Parameter { get => this._parameter; set => this._parameter = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'BackupsTrigger' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.BackupFabricInputObject.Id += $"/protectionContainers/{(global::System.Uri.EscapeDataString(this.ContainerName.ToString()))}/protectedItems/{(global::System.Uri.EscapeDataString(this.ProtectedItemName.ToString()))}";
                        await this.Client.BackupsTriggerViaIdentity(BackupFabricInputObject.Id, Parameter, onAccepted, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.BackupsTrigger(BackupFabricInputObject.SubscriptionId ?? null, BackupFabricInputObject.ResourceGroupName ?? null, BackupFabricInputObject.VaultName ?? null, BackupFabricInputObject.FabricName ?? null, ContainerName, ProtectedItemName, Parameter, onAccepted, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ContainerName=ContainerName,ProtectedItemName=ProtectedItemName})
                    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StartAzRecoveryServicesBackup_TriggerViaIdentityBackupFabric" /> cmdlet class.
        /// </summary>
        public StartAzRecoveryServicesBackup_TriggerViaIdentityBackupFabric()
        {
