...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Move, @"AzRecoveryServicesBackupRecoveryPoint_MoveViaIdentityBackupFabricExpanded", SupportsShouldProcess = true)]
    ...
    public partial class MoveAzRecoveryServicesBackupRecoveryPoint_MoveViaIdentityBackupFabricExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.IContext
    {
        ...
        /// <returns>
        /// a duplicate instance of MoveAzRecoveryServicesBackupRecoveryPoint_MoveViaIdentityBackupFabricExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Cmdlets.MoveAzRecoveryServicesBackupRecoveryPoint_MoveViaIdentityBackupFabricExpanded Clone()
        {
            var clone = new MoveAzRecoveryServicesBackupRecoveryPoint_MoveViaIdentityBackupFabricExpanded();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MoveAzRecoveryServicesBackupRecoveryPoint_MoveViaIdentityBackupFabricExpanded"
        /// /> cmdlet class.
        /// </summary>
        public MoveAzRecoveryServicesBackupRecoveryPoint_MoveViaIdentityBackupFabricExpanded()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.BackupFabricInputObject.Id += $"/protectionContainers/{(global::System.Uri.EscapeDataString(this.ContainerName.ToString()))}/protectedItems/{(global::System.Uri.EscapeDataString(this.ProtectedItemName.ToString()))}/recoveryPoints/{(global::System.Uri.EscapeDataString(this.Id.ToString()))}";
                        await this.Client.MoveRecoveryPointViaIdentity(BackupFabricInputObject.Id, _parametersBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.MoveRecoveryPoint(BackupFabricInputObject.SubscriptionId ?? null, BackupFabricInputObject.ResourceGroupName ?? null, BackupFabricInputObject.VaultName ?? null, BackupFabricInputObject.FabricName ?? null, ContainerName, ProtectedItemName, Id, _parametersBody, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ContainerName=ContainerName,ProtectedItemName=ProtectedItemName,Id=Id})
                    {
