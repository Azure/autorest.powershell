...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Register, @"AzRecoveryServicesBackupProtectionContainer_RegisterViaIdentityBackupFabric", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupFabrics/{fabricName}/protectionContainers/{containerName}", ApiVersion = "2025-08-01")]
    public partial class RegisterAzRecoveryServicesBackupProtectionContainer_RegisterViaIdentityBackupFabric : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IProtectionContainerResource _parameter;
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IProtectionContainerResource) })]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IProtectionContainerResource Parameter { get => this._parameter; set => this._parameter = value; }
        ...
        /// <returns>
        /// a duplicate instance of RegisterAzRecoveryServicesBackupProtectionContainer_RegisterViaIdentityBackupFabric
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Cmdlets.RegisterAzRecoveryServicesBackupProtectionContainer_RegisterViaIdentityBackupFabric Clone()
        {
            var clone = new RegisterAzRecoveryServicesBackupProtectionContainer_RegisterViaIdentityBackupFabric();
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (BackupFabricInputObject?.Id != null)
                    {
                        ...
                        await this.Client.ProtectionContainersRegisterViaIdentity(BackupFabricInputObject.Id, Parameter, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ProtectionContainersRegister(BackupFabricInputObject.SubscriptionId ?? null, BackupFabricInputObject.ResourceGroupName ?? null, BackupFabricInputObject.VaultName ?? null, BackupFabricInputObject.FabricName ?? null, ContainerName, Parameter, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RegisterAzRecoveryServicesBackupProtectionContainer_RegisterViaIdentityBackupFabric"
        /// /> cmdlet class.
        /// </summary>
        public RegisterAzRecoveryServicesBackupProtectionContainer_RegisterViaIdentityBackupFabric()
        {
