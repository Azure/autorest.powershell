...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Unregister, @"AzRecoveryServicesBackupProtectionContainer_UnregisterViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class UnregisterAzRecoveryServicesBackupProtectionContainer_UnregisterViaIdentity : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.IContext
    {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ProtectionContainersUnregisterViaIdentity(InputObject.Id, onOk, onAccepted, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ProtectionContainersUnregister(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.VaultName ?? null, InputObject.FabricName ?? null, InputObject.ContainerName ?? null, onOk, onAccepted, onNoContent, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UnregisterAzRecoveryServicesBackupProtectionContainer_UnregisterViaIdentity"
        /// /> cmdlet class.
        /// </summary>
        public UnregisterAzRecoveryServicesBackupProtectionContainer_UnregisterViaIdentity()
        {
