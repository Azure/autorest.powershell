...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzRecoveryServicesBackupProtectionIntent_DeleteViaIdentityVault", SupportsShouldProcess = true)]
    ...
    public partial class RemoveAzRecoveryServicesBackupProtectionIntent_DeleteViaIdentityVault : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.IContext
    {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (VaultInputObject?.Id != null)
                    {
                        ...
                        await this.Client.ProtectionIntentDeleteViaIdentity(VaultInputObject.Id, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ProtectionIntentDelete(VaultInputObject.SubscriptionId ?? null, VaultInputObject.ResourceGroupName ?? null, VaultInputObject.VaultName ?? null, FabricName, IntentObjectName, onNoContent, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveAzRecoveryServicesBackupProtectionIntent_DeleteViaIdentityVault" />
        /// cmdlet class.
        /// </summary>
        public RemoveAzRecoveryServicesBackupProtectionIntent_DeleteViaIdentityVault()
        {
