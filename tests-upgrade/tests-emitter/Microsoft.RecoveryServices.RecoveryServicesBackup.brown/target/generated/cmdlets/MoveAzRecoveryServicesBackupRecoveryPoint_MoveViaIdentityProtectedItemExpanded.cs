...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] MoveRecoveryPoint=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupFabrics/{fabricName}/protectionContainers/{containerName}/protectedItems/{protectedItemName}/recoveryPoints/{recoveryPointId}/move"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Move, @"AzRecoveryServicesBackupRecoveryPoint_MoveViaIdentityProtectedItemExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Description(@"Move recovery point from one datastore to another store.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupFabrics/{fabricName}/protectionContainers/{containerName}/protectedItems/{protectedItemName}/recoveryPoints/{recoveryPointId}/move", ApiVersion = "2025-08-01")]
    public partial class MoveAzRecoveryServicesBackupRecoveryPoint_MoveViaIdentityProtectedItemExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IMoveRpAcrossTiersRequest _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.MoveRpAcrossTiersRequest();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Source tier from where RP needs to be moved")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Category(global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public string SourceTierType { get => _parametersBody.SourceTierType ?? null; set => _parametersBody.SourceTierType = value; }

        /// <summary>Target tier where RP needs to be moved</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Target tier where RP needs to be moved")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Category(global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.PSArgumentCompleterAttribute("Invalid", "InstantRP", "HardenedRP", "ArchivedRP")]
        public string TargetTierType { get => _parametersBody.TargetTierType ?? null; set => _parametersBody.TargetTierType = value; }
        ...
        /// <returns>
        /// a duplicate instance of MoveAzRecoveryServicesBackupRecoveryPoint_MoveViaIdentityProtectedItemExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Cmdlets.MoveAzRecoveryServicesBackupRecoveryPoint_MoveViaIdentityProtectedItemExpanded Clone()
        {
            var clone = new MoveAzRecoveryServicesBackupRecoveryPoint_MoveViaIdentityProtectedItemExpanded();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MoveAzRecoveryServicesBackupRecoveryPoint_MoveViaIdentityProtectedItemExpanded"
        /// /> cmdlet class.
        /// </summary>
        public MoveAzRecoveryServicesBackupRecoveryPoint_MoveViaIdentityProtectedItemExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'MoveRecoveryPoint' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.ProtectedItemInputObject.Id += $"/recoveryPoints/{(global::System.Uri.EscapeDataString(this.Id.ToString()))}";
                        await this.Client.MoveRecoveryPointViaIdentity(ProtectedItemInputObject.Id, _parametersBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.MoveRecoveryPoint(ProtectedItemInputObject.SubscriptionId ?? null, ProtectedItemInputObject.ResourceGroupName ?? null, ProtectedItemInputObject.VaultName ?? null, ProtectedItemInputObject.FabricName ?? null, ProtectedItemInputObject.ContainerName ?? null, ProtectedItemInputObject.ProtectedItemName ?? null, Id, _parametersBody, onOk, onDefault, this, Pipeline);
                    }
