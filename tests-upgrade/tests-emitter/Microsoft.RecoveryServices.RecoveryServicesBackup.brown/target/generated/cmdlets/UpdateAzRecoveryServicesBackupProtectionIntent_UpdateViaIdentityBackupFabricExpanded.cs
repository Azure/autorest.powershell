...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupFabrics/{fabricName}/backupProtectionIntent/{intentObjectName}"
    /// [OpenAPI] CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupFabrics/{fabricName}/backupProtectionIntent/{intentObjectName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzRecoveryServicesBackupProtectionIntent_UpdateViaIdentityBackupFabricExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IProtectionIntentResource))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Description(@"update Intent for Enabling backup of an item. This is a synchronous operation.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Generated]
    public partial class UpdateAzRecoveryServicesBackupProtectionIntent_UpdateViaIdentityBackupFabricExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IProtectionIntentResource _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.ProtectionIntentResource();
        ...
        /// <summary>Backing field for <see cref="BackupFabricInputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IRecoveryServicesBackupIdentity _backupFabricInputObject;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IRecoveryServicesBackupIdentity BackupFabricInputObject { get => this._backupFabricInputObject; set => this._backupFabricInputObject = value; }

        /// <summary>Type of backup management for the backed up item.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Type of backup management for the backed up item.")]
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "ID of the item which is getting protected, In case of Azure Vm , it is ProtectedItemId")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Category(global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string ItemId { get => _parametersBody.ItemId ?? null; set => _parametersBody.ItemId = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "backup protectionIntent type.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Category(global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public string ProtectionIntentItemType { get => _parametersBody.ProtectionIntentItemType ?? null; set => _parametersBody.ProtectionIntentItemType = value; }

        /// <summary>Backup state of this backup item.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Backup state of this backup item.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Category(global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public string ProtectionState { get => _parametersBody.ProtectionState ?? null; set => _parametersBody.ProtectionState = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IProtectionIntentResourceTags Tag { get => _parametersBody.Tag ?? null /* object */; set => _parametersBody.Tag = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IProtectionIntentResource">Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IProtectionIntentResource</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IProtectionIntentResource> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ProtectionIntentCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (BackupFabricInputObject?.Id != null)
                    {
                        this.BackupFabricInputObject.Id += $"/backupProtectionIntent/{(global::System.Uri.EscapeDataString(this.IntentObjectName.ToString()))}";
                        _parametersBody = await this.Client.ProtectionIntentGetViaIdentityWithResult(BackupFabricInputObject.Id, this, Pipeline);
                        this.Update_parametersBody();
                        await this.Client.ProtectionIntentCreateOrUpdateViaIdentity(BackupFabricInputObject.Id, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == BackupFabricInputObject.SubscriptionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("BackupFabricInputObject has null value for BackupFabricInputObject.SubscriptionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, BackupFabricInputObject) );
                        }
                        if (null == BackupFabricInputObject.ResourceGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("BackupFabricInputObject has null value for BackupFabricInputObject.ResourceGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, BackupFabricInputObject) );
                        }
                        if (null == BackupFabricInputObject.VaultName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("BackupFabricInputObject has null value for BackupFabricInputObject.VaultName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, BackupFabricInputObject) );
                        }
                        if (null == BackupFabricInputObject.FabricName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("BackupFabricInputObject has null value for BackupFabricInputObject.FabricName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, BackupFabricInputObject) );
                        }
                        _parametersBody = await this.Client.ProtectionIntentGetWithResult(BackupFabricInputObject.SubscriptionId ?? null, BackupFabricInputObject.ResourceGroupName ?? null, BackupFabricInputObject.VaultName ?? null, BackupFabricInputObject.FabricName ?? null, IntentObjectName, this, Pipeline);
                        this.Update_parametersBody();
                        await this.Client.ProtectionIntentCreateOrUpdate(BackupFabricInputObject.SubscriptionId ?? null, BackupFabricInputObject.ResourceGroupName ?? null, BackupFabricInputObject.VaultName ?? null, BackupFabricInputObject.FabricName ?? null, IntentObjectName, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.SerializationMode.IncludeUpdate);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { IntentObjectName=IntentObjectName})
                    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzRecoveryServicesBackupProtectionIntent_UpdateViaIdentityBackupFabricExpanded"
        /// /> cmdlet class.
        /// </summary>
        public UpdateAzRecoveryServicesBackupProtectionIntent_UpdateViaIdentityBackupFabricExpanded()
        {
        ...
        private void Update_parametersBody()
        {
            ...
            {
                this.Tag = (Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IProtectionIntentResourceTags)(this.MyInvocation?.BoundParameters["Tag"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("ETag")))
            {
                this.ETag = (string)(this.MyInvocation?.BoundParameters["ETag"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("ProtectionIntentItemType")))
            {
                this.ProtectionIntentItemType = (string)(this.MyInvocation?.BoundParameters["ProtectionIntentItemType"]);
            }
            ...
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("ItemId")))
            {
                this.ItemId = (string)(this.MyInvocation?.BoundParameters["ItemId"]);
            }
            ...
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("ProtectionState")))
            {
                this.ProtectionState = (string)(this.MyInvocation?.BoundParameters["ProtectionState"]);
            }
        }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IProtectionIntentResource> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IProtectionIntentResource
