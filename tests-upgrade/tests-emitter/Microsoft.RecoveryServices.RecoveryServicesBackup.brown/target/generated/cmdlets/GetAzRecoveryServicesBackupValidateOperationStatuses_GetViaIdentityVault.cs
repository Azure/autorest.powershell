...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Cmdlets
{
    ...
    /// <summary>
    /// Fetches the status of a triggered validate operation. The status can be in progress, completed\nor failed. You can refer
    /// to the OperationStatus enum for all the possible states of the operation.\nIf operation has completed, this method returns
    /// the list of errors obtained while validating the operation.
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupValidateOperationsStatuses/{operationId}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzRecoveryServicesBackupValidateOperationStatuses_GetViaIdentityVault")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Description(@"Fetches the status of a triggered validate operation. The status can be in progress, completed\nor failed. You can refer to the OperationStatus enum for all the possible states of the operation.\nIf operation has completed, this method returns the list of errors obtained while validating the operation.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupValidateOperationsStatuses/{operationId}", ApiVersion = "2025-08-01")]
    public partial class GetAzRecoveryServicesBackupValidateOperationStatuses_GetViaIdentityVault : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.IContext
    {
        ...
        /// <summary>OperationID represents the operation whose status needs to be fetched.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "OperationID represents the operation whose status needs to be fetched.")]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzRecoveryServicesBackupValidateOperationStatuses_GetViaIdentityVault"
        /// /> cmdlet class.
        /// </summary>
        public GetAzRecoveryServicesBackupValidateOperationStatuses_GetViaIdentityVault()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.VaultInputObject.Id += $"/backupValidateOperationsStatuses/{(global::System.Uri.EscapeDataString(this.OperationId.ToString()))}";
                        await this.Client.ValidateOperationStatusesGetViaIdentity(VaultInputObject.Id, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ValidateOperationStatusesGet(VaultInputObject.SubscriptionId ?? null, VaultInputObject.ResourceGroupName ?? null, VaultInputObject.VaultName ?? null, OperationId, onOk, onDefault, this, Pipeline);
                    }
