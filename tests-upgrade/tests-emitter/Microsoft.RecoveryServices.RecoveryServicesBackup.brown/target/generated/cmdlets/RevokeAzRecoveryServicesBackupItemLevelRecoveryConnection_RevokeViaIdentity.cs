...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsSecurity.Revoke, @"AzRecoveryServicesBackupItemLevelRecoveryConnection_RevokeViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class RevokeAzRecoveryServicesBackupItemLevelRecoveryConnection_RevokeViaIdentity : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.IContext
    {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ItemLevelRecoveryConnectionsRevokeViaIdentity(InputObject.Id, onAccepted, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ItemLevelRecoveryConnectionsRevoke(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.VaultName ?? null, InputObject.FabricName ?? null, InputObject.ContainerName ?? null, InputObject.ProtectedItemName ?? null, InputObject.RecoveryPointId ?? null, onAccepted, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RevokeAzRecoveryServicesBackupItemLevelRecoveryConnection_RevokeViaIdentity"
        /// /> cmdlet class.
        /// </summary>
        public RevokeAzRecoveryServicesBackupItemLevelRecoveryConnection_RevokeViaIdentity()
        {
