...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupJobs/{jobName}/operationResults/{operationId}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzRecoveryServicesBackupJobOperationResult_GetViaIdentityBackupJob")]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Description(@"Fetches the result of any operation.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupJobs/{jobName}/operationResults/{operationId}", ApiVersion = "2025-08-01")]
    public partial class GetAzRecoveryServicesBackupJobOperationResult_GetViaIdentityBackupJob : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.IContext
    {
        ...
        /// <summary>Backing field for <see cref="BackupJobInputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IRecoveryServicesBackupIdentity _backupJobInputObject;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IRecoveryServicesBackupIdentity BackupJobInputObject { get => this._backupJobInputObject; set => this._backupJobInputObject = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the JobResource")]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzRecoveryServicesBackupJobOperationResult_GetViaIdentityBackupJob" />
        /// cmdlet class.
        /// </summary>
        public GetAzRecoveryServicesBackupJobOperationResult_GetViaIdentityBackupJob()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (BackupJobInputObject?.Id != null)
                    {
                        this.BackupJobInputObject.Id += $"/operationResults/{(global::System.Uri.EscapeDataString(this.OperationId.ToString()))}";
                        await this.Client.JobOperationResultsGetViaIdentity(BackupJobInputObject.Id, onOk, onAccepted, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == BackupJobInputObject.SubscriptionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("BackupJobInputObject has null value for BackupJobInputObject.SubscriptionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, BackupJobInputObject) );
                        }
                        if (null == BackupJobInputObject.ResourceGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("BackupJobInputObject has null value for BackupJobInputObject.ResourceGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, BackupJobInputObject) );
                        }
                        if (null == BackupJobInputObject.VaultName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("BackupJobInputObject has null value for BackupJobInputObject.VaultName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, BackupJobInputObject) );
                        }
                        if (null == BackupJobInputObject.JobName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("BackupJobInputObject has null value for BackupJobInputObject.JobName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, BackupJobInputObject) );
                        }
                        await this.Client.JobOperationResultsGet(BackupJobInputObject.SubscriptionId ?? null, BackupJobInputObject.ResourceGroupName ?? null, BackupJobInputObject.VaultName ?? null, BackupJobInputObject.JobName ?? null, OperationId, onOk, onAccepted, onNoContent, onDefault, this, Pipeline);
                    }
