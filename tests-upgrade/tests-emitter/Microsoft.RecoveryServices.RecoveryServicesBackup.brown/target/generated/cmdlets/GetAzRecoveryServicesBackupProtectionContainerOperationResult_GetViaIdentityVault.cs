...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzRecoveryServicesBackupProtectionContainerOperationResult_GetViaIdentityVault")]
    ...
    public partial class GetAzRecoveryServicesBackupProtectionContainerOperationResult_GetViaIdentityVault : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzRecoveryServicesBackupProtectionContainerOperationResult_GetViaIdentityVault"
        /// /> cmdlet class.
        /// </summary>
        public GetAzRecoveryServicesBackupProtectionContainerOperationResult_GetViaIdentityVault()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.VaultInputObject.Id += $"/backupFabrics/{(global::System.Uri.EscapeDataString(this.FabricName.ToString()))}/protectionContainers/{(global::System.Uri.EscapeDataString(this.ContainerName.ToString()))}/operationResults/{(global::System.Uri.EscapeDataString(this.OperationId.ToString()))}";
                        await this.Client.ProtectionContainerOperationResultsGetViaIdentity(VaultInputObject.Id, onOk, onAccepted, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ProtectionContainerOperationResultsGet(VaultInputObject.SubscriptionId ?? null, VaultInputObject.ResourceGroupName ?? null, VaultInputObject.VaultName ?? null, FabricName, ContainerName, OperationId, onOk, onAccepted, onNoContent, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { FabricName=FabricName,ContainerName=ContainerName,OperationId=OperationId})
                    {
