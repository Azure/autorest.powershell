...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzRecoveryServicesBackupProtectionContainer_UpdateViaIdentityBackupFabricExpanded", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzRecoveryServicesBackupProtectionContainer_UpdateViaIdentityBackupFabricExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.IContext
    {
        ...
        /// <returns>
        /// a duplicate instance of UpdateAzRecoveryServicesBackupProtectionContainer_UpdateViaIdentityBackupFabricExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Cmdlets.UpdateAzRecoveryServicesBackupProtectionContainer_UpdateViaIdentityBackupFabricExpanded Clone()
        {
            var clone = new UpdateAzRecoveryServicesBackupProtectionContainer_UpdateViaIdentityBackupFabricExpanded();
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (BackupFabricInputObject?.Id != null)
                    {
                        ...
                        _parametersBody = await this.Client.ProtectionContainersGetViaIdentityWithResult(BackupFabricInputObject.Id, this, Pipeline);
                    ...
                    else
                    {
                        ...
                        _parametersBody = await this.Client.ProtectionContainersGetWithResult(BackupFabricInputObject.SubscriptionId ?? null, BackupFabricInputObject.ResourceGroupName ?? null, BackupFabricInputObject.VaultName ?? null, BackupFabricInputObject.FabricName ?? null, ContainerName, this, Pipeline);
                        this.Update_parametersBody();
                        await this.Client.ProtectionContainersRegister(BackupFabricInputObject.SubscriptionId ?? null, BackupFabricInputObject.ResourceGroupName ?? null, BackupFabricInputObject.VaultName ?? null, BackupFabricInputObject.FabricName ?? null, ContainerName, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzRecoveryServicesBackupProtectionContainer_UpdateViaIdentityBackupFabricExpanded"
        /// /> cmdlet class.
        /// </summary>
        public UpdateAzRecoveryServicesBackupProtectionContainer_UpdateViaIdentityBackupFabricExpanded()
        {
