...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzRecoveryServicesBackupProtectionIntent_UpdateViaIdentityVaultExpanded", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzRecoveryServicesBackupProtectionIntent_UpdateViaIdentityVaultExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.IContext
    {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.VaultInputObject.Id += $"/backupFabrics/{(global::System.Uri.EscapeDataString(this.FabricName.ToString()))}/backupProtectionIntent/{(global::System.Uri.EscapeDataString(this.IntentObjectName.ToString()))}";
                        _parametersBody = await this.Client.ProtectionIntentGetViaIdentityWithResult(VaultInputObject.Id, this, Pipeline);
                    ...
                    else
                    {
                        ...
                        _parametersBody = await this.Client.ProtectionIntentGetWithResult(VaultInputObject.SubscriptionId ?? null, VaultInputObject.ResourceGroupName ?? null, VaultInputObject.VaultName ?? null, FabricName, IntentObjectName, this, Pipeline);
                        this.Update_parametersBody();
                        await this.Client.ProtectionIntentCreateOrUpdate(VaultInputObject.SubscriptionId ?? null, VaultInputObject.ResourceGroupName ?? null, VaultInputObject.VaultName ?? null, FabricName, IntentObjectName, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.SerializationMode.IncludeUpdate);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { FabricName=FabricName,IntentObjectName=IntentObjectName})
                    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzRecoveryServicesBackupProtectionIntent_UpdateViaIdentityVaultExpanded"
        /// /> cmdlet class.
        /// </summary>
        public UpdateAzRecoveryServicesBackupProtectionIntent_UpdateViaIdentityVaultExpanded()
        {
