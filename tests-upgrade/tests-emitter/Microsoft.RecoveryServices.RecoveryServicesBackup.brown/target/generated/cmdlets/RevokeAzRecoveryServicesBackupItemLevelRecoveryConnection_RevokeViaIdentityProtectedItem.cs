...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Revoke=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupFabrics/{fabricName}/protectionContainers/{containerName}/protectedItems/{protectedItemName}/recoveryPoints/{recoveryPointId}/revokeInstantItemRecovery"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsSecurity.Revoke, @"AzRecoveryServicesBackupItemLevelRecoveryConnection_RevokeViaIdentityProtectedItem", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Description(@"Revokes an iSCSI connection which can be used to download a script. Executing this script opens a file explorer\ndisplaying all recoverable files and folders. This is an asynchronous operation.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupFabrics/{fabricName}/protectionContainers/{containerName}/protectedItems/{protectedItemName}/recoveryPoints/{recoveryPointId}/revokeInstantItemRecovery", ApiVersion = "2025-08-01")]
    public partial class RevokeAzRecoveryServicesBackupItemLevelRecoveryConnection_RevokeViaIdentityProtectedItem : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.IContext
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ItemLevelRecoveryConnectionsRevoke' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (ProtectedItemInputObject?.Id != null)
                    {
                        ...
                        await this.Client.ItemLevelRecoveryConnectionsRevokeViaIdentity(ProtectedItemInputObject.Id, onAccepted, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ItemLevelRecoveryConnectionsRevoke(ProtectedItemInputObject.SubscriptionId ?? null, ProtectedItemInputObject.ResourceGroupName ?? null, ProtectedItemInputObject.VaultName ?? null, ProtectedItemInputObject.FabricName ?? null, ProtectedItemInputObject.ContainerName ?? null, ProtectedItemInputObject.ProtectedItemName ?? null, RecoveryPointId, onAccepted, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RevokeAzRecoveryServicesBackupItemLevelRecoveryConnection_RevokeViaIdentityProtectedItem"
        /// /> cmdlet class.
        /// </summary>
        public RevokeAzRecoveryServicesBackupItemLevelRecoveryConnection_RevokeViaIdentityProtectedItem()
        {
