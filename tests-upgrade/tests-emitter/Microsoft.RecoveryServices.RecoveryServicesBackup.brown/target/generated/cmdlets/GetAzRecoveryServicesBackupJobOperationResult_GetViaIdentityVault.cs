...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzRecoveryServicesBackupJobOperationResult_GetViaIdentityVault")]
    ...
    public partial class GetAzRecoveryServicesBackupJobOperationResult_GetViaIdentityVault : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzRecoveryServicesBackupJobOperationResult_GetViaIdentityVault" /> cmdlet
        /// class.
        /// </summary>
        public GetAzRecoveryServicesBackupJobOperationResult_GetViaIdentityVault()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.VaultInputObject.Id += $"/backupJobs/{(global::System.Uri.EscapeDataString(this.JobName.ToString()))}/operationResults/{(global::System.Uri.EscapeDataString(this.OperationId.ToString()))}";
                        await this.Client.JobOperationResultsGetViaIdentity(VaultInputObject.Id, onOk, onAccepted, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.JobOperationResultsGet(VaultInputObject.SubscriptionId ?? null, VaultInputObject.ResourceGroupName ?? null, VaultInputObject.VaultName ?? null, JobName, OperationId, onOk, onAccepted, onNoContent, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { JobName=JobName,OperationId=OperationId})
                    {
