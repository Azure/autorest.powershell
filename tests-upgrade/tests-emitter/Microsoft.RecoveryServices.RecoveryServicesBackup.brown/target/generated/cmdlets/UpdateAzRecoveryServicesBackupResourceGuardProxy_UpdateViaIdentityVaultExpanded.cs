...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Cmdlets
{
    ...
    /// <summary>Add or put ResourceGuardProxy under vault\nSecures vault critical operations</summary>
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupResourceGuardProxies/{resourceGuardProxyName}"
    /// [OpenAPI] Put=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupResourceGuardProxies/{resourceGuardProxyName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzRecoveryServicesBackupResourceGuardProxy_UpdateViaIdentityVaultExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IResourceGuardProxyBaseResource))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Description(@"Add or put ResourceGuardProxy under vault\nSecures vault critical operations")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Generated]
    public partial class UpdateAzRecoveryServicesBackupResourceGuardProxy_UpdateViaIdentityVaultExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IResourceGuardProxyBaseResource _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.ResourceGuardProxyBaseResource();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "A sequence of textual characters.")]
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::System.Management.Automation.Alias("ResourceGuardProxyName")]
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Array of ResourceGuardOperationDetail")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Category(global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IResourceGuardOperationDetail[] ResourceGuardOperationDetail { get => _parametersBody.ResourceGuardOperationDetail?.ToArray() ?? null /* fixedArrayOf */; set => _parametersBody.ResourceGuardOperationDetail = (value != null ? new System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IResourceGuardOperationDetail>(value) : null); }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string ResourceGuardResourceId { get => _parametersBody.ResourceGuardResourceId ?? null; set => _parametersBody.ResourceGuardResourceId = value; }
        ...
        SerializedName = @"tags",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IResourceGuardProxyBaseResourceTags) })]
        public Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IResourceGuardProxyBaseResourceTags Tag { get => _parametersBody.Tag ?? null /* object */; set => _parametersBody.Tag = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IResourceGuardProxyBaseResource">Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IResourceGuardProxyBaseResource</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IResourceGuardProxyBaseResource> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ResourceGuardProxyPut' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.VaultInputObject.Id += $"/backupResourceGuardProxies/{(global::System.Uri.EscapeDataString(this.Name.ToString()))}";
                        _parametersBody = await this.Client.ResourceGuardProxyGetViaIdentityWithResult(VaultInputObject.Id, this, Pipeline);
                        this.Update_parametersBody();
                        await this.Client.ResourceGuardProxyPutViaIdentity(VaultInputObject.Id, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _parametersBody = await this.Client.ResourceGuardProxyGetWithResult(VaultInputObject.SubscriptionId ?? null, VaultInputObject.ResourceGroupName ?? null, VaultInputObject.VaultName ?? null, Name, this, Pipeline);
                        this.Update_parametersBody();
                        await this.Client.ResourceGuardProxyPut(VaultInputObject.SubscriptionId ?? null, VaultInputObject.ResourceGroupName ?? null, VaultInputObject.VaultName ?? null, Name, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzRecoveryServicesBackupResourceGuardProxy_UpdateViaIdentityVaultExpanded"
        /// /> cmdlet class.
        /// </summary>
        public UpdateAzRecoveryServicesBackupResourceGuardProxy_UpdateViaIdentityVaultExpanded()
        {
        ...
        private void Update_parametersBody()
        {
            ...
            {
                this.Tag = (Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IResourceGuardProxyBaseResourceTags)(this.MyInvocation?.BoundParameters["Tag"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("ETag")))
            {
                this.ETag = (string)(this.MyInvocation?.BoundParameters["ETag"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("ResourceGuardResourceId")))
            {
                this.ResourceGuardResourceId = (string)(this.MyInvocation?.BoundParameters["ResourceGuardResourceId"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("ResourceGuardOperationDetail")))
            {
                this.ResourceGuardOperationDetail = (Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IResourceGuardOperationDetail[])(this.MyInvocation?.BoundParameters["ResourceGuardOperationDetail"]);
            }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IResourceGuardProxyBaseResource> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.IResourceGuardProxyBaseResource
