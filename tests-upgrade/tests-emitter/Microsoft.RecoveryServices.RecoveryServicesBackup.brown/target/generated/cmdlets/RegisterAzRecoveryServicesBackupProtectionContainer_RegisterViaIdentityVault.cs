...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Register, @"AzRecoveryServicesBackupProtectionContainer_RegisterViaIdentityVault", SupportsShouldProcess = true)]
    ...
    public partial class RegisterAzRecoveryServicesBackupProtectionContainer_RegisterViaIdentityVault : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.IContext
    {
        ...
        /// <returns>
        /// a duplicate instance of RegisterAzRecoveryServicesBackupProtectionContainer_RegisterViaIdentityVault
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Cmdlets.RegisterAzRecoveryServicesBackupProtectionContainer_RegisterViaIdentityVault Clone()
        {
            var clone = new RegisterAzRecoveryServicesBackupProtectionContainer_RegisterViaIdentityVault();
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (VaultInputObject?.Id != null)
                    {
                        ...
                        await this.Client.ProtectionContainersRegisterViaIdentity(VaultInputObject.Id, Parameter, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ProtectionContainersRegister(VaultInputObject.SubscriptionId ?? null, VaultInputObject.ResourceGroupName ?? null, VaultInputObject.VaultName ?? null, FabricName, ContainerName, Parameter, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RegisterAzRecoveryServicesBackupProtectionContainer_RegisterViaIdentityVault"
        /// /> cmdlet class.
        /// </summary>
        public RegisterAzRecoveryServicesBackupProtectionContainer_RegisterViaIdentityVault()
        {
