...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzRecoveryServicesBackupInquireProtectionContainer_InquireViaIdentityVault", SupportsShouldProcess = true)]
    ...
    public partial class InvokeAzRecoveryServicesBackupInquireProtectionContainer_InquireViaIdentityVault : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InvokeAzRecoveryServicesBackupInquireProtectionContainer_InquireViaIdentityVault"
        /// /> cmdlet class.
        /// </summary>
        public InvokeAzRecoveryServicesBackupInquireProtectionContainer_InquireViaIdentityVault()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (VaultInputObject?.Id != null)
                    {
                        ...
                        await this.Client.ProtectionContainersInquireViaIdentity(VaultInputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null, onAccepted, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ProtectionContainersInquire(VaultInputObject.SubscriptionId ?? null, VaultInputObject.ResourceGroupName ?? null, VaultInputObject.VaultName ?? null, FabricName, ContainerName, this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null, onAccepted, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { FabricName=FabricName,ContainerName=ContainerName,Filter=this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null})
                    {
