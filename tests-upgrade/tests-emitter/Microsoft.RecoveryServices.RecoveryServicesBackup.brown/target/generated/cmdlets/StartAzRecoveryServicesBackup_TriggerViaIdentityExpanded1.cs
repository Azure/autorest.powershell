...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Start, @"AzRecoveryServicesBackup_TriggerViaIdentityExpanded1", SupportsShouldProcess = true)]
    ...
    public partial class StartAzRecoveryServicesBackup_TriggerViaIdentityExpanded1 : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Runtime.IContext
    {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.BackupsTriggerViaIdentity(InputObject.Id, _parametersBody, onAccepted, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.BackupsTrigger(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.VaultName ?? null, InputObject.FabricName ?? null, InputObject.ContainerName ?? null, InputObject.ProtectedItemName ?? null, _parametersBody, onAccepted, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StartAzRecoveryServicesBackup_TriggerViaIdentityExpanded1" /> cmdlet class.
        /// </summary>
        public StartAzRecoveryServicesBackup_TriggerViaIdentityExpanded1()
        {
