...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Az.Astro.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.Astro.psd1'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: Astro cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.Astro.format.ps1xml'
...
if (-not $DisableAfterBuildTasks){
  ...
  $afterBuildTasksArgs = ConvertFrom-Json '{"SubModuleName":"Az.Astro","ModuleRootName":"$(root-module-name)"}' -AsHashtable
