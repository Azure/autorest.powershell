...
namespace Microsoft.Azure.PowerShell.Cmdlets.Astro.Models
{
    ...
    public partial class ErrorAdditionalInfo
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Astro.Runtime.Json.JsonObject into a new instance of <see cref="ErrorAdditionalInfo" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Astro.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal ErrorAdditionalInfo(Microsoft.Azure.PowerShell.Cmdlets.Astro.Runtime.Json.JsonObject json)
        {
            ...
            {_info = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Astro.Runtime.Json.JsonObject>("info"), out var __jsonInfo) ? Microsoft.Azure.PowerShell.Cmdlets.Astro.Models.Any.FromJson(__jsonInfo) : _info;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Astro.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Astro.Models.IErrorAdditionalInfo.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Astro.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Astro.Models.IErrorAdditionalInfo.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Astro.Models.IErrorAdditionalInfo FromJson(Microsoft.Azure.PowerShell.Cmdlets.Astro.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Astro.Runtime.Json.JsonObject json ? new ErrorAdditionalInfo(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="ErrorAdditionalInfo" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Astro.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ErrorAdditionalInfo" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Astro.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Astro.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Astro.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Astro.Runtime.SerializationMode serializationMode)
        {
            ...
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.Astro.Runtime.SerializationMode.IncludeRead))
            {
                AddIf( null != this._info ? (Microsoft.Azure.PowerShell.Cmdlets.Astro.Runtime.Json.JsonNode) this._info.ToJson(null,serializationMode) : null, "info" ,container.Add );
            }
