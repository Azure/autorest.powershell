...
$dll = Join-Path $PSScriptRoot 'bin\Az.ContainerOrchestratorRuntime.private.dll'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Az.ContainerOrchestratorRuntime.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.ContainerOrchestratorRuntime.psd1'
$guid = Get-ModuleGuid -Psd1Path $psd1
$moduleName = 'Az.ContainerOrchestratorRuntime'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: ContainerOrchestratorRuntime cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.ContainerOrchestratorRuntime.format.ps1xml'
...
if (-not $DisableAfterBuildTasks){
  ...
  $afterBuildTasksArgs = ConvertFrom-Json '{"SubModuleName":"Az.ContainerOrchestratorRuntime","ModuleRootName":"$(root-module-name)"}' -AsHashtable
