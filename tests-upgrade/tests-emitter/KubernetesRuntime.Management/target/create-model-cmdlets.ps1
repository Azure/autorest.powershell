...
function CreateModelCmdlet {
    ...
    foreach ($Model in $Models)
    {
        ...
        if ($ObjectType.StartsWith('ContainerOrchestratorRuntime')) {
            $ModulePrefix = ''
        } else {
            $ModulePrefix = 'ContainerOrchestratorRuntime'
        }
...
#>
function ${cmdletName} {
    [Microsoft.Azure.PowerShell.Cmdlets.ContainerOrchestratorRuntime.ModelCmdletAttribute()]
