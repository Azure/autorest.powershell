...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Models
{
    ...
    public partial class AccountSasToken
    {
        ...
        internal AccountSasToken(Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Runtime.Json.JsonObject json)
        {
            ...
            {_storageAccountSasToken = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Runtime.Json.JsonString>("storageAccountSasToken"), out var __jsonStorageAccountSasToken) ? new System.Net.NetworkCredential("",(string)__jsonStorageAccountSasToken).SecurePassword : _storageAccountSasToken;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Models.IAccountSasToken.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Models.IAccountSasToken.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Models.IAccountSasToken FromJson(Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Runtime.Json.JsonNode node)
        {
