        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.DataTypesDeleteDataViaJsonString(SubscriptionId, ResourceGroupName, DataProductName, DataTypeName, _jsonString, onNoContent, onDefault, this, Pipeline);
