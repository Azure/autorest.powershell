...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Runtime.IContext
    {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.DataTypesDeleteDataViaIdentity(InputObject.Id, Body, onNoContent, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.DataTypesDeleteData(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.DataProductName ?? null, InputObject.DataTypeName ?? null, Body, onNoContent, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveAzNetworkAnalyticsDataTypeData_DeleteViaIdentity" /> cmdlet class.
        /// </summary>
