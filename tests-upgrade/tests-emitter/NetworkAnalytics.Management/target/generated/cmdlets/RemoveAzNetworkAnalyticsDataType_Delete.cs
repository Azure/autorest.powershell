...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.NetworkAnalytics.Runtime.IContext
    {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.DataTypesDelete(SubscriptionId, ResourceGroupName, DataProductName, Name, onNoContent, onOk, onDefault, this, Pipeline);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveAzNetworkAnalyticsDataType_Delete" /> cmdlet class.
        /// </summary>
