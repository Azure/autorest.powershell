...
namespace Microsoft.Azure.PowerShell.Cmdlets.Hsm.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ValidateBackupProperties=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HardwareSecurityModules/cloudHsmClusters/{cloudHsmClusterName}/validateBackupProperties"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Test, @"AzHsmCloudHsmClusterBackupProperty_ValidateViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Hsm.Models.IBackupResult))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Hsm.Description(@"Pre Backup operation to validate whether the customer can perform a backup on the Cloud HSM Cluster resource in the specified subscription.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Hsm.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Hsm.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HardwareSecurityModules/cloudHsmClusters/{cloudHsmClusterName}/validateBackupProperties", ApiVersion = "2025-03-31")]
    public partial class TestAzHsmCloudHsmClusterBackupProperty_ValidateViaIdentity : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Hsm.Runtime.IContext
    {
        ...
        /// <summary>Backing field for <see cref="BackupRequestProperty" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Hsm.Models.IBackupRequestProperties _backupRequestProperty;

        /// <summary>Backup properties</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Backup properties", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Hsm.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Backup properties",
        SerializedName = @"backupRequestProperties",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Hsm.Models.IBackupRequestProperties) })]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Hsm.Models.IBackupRequestProperties BackupRequestProperty { get => this._backupRequestProperty; set => this._backupRequestProperty = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Hsm.Models.IHsmIdentity _inputObject;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Hsm.Models.IHsmIdentity InputObject { get => this._inputObject; set => this._inputObject = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Hsm.Models.IBackupResult">Microsoft.Azure.PowerShell.Cmdlets.Hsm.Models.IBackupResult</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Hsm.Models.IBackupResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>
        /// a duplicate instance of TestAzHsmCloudHsmClusterBackupProperty_ValidateViaIdentity
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Hsm.Cmdlets.TestAzHsmCloudHsmClusterBackupProperty_ValidateViaIdentity Clone()
        {
            var clone = new TestAzHsmCloudHsmClusterBackupProperty_ValidateViaIdentity();
            ...
            clone.BackupRequestProperty = this.BackupRequestProperty;
            return clone;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'CloudHsmClustersValidateBackupProperties' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.CloudHsmClustersValidateBackupPropertiesViaIdentity(InputObject.Id, BackupRequestProperty, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        if (null == InputObject.CloudHsmClusterName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.CloudHsmClusterName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                        }
                        await this.Client.CloudHsmClustersValidateBackupProperties(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.CloudHsmClusterName ?? null, BackupRequestProperty, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TestAzHsmCloudHsmClusterBackupProperty_ValidateViaIdentity" /> cmdlet class.
        /// </summary>
        public TestAzHsmCloudHsmClusterBackupProperty_ValidateViaIdentity()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Hsm.Models.IBackupResult> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Hsm.Models.IBackupResult
