...
namespace Microsoft.Azure.PowerShell.Cmdlets.Hsm.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Delete=>DELETE:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HardwareSecurityModules/cloudHsmClusters/{cloudHsmClusterName}/privateEndpointConnections/{peConnectionName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzHsmCloudHsmClusterPrivateEndpointConnection_DeleteViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Hsm.Description(@"Deletes the private endpoint connection for the Cloud Hsm Cluster.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Hsm.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Hsm.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HardwareSecurityModules/cloudHsmClusters/{cloudHsmClusterName}/privateEndpointConnections/{peConnectionName}", ApiVersion = "2025-03-31")]
    public partial class RemoveAzHsmCloudHsmClusterPrivateEndpointConnection_DeleteViaIdentity : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Hsm.Runtime.IContext
    {
        ...
        /// <returns>
        /// a duplicate instance of RemoveAzHsmCloudHsmClusterPrivateEndpointConnection_DeleteViaIdentity
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Hsm.Cmdlets.RemoveAzHsmCloudHsmClusterPrivateEndpointConnection_DeleteViaIdentity Clone()
        {
            var clone = new RemoveAzHsmCloudHsmClusterPrivateEndpointConnection_DeleteViaIdentity();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'CloudHsmClusterPrivateEndpointConnectionsDelete' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.CloudHsmClusterPrivateEndpointConnectionsDeleteViaIdentity(InputObject.Id, onNoContent, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        if (null == InputObject.PeConnectionName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.PeConnectionName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                        }
                        await this.Client.CloudHsmClusterPrivateEndpointConnectionsDelete(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.CloudHsmClusterName ?? null, InputObject.PeConnectionName ?? null, onNoContent, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveAzHsmCloudHsmClusterPrivateEndpointConnection_DeleteViaIdentity" />
        /// cmdlet class.
        /// </summary>
        public RemoveAzHsmCloudHsmClusterPrivateEndpointConnection_DeleteViaIdentity()
        {
