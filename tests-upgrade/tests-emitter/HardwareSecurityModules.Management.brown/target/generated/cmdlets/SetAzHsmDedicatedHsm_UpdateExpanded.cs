...
namespace Microsoft.Azure.PowerShell.Cmdlets.Hsm.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"AzHsmDedicatedHsm_UpdateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Hsm.Models.IDedicatedHsm))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Hsm.Description(@"update a dedicated HSM in the specified subscription.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Hsm.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Hsm.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HardwareSecurityModules/dedicatedHSMs/{name}", ApiVersion = "2025-03-31")]
    public partial class SetAzHsmDedicatedHsm_UpdateExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Hsm.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Hsm.Models.IDedicatedHsm _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.Hsm.Models.DedicatedHsm();
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Hsm.Models.INetworkInterface[] ManagementNetworkProfileNetworkInterface { get => _parametersBody.ManagementNetworkProfileNetworkInterface?.ToArray() ?? null /* fixedArrayOf */; set => _parametersBody.ManagementNetworkProfileNetworkInterface = (value != null ? new System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Hsm.Models.INetworkInterface>(value) : null); }

        /// <summary>
        /// The Azure resource id in the form of /subscriptions/{SubscriptionId}/resourceGroups/{ResourceGroupName}/...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The Azure resource id in the form of /subscriptions/{SubscriptionId}/resourceGroups/{ResourceGroupName}/...")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Hsm.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Hsm.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Hsm.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string ManagementNetworkProfileSubnetResourceId { get => _parametersBody.ManagementNetworkProfileSubnetResourceId ?? null; set => _parametersBody.ManagementNetworkProfileSubnetResourceId = value; }
        ...
        SerializedName = @"networkInterfaces",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Hsm.Models.INetworkInterface) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Hsm.Models.INetworkInterface[] NetworkProfileNetworkInterface { get => _parametersBody.NetworkProfileNetworkInterface?.ToArray() ?? null /* fixedArrayOf */; set => _parametersBody.NetworkProfileNetworkInterface = (value != null ? new System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Hsm.Models.INetworkInterface>(value) : null); }
        ...
        SerializedName = @"resourceId",
        PossibleTypes = new [] { typeof(string) })]
        public string NetworkProfileSubnetResourceId { get => _parametersBody.NetworkProfileSubnetResourceId ?? null; set => _parametersBody.NetworkProfileSubnetResourceId = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        [Microsoft.Azure.PowerShell.Cmdlets.Hsm.Runtime.DefaultInfo(
        Name = @"",
        Description =@"",
        ...
        [global::Microsoft.Azure.PowerShell.Cmdlets.Hsm.ExportAs(typeof(global::System.Collections.Hashtable))]
        ...
        SerializedName = @"tags",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Hsm.Models.ITrackedResourceTags) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Hsm.Models.ITrackedResourceTags Tag { get => _parametersBody.Tag ?? null /* object */; set => _parametersBody.Tag = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Hsm.Models.IDedicatedHsmError">Microsoft.Azure.PowerShell.Cmdlets.Hsm.Models.IDedicatedHsmError</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onDefault method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Hsm.Models.IDedicatedHsmError> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Hsm.Models.IDedicatedHsm">Microsoft.Azure.PowerShell.Cmdlets.Hsm.Models.IDedicatedHsm</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Hsm.Models.IDedicatedHsm> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of SetAzHsmDedicatedHsm_UpdateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Hsm.Cmdlets.SetAzHsmDedicatedHsm_UpdateExpanded Clone()
        {
            var clone = new SetAzHsmDedicatedHsm_UpdateExpanded();
         ...
         async global::System.Threading.Tasks.Task Microsoft.Azure.PowerShell.Cmdlets.Hsm.Runtime.IEventListener.Signal(string id, global::System.Threading.CancellationToken token, global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Hsm.Runtime.EventData> messageData)
        {
            using( NoSynchronizationContext )
            {
                ...
                switch ( id )
                {
                    ...
                    case Microsoft.Azure.PowerShell.Cmdlets.Hsm.Runtime.Events.DelayBeforePolling:
                    {
                        var data = messageData();
                        if (true == MyInvocation?.BoundParameters?.ContainsKey("NoWait"))
                        {
                            if (data.ResponseMessage is System.Net.Http.HttpResponseMessage response)
                            {
                                ...
                                WriteObject(new Microsoft.Azure.PowerShell.Cmdlets.Hsm.Runtime.PowerShell.AsyncOperationResponse { Target = uri });
                                // do nothing more.
                                data.Cancel();
                                return;
                            }
            ...
            try
            {
                ...
                if (ShouldProcess($"Call remote 'DedicatedHsmCreateOrUpdate' operation"))
                {
                    if (true == MyInvocation?.BoundParameters?.ContainsKey("AsJob"))
                    {
                        ...
                        var job = new Microsoft.Azure.PowerShell.Cmdlets.Hsm.Runtime.PowerShell.AsyncJob(instance, this.MyInvocation.Line, this.MyInvocation.MyCommand.Name, this._cancellationTokenSource.Token, this._cancellationTokenSource.Cancel);
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.DedicatedHsmCreateOrUpdate(SubscriptionId, ResourceGroupName, Name, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Hsm.Runtime.SerializationMode.IncludeCreate);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SetAzHsmDedicatedHsm_UpdateExpanded" /> cmdlet class.
        /// </summary>
        public SetAzHsmDedicatedHsm_UpdateExpanded()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Hsm.Models.IDedicatedHsmError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    var ex = new Microsoft.Azure.PowerShell.Cmdlets.Hsm.Runtime.RestException<Microsoft.Azure.PowerShell.Cmdlets.Hsm.Models.IDedicatedHsmError>(responseMessage, await response);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Hsm.Models.IDedicatedHsm> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Hsm.Models.IDedicatedHsm
