...
namespace Microsoft.Azure.PowerShell.Cmdlets.Hsm.Models
{
    ...
    public partial class EndpointDependency :
        Microsoft.Azure.PowerShell.Cmdlets.Hsm.Models.IEndpointDependency,
        Microsoft.Azure.PowerShell.Cmdlets.Hsm.Models.IEndpointDependencyInternal
    {
        ...
        private System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Hsm.Models.IEndpointDetail> _endpointDetail;

        /// <summary>The Ports and Protocols used when connecting to domainName.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Hsm.Origin(Microsoft.Azure.PowerShell.Cmdlets.Hsm.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Hsm.Models.IEndpointDetail> EndpointDetail { get => this._endpointDetail; set => this._endpointDetail = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Hsm.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Hsm.Models.IEndpointDetail) })]
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Hsm.Models.IEndpointDetail> EndpointDetail { get; set; }
