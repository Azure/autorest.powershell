...
$dll = Join-Path $PSScriptRoot 'bin\Az.Hsm.private.dll'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Az.Hsm.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.Hsm.psd1'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: Hsm cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.Hsm.format.ps1xml'
...
if (-not $DisableAfterBuildTasks){
  ...
  $afterBuildTasksArgs = ConvertFrom-Json '{"SubModuleName":"Az.Hsm","ModuleRootName":"$(root-module-name)"}' -AsHashtable
