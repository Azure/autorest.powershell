...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models
{
    ...
    public partial class VaultPropertiesMoveDetails :
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IVaultPropertiesMoveDetails,
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IVaultPropertiesMoveDetailsInternal
    {
        ...
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IVaultPropertiesMoveDetailsInternal.CompletionTimeUtc { get => this._completionTimeUtc; set { {_completionTimeUtc = value;} } }

        /// <summary>Internal Acessors for OperationId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IVaultPropertiesMoveDetailsInternal.OperationId { get => this._operationId; set { {_operationId = value;} } }

        /// <summary>Internal Acessors for SourceResourceId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IVaultPropertiesMoveDetailsInternal.SourceResourceId { get => this._sourceResourceId; set { {_sourceResourceId = value;} } }

        /// <summary>Internal Acessors for StartTimeUtc</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IVaultPropertiesMoveDetailsInternal.StartTimeUtc { get => this._startTimeUtc; set { {_startTimeUtc = value;} } }

        /// <summary>Internal Acessors for TargetResourceId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IVaultPropertiesMoveDetailsInternal.TargetResourceId { get => this._targetResourceId; set { {_targetResourceId = value;} } }
