...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models
{
    ...
    public partial class ReplicationUsage :
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IReplicationUsage,
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IReplicationUsageInternal
    {
        ...
        public int? JobSummaryFailedJob { get => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IJobsSummaryInternal)JobsSummary).FailedJob; set => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IJobsSummaryInternal)JobsSummary).FailedJob = value ?? default(int); }

        /// <summary>Count of in-progress jobs.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.PropertyOrigin.Inlined)]
        public int? JobSummaryInProgressJob { get => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IJobsSummaryInternal)JobsSummary).InProgressJob; set => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IJobsSummaryInternal)JobsSummary).InProgressJob = value ?? default(int); }

        /// <summary>Count of suspended jobs.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.PropertyOrigin.Inlined)]
        public int? JobSummarySuspendedJob { get => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IJobsSummaryInternal)JobsSummary).SuspendedJob; set => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IJobsSummaryInternal)JobsSummary).SuspendedJob = value ?? default(int); }

        /// <summary>Backing field for <see cref="JobsSummary" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IJobsSummary _jobsSummary;

        /// <summary>Summary of the replication jobs data for this vault.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IJobsSummary JobsSummary { get => (this._jobsSummary = this._jobsSummary ?? new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.JobsSummary()); set => this._jobsSummary = value; }

        /// <summary>Internal Acessors for JobsSummary</summary>
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IJobsSummary Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IReplicationUsageInternal.JobsSummary { get => (this._jobsSummary = this._jobsSummary ?? new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.JobsSummary()); set { {_jobsSummary = value;} } }

        /// <summary>Internal Acessors for MonitoringSummary</summary>
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IMonitoringSummary Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IReplicationUsageInternal.MonitoringSummary { get => (this._monitoringSummary = this._monitoringSummary ?? new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.MonitoringSummary()); set { {_monitoringSummary = value;} } }

        /// <summary>Backing field for <see cref="MonitoringSummary" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IMonitoringSummary _monitoringSummary;

        /// <summary>Summary of the replication monitoring data for this vault.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IMonitoringSummary MonitoringSummary { get => (this._monitoringSummary = this._monitoringSummary ?? new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.MonitoringSummary()); set => this._monitoringSummary = value; }

        /// <summary>Count of all deprecated recovery service providers.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.PropertyOrigin.Inlined)]
        public int? MonitoringSummaryDeprecatedProviderCount { get => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IMonitoringSummaryInternal)MonitoringSummary).DeprecatedProviderCount; set => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IMonitoringSummaryInternal)MonitoringSummary).DeprecatedProviderCount = value ?? default(int); }

        /// <summary>Count of all critical warnings.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.PropertyOrigin.Inlined)]
        public int? MonitoringSummaryEventsCount { get => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IMonitoringSummaryInternal)MonitoringSummary).EventsCount; set => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IMonitoringSummaryInternal)MonitoringSummary).EventsCount = value ?? default(int); }

        /// <summary>Count of all the supported recovery service providers.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.PropertyOrigin.Inlined)]
        public int? MonitoringSummarySupportedProviderCount { get => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IMonitoringSummaryInternal)MonitoringSummary).SupportedProviderCount; set => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IMonitoringSummaryInternal)MonitoringSummary).SupportedProviderCount = value ?? default(int); }

        /// <summary>Count of unhealthy replication providers.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.PropertyOrigin.Inlined)]
        public int? MonitoringSummaryUnHealthyProviderCount { get => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IMonitoringSummaryInternal)MonitoringSummary).UnHealthyProviderCount; set => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IMonitoringSummaryInternal)MonitoringSummary).UnHealthyProviderCount = value ?? default(int); }

        /// <summary>Count of unhealthy VMs.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.PropertyOrigin.Inlined)]
        public int? MonitoringSummaryUnHealthyVMCount { get => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IMonitoringSummaryInternal)MonitoringSummary).UnHealthyVMCount; set => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IMonitoringSummaryInternal)MonitoringSummary).UnHealthyVMCount = value ?? default(int); }

        /// <summary>Count of all the unsupported recovery service providers.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.PropertyOrigin.Inlined)]
        public int? MonitoringSummaryUnsupportedProviderCount { get => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IMonitoringSummaryInternal)MonitoringSummary).UnsupportedProviderCount; set => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IMonitoringSummaryInternal)MonitoringSummary).UnsupportedProviderCount = value ?? default(int); }
...

    {
        ...
        int? JobSummarySuspendedJob { get; set; }
        /// <summary>Summary of the replication jobs data for this vault.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IJobsSummary JobsSummary { get; set; }
        /// <summary>Summary of the replication monitoring data for this vault.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IMonitoringSummary MonitoringSummary { get; set; }
        /// <summary>Count of all deprecated recovery service providers.</summary>
        int? MonitoringSummaryDeprecatedProviderCount { get; set; }
        /// <summary>Count of all critical warnings.</summary>
        int? MonitoringSummaryEventsCount { get; set; }
