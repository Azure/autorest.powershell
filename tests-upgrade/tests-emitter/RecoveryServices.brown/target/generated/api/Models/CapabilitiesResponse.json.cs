...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models
{
    ...
    public partial class CapabilitiesResponse
    {
        ...
        internal CapabilitiesResponse(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.Json.JsonObject json)
        {
            ...
            __resourceCapabilitiesBase = new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.ResourceCapabilitiesBase(json);
            {_property = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.CapabilitiesResponseProperties.FromJson(__jsonProperties) : _property;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.ICapabilitiesResponse.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.ICapabilitiesResponse.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.ICapabilitiesResponse FromJson(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.Json.JsonNode node)
        {
