...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models
{
    ...
    public partial class VaultUsage :
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IVaultUsage,
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IVaultUsageInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.INameInfo Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IVaultUsageInternal.Name { get => (this._name = this._name ?? new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.NameInfo()); set { {_name = value;} } }

        /// <summary>Backing field for <see cref="Name" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.INameInfo _name;

        /// <summary>Name of usage.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.INameInfo Name { get => (this._name = this._name ?? new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.NameInfo()); set => this._name = value; }
        ...
        public string NameLocalizedValue { get => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.INameInfoInternal)Name).LocalizedValue; set => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.INameInfoInternal)Name).LocalizedValue = value ?? null; }

        /// <summary>Value of usage.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.PropertyOrigin.Inlined)]
        public string NameValue { get => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.INameInfoInternal)Name).Value; set => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.INameInfoInternal)Name).Value = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.IJsonSerializable
    {
        ...
        SerializedName = @"unit",
        PossibleTypes = new [] { typeof(string) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.PSArgumentCompleterAttribute("Count", "Bytes", "Seconds", "Percent", "CountPerSecond", "BytesPerSecond")]
        string Unit { get; set; }
...

    {
        ...
        long? Limit { get; set; }
        /// <summary>Name of usage.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.INameInfo Name { get; set; }
        /// <summary>Localized value of usage.</summary>
        string NameLocalizedValue { get; set; }
        /// <summary>Value of usage.</summary>
        string NameValue { get; set; }
