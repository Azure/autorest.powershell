...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models
{
    ...
    public partial class PrivateLinkServiceConnectionState :
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IPrivateLinkServiceConnectionState,
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IPrivateLinkServiceConnectionStateInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IPrivateLinkServiceConnectionStateInternal.ActionsRequired { get => this._actionsRequired; set { {_actionsRequired = value;} } }

        /// <summary>Internal Acessors for Description</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IPrivateLinkServiceConnectionStateInternal.Description { get => this._description; set { {_description = value;} } }

        /// <summary>Internal Acessors for Status</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IPrivateLinkServiceConnectionStateInternal.Status { get => this._status; set { {_status = value;} } }
