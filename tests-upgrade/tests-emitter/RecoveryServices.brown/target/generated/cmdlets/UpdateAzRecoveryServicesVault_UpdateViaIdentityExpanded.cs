...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Description(@"update a Recovery Services vault.")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.IContext
    {
        ...
        {
            bool supportsSystemAssignedIdentity = (true == this.EnableSystemAssignedIdentity || null == this.EnableSystemAssignedIdentity && true == _vaultBody?.IdentityType?.Contains("SystemAssigned"));
            ...
            supportsUserAssignedIdentity = true == this.MyInvocation?.BoundParameters?.ContainsKey("UserAssignedIdentity") && this.UserAssignedIdentity?.Length > 0 ||
                    true != this.MyInvocation?.BoundParameters?.ContainsKey("UserAssignedIdentity") && true == _vaultBody.IdentityType?.Contains("UserAssigned");
            if (!supportsUserAssignedIdentity)
            {
                _vaultBody.IdentityUserAssignedIdentity = null;
            }
            ...
            {
                _vaultBody.IdentityType = "SystemAssigned";
            }
            else
            {
                _vaultBody.IdentityType = "None";
            }
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        _vaultBody = await this.Client.VaultsGetViaIdentityWithResult(InputObject.Id, this, Pipeline);
                        this.PreProcessManagedIdentityParametersWithGetResult();
                        this.Update_vaultBody();
                        await this.Client.VaultsCreateOrUpdateViaIdentity(InputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("XmsAuthorizationAuxiliary") ? XmsAuthorizationAuxiliary : null, _vaultBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _vaultBody = await this.Client.VaultsGetWithResult(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.VaultName ?? null, this, Pipeline);
                        this.PreProcessManagedIdentityParametersWithGetResult();
                        this.Update_vaultBody();
                        await this.Client.VaultsCreateOrUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.VaultName ?? null, this.InvocationInformation.BoundParameters.ContainsKey("XmsAuthorizationAuxiliary") ? XmsAuthorizationAuxiliary : null, _vaultBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzRecoveryServicesVault_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        ...
        private void Update_vaultBody()
        {
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("Tag")))
            {
                this.Tag = (Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.ITrackedResourceTags)(this.MyInvocation?.BoundParameters["Tag"]);
            }
            ...
            {
                this.SkuCapacity = (string)(this.MyInvocation?.BoundParameters["SkuCapacity"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("EncryptionInfrastructureEncryption")))
            {
                this.EncryptionInfrastructureEncryption = (string)(this.MyInvocation?.BoundParameters["EncryptionInfrastructureEncryption"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("RedundancySettingStandardTierStorageRedundancy")))
            {
                this.RedundancySettingStandardTierStorageRedundancy = (string)(this.MyInvocation?.BoundParameters["RedundancySettingStandardTierStorageRedundancy"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("RedundancySettingCrossRegionRestore")))
            {
                this.RedundancySettingCrossRegionRestore = (string)(this.MyInvocation?.BoundParameters["RedundancySettingCrossRegionRestore"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("SourceScanConfigurationState")))
            {
                this.SourceScanConfigurationState = (string)(this.MyInvocation?.BoundParameters["SourceScanConfigurationState"]);
            }
            ...
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("KekIdentityUseSystemAssignedIdentity")))
            {
                this.KekIdentityUseSystemAssignedIdentity = (global::System.Management.Automation.SwitchParameter)(this.MyInvocation?.BoundParameters["KekIdentityUseSystemAssignedIdentity"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("KekIdentityUserAssignedIdentity")))
            {
                this.KekIdentityUserAssignedIdentity = (string)(this.MyInvocation?.BoundParameters["KekIdentityUserAssignedIdentity"]);
            }
            ...
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("AzureMonitorAlertSettingAlertsForAllReplicationIssue")))
            {
                this.AzureMonitorAlertSettingAlertsForAllReplicationIssue = (string)(this.MyInvocation?.BoundParameters["AzureMonitorAlertSettingAlertsForAllReplicationIssue"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("AzureMonitorAlertSettingAlertsForAllFailoverIssue")))
            {
                this.AzureMonitorAlertSettingAlertsForAllFailoverIssue = (string)(this.MyInvocation?.BoundParameters["AzureMonitorAlertSettingAlertsForAllFailoverIssue"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("ClassicAlertSettingAlertsForCriticalOperation")))
            {
                this.ClassicAlertSettingAlertsForCriticalOperation = (string)(this.MyInvocation?.BoundParameters["ClassicAlertSettingAlertsForCriticalOperation"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("ClassicAlertSettingEmailNotificationsForSiteRecovery")))
            {
                this.ClassicAlertSettingEmailNotificationsForSiteRecovery = (string)(this.MyInvocation?.BoundParameters["ClassicAlertSettingEmailNotificationsForSiteRecovery"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("CrossSubscriptionRestoreSettingCrossSubscriptionRestoreState")))
            {
                this.CrossSubscriptionRestoreSettingCrossSubscriptionRestoreState = (string)(this.MyInvocation?.BoundParameters["CrossSubscriptionRestoreSettingCrossSubscriptionRestoreState"]);
            }
            ...
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("SoftDeleteSettingSoftDeleteState")))
            {
                this.SoftDeleteSettingSoftDeleteState = (string)(this.MyInvocation?.BoundParameters["SoftDeleteSettingSoftDeleteState"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("SoftDeleteSettingSoftDeleteRetentionPeriodInDay")))
            {
                this.SoftDeleteSettingSoftDeleteRetentionPeriodInDay = (int)(this.MyInvocation?.BoundParameters["SoftDeleteSettingSoftDeleteRetentionPeriodInDay"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("SoftDeleteSettingEnhancedSecurityState")))
            {
                this.SoftDeleteSettingEnhancedSecurityState = (string)(this.MyInvocation?.BoundParameters["SoftDeleteSettingEnhancedSecurityState"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("SourceScanIdentityOperationIdentityType")))
            {
                this.SourceScanIdentityOperationIdentityType = (string)(this.MyInvocation?.BoundParameters["SourceScanIdentityOperationIdentityType"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("SourceScanIdentityUserAssignedIdentity")))
            {
                this.SourceScanIdentityUserAssignedIdentity = (string)(this.MyInvocation?.BoundParameters["SourceScanIdentityUserAssignedIdentity"]);
            }
        }
