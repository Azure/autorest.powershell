...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListBySubscriptionId=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.RecoveryServices/vaults"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzRecoveryServicesVault_List")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IVault))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Description(@"Fetches all the resources of the specified type in the subscription.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Microsoft.RecoveryServices/vaults", ApiVersion = "2025-02-01")]
    public partial class GetAzRecoveryServicesVault_List : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.IContext
    {
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IVaultList">Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IVaultList</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IVaultList> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzRecoveryServicesVault_List" /> cmdlet class.
        /// </summary>
        public GetAzRecoveryServicesVault_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.VaultsListBySubscriptionId(SubscriptionId, onOk, onDefault, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IVaultList> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IVaultList
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.VaultsListBySubscriptionId_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
