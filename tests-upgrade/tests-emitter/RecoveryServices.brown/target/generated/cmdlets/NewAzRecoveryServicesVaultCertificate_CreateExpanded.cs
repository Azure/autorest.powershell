...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Create=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/certificates/{certificateName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzRecoveryServicesVaultCertificate_CreateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IVaultCertificateResponse))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Description(@"Uploads a certificate for a resource.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/certificates/{certificateName}", ApiVersion = "2025-02-01")]
    public partial class NewAzRecoveryServicesVaultCertificate_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.ICertificateRequest _certificateRequestBody = new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.CertificateRequest();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Specifies the authentication type.")]
        ...
        public string AuthType { get => _certificateRequestBody.AuthType ?? null; set => _certificateRequestBody.AuthType = value; }
        ...
        internal byte[] Certificate { get => _certificateRequestBody.Certificate ?? null /* byte array */; set => _certificateRequestBody.Certificate = value; }

        /// <summary>Input File for Certificate (The base64 encoded certificate raw data string)</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Input File for Certificate (The base64 encoded certificate raw data string)")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Category(global::Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.ParameterCategory.Body)]
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Certificate friendly name.")]
        [Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IErrorResponse">Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IErrorResponse</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onDefault method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IErrorResponse> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IVaultCertificateResponse">Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IVaultCertificateResponse</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IVaultCertificateResponse> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAzRecoveryServicesVaultCertificate_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzRecoveryServicesVaultCertificate_CreateExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'VaultCertificatesCreate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.VaultCertificatesCreate(SubscriptionId, ResourceGroupName, VaultName, CertificateName, _certificateRequestBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.SerializationMode.IncludeCreate);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,VaultName=VaultName,CertificateName=CertificateName})
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    var ex = new Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.RestException<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IErrorResponse>(responseMessage, await response);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IVaultCertificateResponse> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.IVaultCertificateResponse
