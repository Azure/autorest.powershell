...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Runtime.IContext
    {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.RegisteredIdentitiesDelete(SubscriptionId, ResourceGroupName, VaultName, IdentityName, onNoContent, onDefault, this, Pipeline);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveAzRecoveryServicesRegisteredIdentity_Delete" /> cmdlet class.
        /// </summary>
