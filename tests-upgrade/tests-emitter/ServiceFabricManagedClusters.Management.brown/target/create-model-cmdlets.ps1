...
function CreateModelCmdlet {
    ...
    foreach ($Model in $Models)
    {
        ...
        if ($ObjectType.StartsWith('ServiceFabricManagedClusters')) {
            $ModulePrefix = ''
        } else {
            $ModulePrefix = 'ServiceFabricManagedClusters'
        }
...
#>
function ${cmdletName} {
    [Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.ModelCmdletAttribute()]
