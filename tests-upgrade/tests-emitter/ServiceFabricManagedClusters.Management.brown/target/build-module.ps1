...
$dll = Join-Path $PSScriptRoot 'bin\Az.ServiceFabricManagedClusters.private.dll'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Az.ServiceFabricManagedClusters.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.ServiceFabricManagedClusters.psd1'
$guid = Get-ModuleGuid -Psd1Path $psd1
$moduleName = 'Az.ServiceFabricManagedClusters'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: ServiceFabricManagedClusters cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.ServiceFabricManagedClusters.format.ps1xml'
...
if (-not $DisableAfterBuildTasks){
  ...
  $afterBuildTasksArgs = ConvertFrom-Json '{"SubModuleName":"Az.ServiceFabricManagedClusters","ModuleRootName":"$(root-module-name)"}' -AsHashtable
