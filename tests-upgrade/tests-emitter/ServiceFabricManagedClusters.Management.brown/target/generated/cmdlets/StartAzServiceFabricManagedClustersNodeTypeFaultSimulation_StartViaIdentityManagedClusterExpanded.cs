...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] StartFaultSimulation=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/managedClusters/{clusterName}/nodeTypes/{nodeTypeName}/startFaultSimulation"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Start, @"AzServiceFabricManagedClustersNodeTypeFaultSimulation_StartViaIdentityManagedClusterExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Models.IFaultSimulation))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Description(@"Starts a fault simulation on the node type.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/managedClusters/{clusterName}/nodeTypes/{nodeTypeName}/startFaultSimulation", ApiVersion = "2025-06-01-preview")]
    public partial class StartAzServiceFabricManagedClustersNodeTypeFaultSimulation_StartViaIdentityManagedClusterExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Models.IFaultSimulationContentWrapper _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Models.FaultSimulationContentWrapper();
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The absolute expiration timestamp (UTC) after which this fault simulation should be stopped if it's still active.")]
        ...
        public global::System.DateTime ConstraintExpirationTime { get => _parametersBody.ConstraintExpirationTime ?? default(global::System.DateTime); set => _parametersBody.ConstraintExpirationTime = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Models.IServiceFabricManagedClustersIdentity _managedClusterInputObject;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Models.IServiceFabricManagedClustersIdentity ManagedClusterInputObject { get => this._managedClusterInputObject; set => this._managedClusterInputObject = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Force the action to go through without any check on the cluster.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public global::System.Management.Automation.SwitchParameter ParameterForce { get => _parametersBody.ParameterForce ?? default(global::System.Management.Automation.SwitchParameter); set => _parametersBody.ParameterForce = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Models.IFaultSimulation">Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Models.IFaultSimulation</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Models.IFaultSimulation> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>
        /// a duplicate instance of StartAzServiceFabricManagedClustersNodeTypeFaultSimulation_StartViaIdentityManagedClusterExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Cmdlets.StartAzServiceFabricManagedClustersNodeTypeFaultSimulation_StartViaIdentityManagedClusterExpanded Clone()
        {
            var clone = new StartAzServiceFabricManagedClustersNodeTypeFaultSimulation_StartViaIdentityManagedClusterExpanded();
            ...
            clone.NodeTypeName = this.NodeTypeName;
            return clone;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'NodeTypesStartFaultSimulation' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.ManagedClusterInputObject.Id += $"/nodeTypes/{(global::System.Uri.EscapeDataString(this.NodeTypeName.ToString()))}";
                        await this.Client.NodeTypesStartFaultSimulationViaIdentity(ManagedClusterInputObject.Id, _parametersBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        if (null == ManagedClusterInputObject.ClusterName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("ManagedClusterInputObject has null value for ManagedClusterInputObject.ClusterName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, ManagedClusterInputObject) );
                        }
                        await this.Client.NodeTypesStartFaultSimulation(ManagedClusterInputObject.SubscriptionId ?? null, ManagedClusterInputObject.ResourceGroupName ?? null, ManagedClusterInputObject.ClusterName ?? null, NodeTypeName, _parametersBody, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { NodeTypeName=NodeTypeName})
                    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StartAzServiceFabricManagedClustersNodeTypeFaultSimulation_StartViaIdentityManagedClusterExpanded"
        /// /> cmdlet class.
        /// </summary>
        public StartAzServiceFabricManagedClustersNodeTypeFaultSimulation_StartViaIdentityManagedClusterExpanded()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Models.IFaultSimulation> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Models.IFaultSimulation
