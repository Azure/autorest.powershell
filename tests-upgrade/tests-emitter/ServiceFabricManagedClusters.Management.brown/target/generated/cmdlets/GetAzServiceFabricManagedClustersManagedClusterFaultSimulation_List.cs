...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListFaultSimulation=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/managedClusters/{clusterName}/listFaultSimulation"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzServiceFabricManagedClustersManagedClusterFaultSimulation_List", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Description(@"Gets the list of recent fault simulations for the cluster.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/managedClusters/{clusterName}/listFaultSimulation", ApiVersion = "2025-06-01-preview")]
    public partial class GetAzServiceFabricManagedClustersManagedClusterFaultSimulation_List : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzServiceFabricManagedClustersManagedClusterFaultSimulation_List" /> cmdlet
        /// class.
        /// </summary>
        public GetAzServiceFabricManagedClustersManagedClusterFaultSimulation_List()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ManagedClustersListFaultSimulation' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ManagedClustersListFaultSimulation(SubscriptionId, ResourceGroupName, ClusterName, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.ManagedClustersListFaultSimulation_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
