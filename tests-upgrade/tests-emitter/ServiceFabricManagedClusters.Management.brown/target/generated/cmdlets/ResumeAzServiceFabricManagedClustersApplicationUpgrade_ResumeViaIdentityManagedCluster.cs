...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ResumeUpgrade=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/managedClusters/{clusterName}/applications/{applicationName}/resumeUpgrade"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Resume, @"AzServiceFabricManagedClustersApplicationUpgrade_ResumeViaIdentityManagedCluster", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Description(@"Send a request to resume the current application upgrade. This will resume the application upgrade from where it was paused.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/managedClusters/{clusterName}/applications/{applicationName}/resumeUpgrade", ApiVersion = "2025-06-01-preview")]
    public partial class ResumeAzServiceFabricManagedClustersApplicationUpgrade_ResumeViaIdentityManagedCluster : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Models.IRuntimeResumeApplicationUpgradeParameters _parameter;

        /// <summary>
        /// Parameters for Resume Upgrade action. The upgrade domain name must be specified.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Parameters for Resume Upgrade action. The upgrade domain name must be specified.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Parameters for Resume Upgrade action. The upgrade domain name must be specified.",
        SerializedName = @"parameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Models.IRuntimeResumeApplicationUpgradeParameters) })]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Models.IRuntimeResumeApplicationUpgradeParameters Parameter { get => this._parameter; set => this._parameter = value; }
        ...
        /// <returns>
        /// a duplicate instance of ResumeAzServiceFabricManagedClustersApplicationUpgrade_ResumeViaIdentityManagedCluster
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Cmdlets.ResumeAzServiceFabricManagedClustersApplicationUpgrade_ResumeViaIdentityManagedCluster Clone()
        {
            var clone = new ResumeAzServiceFabricManagedClustersApplicationUpgrade_ResumeViaIdentityManagedCluster();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ApplicationsResumeUpgrade' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.ManagedClusterInputObject.Id += $"/applications/{(global::System.Uri.EscapeDataString(this.ApplicationName.ToString()))}";
                        await this.Client.ApplicationsResumeUpgradeViaIdentity(ManagedClusterInputObject.Id, Parameter, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ApplicationsResumeUpgrade(ManagedClusterInputObject.SubscriptionId ?? null, ManagedClusterInputObject.ResourceGroupName ?? null, ManagedClusterInputObject.ClusterName ?? null, ApplicationName, Parameter, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ApplicationName=ApplicationName})
                    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ResumeAzServiceFabricManagedClustersApplicationUpgrade_ResumeViaIdentityManagedCluster"
        /// /> cmdlet class.
        /// </summary>
        public ResumeAzServiceFabricManagedClustersApplicationUpgrade_ResumeViaIdentityManagedCluster()
        {
