...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Start=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/managedClusters/{clusterName}/nodeTypes/{nodeTypeName}/start"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Start, @"AzServiceFabricManagedClustersNodeType_StartViaIdentityManagedClusterExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Description(@"Starts one or more nodes on the node type. It will trigger an allocation of the fabric node if needed and activate them.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/managedClusters/{clusterName}/nodeTypes/{nodeTypeName}/start", ApiVersion = "2025-06-01-preview")]
    public partial class StartAzServiceFabricManagedClustersNodeType_StartViaIdentityManagedClusterExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Runtime.IContext
    {
        ...
        /// <returns>
        /// a duplicate instance of StartAzServiceFabricManagedClustersNodeType_StartViaIdentityManagedClusterExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Cmdlets.StartAzServiceFabricManagedClustersNodeType_StartViaIdentityManagedClusterExpanded Clone()
        {
            var clone = new StartAzServiceFabricManagedClustersNodeType_StartViaIdentityManagedClusterExpanded();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'NodeTypesStart' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (ManagedClusterInputObject?.Id != null)
                    {
                        ...
                        await this.Client.NodeTypesStartViaIdentity(ManagedClusterInputObject.Id, _parametersBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.NodeTypesStart(ManagedClusterInputObject.SubscriptionId ?? null, ManagedClusterInputObject.ResourceGroupName ?? null, ManagedClusterInputObject.ClusterName ?? null, Name, _parametersBody, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StartAzServiceFabricManagedClustersNodeType_StartViaIdentityManagedClusterExpanded"
        /// /> cmdlet class.
        /// </summary>
        public StartAzServiceFabricManagedClustersNodeType_StartViaIdentityManagedClusterExpanded()
        {
