...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ReadUpgrade=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/managedClusters/{clusterName}/applications/{applicationName}/fetchUpgradeStatus"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommunications.Read, @"AzServiceFabricManagedClustersApplicationUpgrade_ReadViaIdentityManagedCluster", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Description(@"Get the status of the latest application upgrade. It will query the cluster to find the status of the latest application upgrade.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/managedClusters/{clusterName}/applications/{applicationName}/fetchUpgradeStatus", ApiVersion = "2025-06-01-preview")]
    public partial class ReadAzServiceFabricManagedClustersApplicationUpgrade_ReadViaIdentityManagedCluster : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Runtime.IContext
    {
        ...
        /// <returns>
        /// a duplicate instance of ReadAzServiceFabricManagedClustersApplicationUpgrade_ReadViaIdentityManagedCluster
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Cmdlets.ReadAzServiceFabricManagedClustersApplicationUpgrade_ReadViaIdentityManagedCluster Clone()
        {
            var clone = new ReadAzServiceFabricManagedClustersApplicationUpgrade_ReadViaIdentityManagedCluster();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ApplicationsReadUpgrade' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (ManagedClusterInputObject?.Id != null)
                    {
                        ...
                        await this.Client.ApplicationsReadUpgradeViaIdentity(ManagedClusterInputObject.Id, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ApplicationsReadUpgrade(ManagedClusterInputObject.SubscriptionId ?? null, ManagedClusterInputObject.ResourceGroupName ?? null, ManagedClusterInputObject.ClusterName ?? null, ApplicationName, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ReadAzServiceFabricManagedClustersApplicationUpgrade_ReadViaIdentityManagedCluster"
        /// /> cmdlet class.
        /// </summary>
        public ReadAzServiceFabricManagedClustersApplicationUpgrade_ReadViaIdentityManagedCluster()
        {
