...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzServiceFabricManagedClustersDeallocateNodeType_DeallocateViaIdentityManagedCluster", SupportsShouldProcess = true)]
    ...
    public partial class InvokeAzServiceFabricManagedClustersDeallocateNodeType_DeallocateViaIdentityManagedCluster : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Models.INodeTypeActionParameters _parameter;
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Parameters for Node type action. If nodes are not specified on the parameters, the operation will be performed in all nodes of the node type one upgrade domain at a time.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Models.INodeTypeActionParameters) })]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Models.INodeTypeActionParameters Parameter { get => this._parameter; set => this._parameter = value; }
        ...
        /// <returns>
        /// a duplicate instance of InvokeAzServiceFabricManagedClustersDeallocateNodeType_DeallocateViaIdentityManagedCluster
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Cmdlets.InvokeAzServiceFabricManagedClustersDeallocateNodeType_DeallocateViaIdentityManagedCluster Clone()
        {
            var clone = new InvokeAzServiceFabricManagedClustersDeallocateNodeType_DeallocateViaIdentityManagedCluster();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InvokeAzServiceFabricManagedClustersDeallocateNodeType_DeallocateViaIdentityManagedCluster"
        /// /> cmdlet class.
        /// </summary>
        public InvokeAzServiceFabricManagedClustersDeallocateNodeType_DeallocateViaIdentityManagedCluster()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (ManagedClusterInputObject?.Id != null)
                    {
                        ...
                        await this.Client.NodeTypesDeallocateViaIdentity(ManagedClusterInputObject.Id, Parameter, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.NodeTypesDeallocate(ManagedClusterInputObject.SubscriptionId ?? null, ManagedClusterInputObject.ResourceGroupName ?? null, ManagedClusterInputObject.ClusterName ?? null, NodeTypeName, Parameter, onOk, onDefault, this, Pipeline);
                    }
