...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Deallocate=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/managedClusters/{clusterName}/nodeTypes/{nodeTypeName}/deallocate"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzServiceFabricManagedClustersDeallocateNodeType_DeallocateViaIdentityManagedClusterExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Description(@"Deallocates one or more nodes on the node type. It will disable the fabric nodes, trigger a shutdown on the VMs and release them from the cluster.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/managedClusters/{clusterName}/nodeTypes/{nodeTypeName}/deallocate", ApiVersion = "2025-06-01-preview")]
    public partial class InvokeAzServiceFabricManagedClustersDeallocateNodeType_DeallocateViaIdentityManagedClusterExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Runtime.IContext
    {
        ...
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Models.INodeTypeActionParameters _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Models.NodeTypeActionParameters();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Force the action to go through.")]
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "List of node names from the node type.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public string[] Node { get => _parametersBody.Node?.ToArray() ?? null /* fixedArrayOf */; set => _parametersBody.Node = (value != null ? new System.Collections.Generic.List<string>(value) : null); }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Specifies the way the operation will be performed.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public string UpdateType { get => _parametersBody.UpdateType ?? null; set => _parametersBody.UpdateType = value; }
        ...
        /// <returns>
        /// a duplicate instance of InvokeAzServiceFabricManagedClustersDeallocateNodeType_DeallocateViaIdentityManagedClusterExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Cmdlets.InvokeAzServiceFabricManagedClustersDeallocateNodeType_DeallocateViaIdentityManagedClusterExpanded Clone()
        {
            var clone = new InvokeAzServiceFabricManagedClustersDeallocateNodeType_DeallocateViaIdentityManagedClusterExpanded();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InvokeAzServiceFabricManagedClustersDeallocateNodeType_DeallocateViaIdentityManagedClusterExpanded"
        /// /> cmdlet class.
        /// </summary>
        public InvokeAzServiceFabricManagedClustersDeallocateNodeType_DeallocateViaIdentityManagedClusterExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'NodeTypesDeallocate' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (ManagedClusterInputObject?.Id != null)
                    {
                        ...
                        await this.Client.NodeTypesDeallocateViaIdentity(ManagedClusterInputObject.Id, _parametersBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.NodeTypesDeallocate(ManagedClusterInputObject.SubscriptionId ?? null, ManagedClusterInputObject.ResourceGroupName ?? null, ManagedClusterInputObject.ClusterName ?? null, NodeTypeName, _parametersBody, onOk, onDefault, this, Pipeline);
                    }
