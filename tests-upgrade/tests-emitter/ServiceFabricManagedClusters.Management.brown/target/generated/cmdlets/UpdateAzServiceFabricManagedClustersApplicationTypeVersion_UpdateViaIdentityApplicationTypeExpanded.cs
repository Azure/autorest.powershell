...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Update=>PATCH:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/managedClusters/{clusterName}/applicationTypes/{applicationTypeName}/versions/{version}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzServiceFabricManagedClustersApplicationTypeVersion_UpdateViaIdentityApplicationTypeExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Models.IApplicationTypeVersionResource))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Description(@"update the tags of an application type version resource of a given managed cluster.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/managedClusters/{clusterName}/applicationTypes/{applicationTypeName}/versions/{version}", ApiVersion = "2025-06-01-preview")]
    public partial class UpdateAzServiceFabricManagedClustersApplicationTypeVersion_UpdateViaIdentityApplicationTypeExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Models.IApplicationTypeVersionUpdateParameters _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Models.ApplicationTypeVersionUpdateParameters();
        ...
        /// <summary>Backing field for <see cref="ApplicationTypeInputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Models.IServiceFabricManagedClustersIdentity _applicationTypeInputObject;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Models.IServiceFabricManagedClustersIdentity ApplicationTypeInputObject { get => this._applicationTypeInputObject; set => this._applicationTypeInputObject = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Application type version update parameters")]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Models.IApplicationTypeVersionUpdateParametersTags Tag { get => _parametersBody.Tag ?? null /* object */; set => _parametersBody.Tag = value; }

        /// <summary>Backing field for <see cref="Version" /> property.</summary>
        private string _version;

        /// <summary>The application type version.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The application type version.")]
        [Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Models.IApplicationTypeVersionResource">Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Models.IApplicationTypeVersionResource</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Models.IApplicationTypeVersionResource> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ApplicationTypeVersionsUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (ApplicationTypeInputObject?.Id != null)
                    {
                        this.ApplicationTypeInputObject.Id += $"/versions/{(global::System.Uri.EscapeDataString(this.Version.ToString()))}";
                        await this.Client.ApplicationTypeVersionsUpdateViaIdentity(ApplicationTypeInputObject.Id, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == ApplicationTypeInputObject.SubscriptionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("ApplicationTypeInputObject has null value for ApplicationTypeInputObject.SubscriptionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, ApplicationTypeInputObject) );
                        }
                        if (null == ApplicationTypeInputObject.ResourceGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("ApplicationTypeInputObject has null value for ApplicationTypeInputObject.ResourceGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, ApplicationTypeInputObject) );
                        }
                        if (null == ApplicationTypeInputObject.ClusterName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("ApplicationTypeInputObject has null value for ApplicationTypeInputObject.ClusterName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, ApplicationTypeInputObject) );
                        }
                        if (null == ApplicationTypeInputObject.ApplicationTypeName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("ApplicationTypeInputObject has null value for ApplicationTypeInputObject.ApplicationTypeName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, ApplicationTypeInputObject) );
                        }
                        await this.Client.ApplicationTypeVersionsUpdate(ApplicationTypeInputObject.SubscriptionId ?? null, ApplicationTypeInputObject.ResourceGroupName ?? null, ApplicationTypeInputObject.ClusterName ?? null, ApplicationTypeInputObject.ApplicationTypeName ?? null, Version, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzServiceFabricManagedClustersApplicationTypeVersion_UpdateViaIdentityApplicationTypeExpanded"
        /// /> cmdlet class.
        /// </summary>
        public UpdateAzServiceFabricManagedClustersApplicationTypeVersion_UpdateViaIdentityApplicationTypeExpanded()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Models.IApplicationTypeVersionResource> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Models.IApplicationTypeVersionResource
