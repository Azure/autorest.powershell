...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Restart=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/managedClusters/{clusterName}/nodeTypes/{nodeTypeName}/restart"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Restart, @"AzServiceFabricManagedClustersNodeType_RestartViaIdentityManagedClusterExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Description(@"Restarts one or more nodes on the node type. It will disable the fabric nodes, trigger a restart on the VMs and activate the nodes back again.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/managedClusters/{clusterName}/nodeTypes/{nodeTypeName}/restart", ApiVersion = "2025-06-01-preview")]
    public partial class RestartAzServiceFabricManagedClustersNodeType_RestartViaIdentityManagedClusterExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Runtime.IContext
    {
        ...
        /// <returns>
        /// a duplicate instance of RestartAzServiceFabricManagedClustersNodeType_RestartViaIdentityManagedClusterExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Cmdlets.RestartAzServiceFabricManagedClustersNodeType_RestartViaIdentityManagedClusterExpanded Clone()
        {
            var clone = new RestartAzServiceFabricManagedClustersNodeType_RestartViaIdentityManagedClusterExpanded();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'NodeTypesRestart' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.ManagedClusterInputObject.Id += $"/nodeTypes/{(global::System.Uri.EscapeDataString(this.Name.ToString()))}";
                        await this.Client.NodeTypesRestartViaIdentity(ManagedClusterInputObject.Id, _parametersBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.NodeTypesRestart(ManagedClusterInputObject.SubscriptionId ?? null, ManagedClusterInputObject.ResourceGroupName ?? null, ManagedClusterInputObject.ClusterName ?? null, Name, _parametersBody, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RestartAzServiceFabricManagedClustersNodeType_RestartViaIdentityManagedClusterExpanded"
        /// /> cmdlet class.
        /// </summary>
        public RestartAzServiceFabricManagedClustersNodeType_RestartViaIdentityManagedClusterExpanded()
        {
