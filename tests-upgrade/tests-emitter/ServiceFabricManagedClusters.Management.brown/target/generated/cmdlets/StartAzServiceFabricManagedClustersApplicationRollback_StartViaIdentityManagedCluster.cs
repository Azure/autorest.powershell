...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] StartRollback=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/managedClusters/{clusterName}/applications/{applicationName}/startRollback"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Start, @"AzServiceFabricManagedClustersApplicationRollback_StartViaIdentityManagedCluster", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Description(@"Send a request to start a rollback of the current application upgrade. This will start rolling back the application to the previous version.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/managedClusters/{clusterName}/applications/{applicationName}/startRollback", ApiVersion = "2025-06-01-preview")]
    public partial class StartAzServiceFabricManagedClustersApplicationRollback_StartViaIdentityManagedCluster : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Runtime.IContext
    {
        ...
        /// <returns>
        /// a duplicate instance of StartAzServiceFabricManagedClustersApplicationRollback_StartViaIdentityManagedCluster
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Cmdlets.StartAzServiceFabricManagedClustersApplicationRollback_StartViaIdentityManagedCluster Clone()
        {
            var clone = new StartAzServiceFabricManagedClustersApplicationRollback_StartViaIdentityManagedCluster();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ApplicationsStartRollback' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (ManagedClusterInputObject?.Id != null)
                    {
                        ...
                        await this.Client.ApplicationsStartRollbackViaIdentity(ManagedClusterInputObject.Id, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ApplicationsStartRollback(ManagedClusterInputObject.SubscriptionId ?? null, ManagedClusterInputObject.ResourceGroupName ?? null, ManagedClusterInputObject.ClusterName ?? null, ApplicationName, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StartAzServiceFabricManagedClustersApplicationRollback_StartViaIdentityManagedCluster"
        /// /> cmdlet class.
        /// </summary>
        public StartAzServiceFabricManagedClustersApplicationRollback_StartViaIdentityManagedCluster()
        {
