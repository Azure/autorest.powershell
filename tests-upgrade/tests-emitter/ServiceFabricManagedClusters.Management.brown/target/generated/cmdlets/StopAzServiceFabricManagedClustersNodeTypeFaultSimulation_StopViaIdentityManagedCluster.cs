...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] StopFaultSimulation=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/managedClusters/{clusterName}/nodeTypes/{nodeTypeName}/stopFaultSimulation"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Stop, @"AzServiceFabricManagedClustersNodeTypeFaultSimulation_StopViaIdentityManagedCluster", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Description(@"Stops a fault simulation on the node type.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/managedClusters/{clusterName}/nodeTypes/{nodeTypeName}/stopFaultSimulation", ApiVersion = "2025-06-01-preview")]
    public partial class StopAzServiceFabricManagedClustersNodeTypeFaultSimulation_StopViaIdentityManagedCluster : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Models.IFaultSimulationIdContent _parameter;

        /// <summary>Parameters for Fault Simulation id.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Parameters for Fault Simulation id.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Parameters for Fault Simulation id.",
        SerializedName = @"parameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Models.IFaultSimulationIdContent) })]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Models.IFaultSimulationIdContent Parameter { get => this._parameter; set => this._parameter = value; }
        ...
        /// <returns>
        /// a duplicate instance of StopAzServiceFabricManagedClustersNodeTypeFaultSimulation_StopViaIdentityManagedCluster
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Cmdlets.StopAzServiceFabricManagedClustersNodeTypeFaultSimulation_StopViaIdentityManagedCluster Clone()
        {
            var clone = new StopAzServiceFabricManagedClustersNodeTypeFaultSimulation_StopViaIdentityManagedCluster();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'NodeTypesStopFaultSimulation' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (ManagedClusterInputObject?.Id != null)
                    {
                        ...
                        await this.Client.NodeTypesStopFaultSimulationViaIdentity(ManagedClusterInputObject.Id, Parameter, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.NodeTypesStopFaultSimulation(ManagedClusterInputObject.SubscriptionId ?? null, ManagedClusterInputObject.ResourceGroupName ?? null, ManagedClusterInputObject.ClusterName ?? null, NodeTypeName, Parameter, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StopAzServiceFabricManagedClustersNodeTypeFaultSimulation_StopViaIdentityManagedCluster"
        /// /> cmdlet class.
        /// </summary>
        public StopAzServiceFabricManagedClustersNodeTypeFaultSimulation_StopViaIdentityManagedCluster()
        {
