...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzServiceFabricManagedClustersOperationResult_Get")]
    ...
    public partial class GetAzServiceFabricManagedClustersOperationResult_Get : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzServiceFabricManagedClustersOperationResult_Get" /> cmdlet class.
        /// </summary>
        public GetAzServiceFabricManagedClustersOperationResult_Get()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.OperationResultsGet(SubscriptionId, Location, OperationId, onOk, onAccepted, onNoContent, onDefault, this, Pipeline);
