...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Resume, @"AzServiceFabricManagedClustersApplicationUpgrade_ResumeViaIdentityManagedClusterExpanded", SupportsShouldProcess = true)]
    ...
    public partial class ResumeAzServiceFabricManagedClustersApplicationUpgrade_ResumeViaIdentityManagedClusterExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Runtime.IContext
    {
        ...
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Models.IRuntimeResumeApplicationUpgradeParameters _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Models.RuntimeResumeApplicationUpgradeParameters();
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The upgrade domain name. Expected to be the next upgrade domain if the application is upgrading.")]
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string UpgradeDomainName { get => _parametersBody.UpgradeDomainName ?? null; set => _parametersBody.UpgradeDomainName = value; }
        ...
        /// <returns>
        /// a duplicate instance of ResumeAzServiceFabricManagedClustersApplicationUpgrade_ResumeViaIdentityManagedClusterExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Cmdlets.ResumeAzServiceFabricManagedClustersApplicationUpgrade_ResumeViaIdentityManagedClusterExpanded Clone()
        {
            var clone = new ResumeAzServiceFabricManagedClustersApplicationUpgrade_ResumeViaIdentityManagedClusterExpanded();
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (ManagedClusterInputObject?.Id != null)
                    {
                        ...
                        await this.Client.ApplicationsResumeUpgradeViaIdentity(ManagedClusterInputObject.Id, _parametersBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ApplicationsResumeUpgrade(ManagedClusterInputObject.SubscriptionId ?? null, ManagedClusterInputObject.ResourceGroupName ?? null, ManagedClusterInputObject.ClusterName ?? null, ApplicationName, _parametersBody, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ResumeAzServiceFabricManagedClustersApplicationUpgrade_ResumeViaIdentityManagedClusterExpanded"
        /// /> cmdlet class.
        /// </summary>
        public ResumeAzServiceFabricManagedClustersApplicationUpgrade_ResumeViaIdentityManagedClusterExpanded()
        {
