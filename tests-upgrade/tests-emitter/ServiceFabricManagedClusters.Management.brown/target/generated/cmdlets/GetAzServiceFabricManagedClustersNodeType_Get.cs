...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzServiceFabricManagedClustersNodeType_Get")]
    ...
    public partial class GetAzServiceFabricManagedClustersNodeType_Get : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzServiceFabricManagedClustersNodeType_Get" /> cmdlet class.
        /// </summary>
        public GetAzServiceFabricManagedClustersNodeType_Get()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.NodeTypesGet(SubscriptionId, ResourceGroupName, ClusterName, Name, onOk, onDefault, this, Pipeline);
