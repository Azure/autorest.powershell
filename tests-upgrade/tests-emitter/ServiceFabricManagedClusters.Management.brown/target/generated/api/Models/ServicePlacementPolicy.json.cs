...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Models
{
    ...
    public partial class ServicePlacementPolicy
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Models.IServicePlacementPolicy.
        /// Note: the Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Models.IServicePlacementPolicy interface is
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Models.IServicePlacementPolicy.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Models.IServicePlacementPolicy FromJson(Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Runtime.Json.JsonNode node)
        {
            ...
            switch ( json.StringProperty("type") )
            {
                case "InvalidDomain":
                {
                    return new ServicePlacementInvalidDomainPolicy(json);
                }
                case "RequiredDomain":
                {
                    return new ServicePlacementRequiredDomainPolicy(json);
                }
                case "PreferredPrimaryDomain":
                {
                    return new ServicePlacementPreferPrimaryDomainPolicy(json);
                }
                case "RequiredDomainDistribution":
                {
                    return new ServicePlacementRequireDomainDistributionPolicy(json);
                }
                case "NonPartiallyPlaceService":
                {
                    return new ServicePlacementNonPartiallyPlaceServicePolicy(json);
                }
            }
            return new ServicePlacementPolicy(json);
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Runtime.Json.JsonObject into a new instance of <see cref="ServicePlacementPolicy" />.
        /// </summary>
        ...
        internal ServicePlacementPolicy(Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Runtime.Json.JsonObject json)
        {
        ...
        /// <summary>
        /// Serializes this instance of <see cref="ServicePlacementPolicy" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ServicePlacementPolicy" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Runtime.Json.JsonNode" />.
        /// </returns>
