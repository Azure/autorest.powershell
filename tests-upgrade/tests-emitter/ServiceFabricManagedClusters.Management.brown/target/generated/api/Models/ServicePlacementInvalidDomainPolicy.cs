...
namespace Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Models
{
    ...
    public partial class ServicePlacementInvalidDomainPolicy :
        Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Models.IServicePlacementInvalidDomainPolicy,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Runtime.IValidates
    {
        ...
        public string Type { get => "InvalidDomain"; set => ((Microsoft.Azure.PowerShell.Cmdlets.ServiceFabricManagedClusters.Models.IServicePlacementPolicyInternal)__servicePlacementPolicy).Type = "InvalidDomain"; }

        /// <summary>Creates an new <see cref="ServicePlacementInvalidDomainPolicy" /> instance.</summary>
        public ServicePlacementInvalidDomainPolicy()
        {
            this.__servicePlacementPolicy.Type = "InvalidDomain";
        }
    ...
    /// Describes the policy to be used for placement of a Service Fabric service where a particular fault or upgrade domain should
    /// not be used for placement of the instances or replicas of that service.
    internal partial interface IServicePlacementInvalidDomainPolicyInternal :
