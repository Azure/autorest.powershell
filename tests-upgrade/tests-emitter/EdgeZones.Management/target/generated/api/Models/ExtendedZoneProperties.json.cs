...
namespace Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models
{
    ...
    public partial class ExtendedZoneProperties
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonObject into a new instance of <see cref="ExtendedZoneProperties" />.
        /// </summary>
        ...
        internal ExtendedZoneProperties(Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonObject json)
        {
            ...
            {_registrationState = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonString>("registrationState"), out var __jsonRegistrationState) ? (string)__jsonRegistrationState : (string)_registrationState;}
            ...
            {_regionalDisplayName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonString>("regionalDisplayName"), out var __jsonRegionalDisplayName) ? (string)__jsonRegionalDisplayName : (string)_regionalDisplayName;}
            {_regionType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonString>("regionType"), out var __jsonRegionType) ? (string)__jsonRegionType : (string)_regionType;}
            {_regionCategory = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonString>("regionCategory"), out var __jsonRegionCategory) ? (string)__jsonRegionCategory : (string)_regionCategory;}
            {_geography = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonString>("geography"), out var __jsonGeography) ? (string)__jsonGeography : (string)_geography;}
            {_geographyGroup = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonString>("geographyGroup"), out var __jsonGeographyGroup) ? (string)__jsonGeographyGroup : (string)_geographyGroup;}
            {_longitude = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonString>("longitude"), out var __jsonLongitude) ? (string)__jsonLongitude : (string)_longitude;}
            {_latitude = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonString>("latitude"), out var __jsonLatitude) ? (string)__jsonLatitude : (string)_latitude;}
            {_homeLocation = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonString>("homeLocation"), out var __jsonHomeLocation) ? (string)__jsonHomeLocation : (string)_homeLocation;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models.IExtendedZoneProperties.
        /// </summary>
        ...
        /// <summary>
        /// Serializes this instance of <see cref="ExtendedZoneProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ExtendedZoneProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonNode" />.
        /// </returns>
