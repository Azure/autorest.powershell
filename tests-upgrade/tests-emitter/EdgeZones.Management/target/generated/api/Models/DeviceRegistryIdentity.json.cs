...
namespace Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Models
{
    ...
    public partial class DeviceRegistryIdentity
    {
        ...
        internal DeviceRegistryIdentity(Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonObject json)
        {
            ...
            {_extendedZoneName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DeviceRegistry.Runtime.Json.JsonString>("extendedZoneName"), out var __jsonExtendedZoneName) ? (string)__jsonExtendedZoneName : (string)_extendedZoneName;}
