...
namespace Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models
{
    ...
    public partial class ConnectionStringType :
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IConnectionStringType,
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IConnectionStringTypeInternal
    {

        /// <summary>Backing field for <see cref="AllConnectionString" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IAllConnectionStringType _allConnectionString;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IAllConnectionStringType AllConnectionString { get => (this._allConnectionString = this._allConnectionString ?? new Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.AllConnectionStringType()); set => this._allConnectionString = value; }
        ...
        public string AllConnectionStringHigh { get => ((Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IAllConnectionStringTypeInternal)AllConnectionString).High; set => ((Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IAllConnectionStringTypeInternal)AllConnectionString).High = value ?? null; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Origin(Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.PropertyOrigin.Inlined)]
        public string AllConnectionStringLow { get => ((Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IAllConnectionStringTypeInternal)AllConnectionString).Low; set => ((Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IAllConnectionStringTypeInternal)AllConnectionString).Low = value ?? null; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Origin(Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.PropertyOrigin.Inlined)]
        public string AllConnectionStringMedium { get => ((Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IAllConnectionStringTypeInternal)AllConnectionString).Medium; set => ((Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IAllConnectionStringTypeInternal)AllConnectionString).Medium = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IAllConnectionStringType Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IConnectionStringTypeInternal.AllConnectionString { get => (this._allConnectionString = this._allConnectionString ?? new Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.AllConnectionStringType()); set { {_allConnectionString = value;} } }

        /// <summary>Backing field for <see cref="Profile" /> property.</summary>
        private System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IProfileType> _profile;
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Origin(Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IProfileType> Profile { get => this._profile; set => this._profile = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Runtime.IJsonSerializable
    {
        ...
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IProfileType> Profile { get; set; }
...

    {
        ...
        /// Returns all connection strings that can be used to connect to the Autonomous Database.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IAllConnectionStringType AllConnectionString { get; set; }
        /// <summary>
        /// The High database service provides the highest level of resources to each SQL statement resulting in the highest performance,
        /// but supports the fewest number of concurrent SQL statements.
        /// </summary>
