...
namespace Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models
{
    ...
    public partial class ExadataIormConfig :
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IExadataIormConfig,
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IExadataIormConfigInternal
    {

        /// <summary>Backing field for <see cref="DbPlan" /> property.</summary>
        private System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IDbIormConfig> _dbPlan;
        ...
        public System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IDbIormConfig> DbPlan { get => this._dbPlan; set => this._dbPlan = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Runtime.IJsonSerializable
    {
        ...
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IDbIormConfig> DbPlan { get; set; }
        /// <summary>Additional information about the current lifecycleState.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Runtime.Info(
        Required = false,
        ReadOnly = false,
