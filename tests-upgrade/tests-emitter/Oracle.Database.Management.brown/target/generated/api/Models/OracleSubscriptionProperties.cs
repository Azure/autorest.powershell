...
namespace Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models
{
    ...
    public partial class OracleSubscriptionProperties :
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IOracleSubscriptionProperties,
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IOracleSubscriptionPropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IOracleSubscriptionPropertiesInternal.AddSubscriptionOperationState { get => this._addSubscriptionOperationState; set { {_addSubscriptionOperationState = value;} } }

        /// <summary>Internal Acessors for AzureSubscriptionId</summary>
        System.Collections.Generic.List<string> Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IOracleSubscriptionPropertiesInternal.AzureSubscriptionId { get => this._azureSubscriptionId; set { {_azureSubscriptionId = value;} } }

        /// <summary>Internal Acessors for CloudAccountId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IOracleSubscriptionPropertiesInternal.CloudAccountId { get => this._cloudAccountId; set { {_cloudAccountId = value;} } }

        /// <summary>Internal Acessors for CloudAccountState</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IOracleSubscriptionPropertiesInternal.CloudAccountState { get => this._cloudAccountState; set { {_cloudAccountState = value;} } }

        /// <summary>Internal Acessors for LastOperationStatusDetail</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IOracleSubscriptionPropertiesInternal.LastOperationStatusDetail { get => this._lastOperationStatusDetail; set { {_lastOperationStatusDetail = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IOracleSubscriptionPropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for SaasSubscriptionId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IOracleSubscriptionPropertiesInternal.SaasSubscriptionId { get => this._saasSubscriptionId; set { {_saasSubscriptionId = value;} } }
