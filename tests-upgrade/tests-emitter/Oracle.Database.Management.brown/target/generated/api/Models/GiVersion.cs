...
namespace Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models
{
    ...
    public partial class GiVersion :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IGiVersionInternal,
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Runtime.IValidates
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IGiVersionProperties Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IGiVersionInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.GiVersionProperties()); set { {_property = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IGiVersionProperties _property;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IGiVersionProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.GiVersionProperties()); set => this._property = value; }
        ...
        public string Version { get => ((Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IGiVersionPropertiesInternal)Property).Version; set => ((Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IGiVersionPropertiesInternal)Property).Version = value ?? null; }
    ...
    {
        /// <summary>The resource-specific properties for this resource.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IGiVersionProperties Property { get; set; }
        /// <summary>A valid Oracle Grid Infrastructure (GI) software version.</summary>
        string Version { get; set; }
