...
namespace Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models
{
    ...
    public partial class DbServerProperties :
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IDbServerProperties,
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IDbServerPropertiesInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IDbServerPatchingDetails _dbServerPatchingDetail;

        /// <summary>dbServerPatching details of the Db server.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Origin(Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IDbServerPatchingDetails DbServerPatchingDetail { get => (this._dbServerPatchingDetail = this._dbServerPatchingDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.DbServerPatchingDetails()); }
        ...
        public int? DbServerPatchingDetailEstimatedPatchDuration { get => ((Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IDbServerPatchingDetailsInternal)DbServerPatchingDetail).EstimatedPatchDuration; }

        /// <summary>Patching Status</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Origin(Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.PropertyOrigin.Inlined)]
        public string DbServerPatchingDetailPatchingStatus { get => ((Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IDbServerPatchingDetailsInternal)DbServerPatchingDetail).PatchingStatus; }

        /// <summary>Time Patching Ended</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Origin(Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.PropertyOrigin.Inlined)]
        public global::System.DateTime? DbServerPatchingDetailTimePatchingEnded { get => ((Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IDbServerPatchingDetailsInternal)DbServerPatchingDetail).TimePatchingEnded; }

        /// <summary>Time Patching Started</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Origin(Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.PropertyOrigin.Inlined)]
        public global::System.DateTime? DbServerPatchingDetailTimePatchingStarted { get => ((Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IDbServerPatchingDetailsInternal)DbServerPatchingDetail).TimePatchingStarted; }
        ...
        System.Collections.Generic.List<string> Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IDbServerPropertiesInternal.AutonomousVMClusterId { get => this._autonomousVMClusterId; set { {_autonomousVMClusterId = value;} } }

        /// <summary>Internal Acessors for AutonomousVirtualMachineId</summary>
        System.Collections.Generic.List<string> Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IDbServerPropertiesInternal.AutonomousVirtualMachineId { get => this._autonomousVirtualMachineId; set { {_autonomousVirtualMachineId = value;} } }

        /// <summary>Internal Acessors for CompartmentId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IDbServerPropertiesInternal.CompartmentId { get => this._compartmentId; set { {_compartmentId = value;} } }

        /// <summary>Internal Acessors for ComputeModel</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IDbServerPropertiesInternal.ComputeModel { get => this._computeModel; set { {_computeModel = value;} } }

        /// <summary>Internal Acessors for CpuCoreCount</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IDbServerPropertiesInternal.CpuCoreCount { get => this._cpuCoreCount; set { {_cpuCoreCount = value;} } }

        /// <summary>Internal Acessors for DbNodeId</summary>
        System.Collections.Generic.List<string> Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IDbServerPropertiesInternal.DbNodeId { get => this._dbNodeId; set { {_dbNodeId = value;} } }

        /// <summary>Internal Acessors for DbNodeStorageSizeInGb</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IDbServerPropertiesInternal.DbNodeStorageSizeInGb { get => this._dbNodeStorageSizeInGb; set { {_dbNodeStorageSizeInGb = value;} } }

        /// <summary>Internal Acessors for DbServerPatchingDetail</summary>
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IDbServerPatchingDetails Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IDbServerPropertiesInternal.DbServerPatchingDetail { get => (this._dbServerPatchingDetail = this._dbServerPatchingDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.DbServerPatchingDetails()); set { {_dbServerPatchingDetail = value;} } }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IDbServerPropertiesInternal.DisplayName { get => this._displayName; set { {_displayName = value;} } }

        /// <summary>Internal Acessors for ExadataInfrastructureId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IDbServerPropertiesInternal.ExadataInfrastructureId { get => this._exadataInfrastructureId; set { {_exadataInfrastructureId = value;} } }

        /// <summary>Internal Acessors for LifecycleDetail</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IDbServerPropertiesInternal.LifecycleDetail { get => this._lifecycleDetail; set { {_lifecycleDetail = value;} } }

        /// <summary>Internal Acessors for LifecycleState</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IDbServerPropertiesInternal.LifecycleState { get => this._lifecycleState; set { {_lifecycleState = value;} } }

        /// <summary>Internal Acessors for MaxCpuCount</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IDbServerPropertiesInternal.MaxCpuCount { get => this._maxCpuCount; set { {_maxCpuCount = value;} } }

        /// <summary>Internal Acessors for MaxDbNodeStorageInGb</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IDbServerPropertiesInternal.MaxDbNodeStorageInGb { get => this._maxDbNodeStorageInGb; set { {_maxDbNodeStorageInGb = value;} } }

        /// <summary>Internal Acessors for MaxMemoryInGb</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IDbServerPropertiesInternal.MaxMemoryInGb { get => this._maxMemoryInGb; set { {_maxMemoryInGb = value;} } }

        /// <summary>Internal Acessors for MemorySizeInGb</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IDbServerPropertiesInternal.MemorySizeInGb { get => this._memorySizeInGb; set { {_memorySizeInGb = value;} } }

        /// <summary>Internal Acessors for Ocid</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IDbServerPropertiesInternal.Ocid { get => this._ocid; set { {_ocid = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IDbServerPropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for Shape</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IDbServerPropertiesInternal.Shape { get => this._shape; set { {_shape = value;} } }

        /// <summary>Internal Acessors for TimeCreated</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IDbServerPropertiesInternal.TimeCreated { get => this._timeCreated; set { {_timeCreated = value;} } }

        /// <summary>Internal Acessors for VMClusterId</summary>
        System.Collections.Generic.List<string> Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IDbServerPropertiesInternal.VMClusterId { get => this._vMClusterId; set { {_vMClusterId = value;} } }
...

    {
        ...
        /// <summary>dbServerPatching details of the Db server.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IDbServerPatchingDetails DbServerPatchingDetail { get; set; }
        /// <summary>Estimated Patch Duration</summary>
