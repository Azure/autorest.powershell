...
namespace Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models
{
    ...
    public partial class ExascaleDbStorageVaultProperties :
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IExascaleDbStorageVaultProperties,
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IExascaleDbStorageVaultPropertiesInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IExascaleDbStorageDetails _highCapacityDatabaseStorage;

        /// <summary>Response exadata Database Storage Details</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Origin(Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IExascaleDbStorageDetails HighCapacityDatabaseStorage { get => (this._highCapacityDatabaseStorage = this._highCapacityDatabaseStorage ?? new Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.ExascaleDbStorageDetails()); }
        ...
        public int? HighCapacityDatabaseStorageAvailableSizeInGb { get => ((Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IExascaleDbStorageDetailsInternal)HighCapacityDatabaseStorage).AvailableSizeInGb; }

        /// <summary>Backing field for <see cref="HighCapacityDatabaseStorageInput" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IExascaleDbStorageInputDetails _highCapacityDatabaseStorageInput;

        /// <summary>Create exadata Database Storage Details</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Origin(Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IExascaleDbStorageInputDetails HighCapacityDatabaseStorageInput { get => (this._highCapacityDatabaseStorageInput = this._highCapacityDatabaseStorageInput ?? new Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.ExascaleDbStorageInputDetails()); set => this._highCapacityDatabaseStorageInput = value; }

        /// <summary>Total Capacity</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Origin(Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.PropertyOrigin.Inlined)]
        public int? HighCapacityDatabaseStorageInputTotalSizeInGb { get => ((Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IExascaleDbStorageInputDetailsInternal)HighCapacityDatabaseStorageInput).TotalSizeInGb; set => ((Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IExascaleDbStorageInputDetailsInternal)HighCapacityDatabaseStorageInput).TotalSizeInGb = value ?? default(int); }

        /// <summary>Total Capacity</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Origin(Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.PropertyOrigin.Inlined)]
        public int? HighCapacityDatabaseStorageTotalSizeInGb { get => ((Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IExascaleDbStorageDetailsInternal)HighCapacityDatabaseStorage).TotalSizeInGb; }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IExascaleDbStorageVaultPropertiesInternal.LifecycleDetail { get => this._lifecycleDetail; set { {_lifecycleDetail = value;} } }

        /// <summary>Internal Acessors for LifecycleState</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IExascaleDbStorageVaultPropertiesInternal.LifecycleState { get => this._lifecycleState; set { {_lifecycleState = value;} } }

        /// <summary>Internal Acessors for OciUrl</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IExascaleDbStorageVaultPropertiesInternal.OciUrl { get => this._ociUrl; set { {_ociUrl = value;} } }

        /// <summary>Internal Acessors for Ocid</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IExascaleDbStorageVaultPropertiesInternal.Ocid { get => this._ocid; set { {_ocid = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IExascaleDbStorageVaultPropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for VMClusterCount</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IExascaleDbStorageVaultPropertiesInternal.VMClusterCount { get => this._vMClusterCount; set { {_vMClusterCount = value;} } }
