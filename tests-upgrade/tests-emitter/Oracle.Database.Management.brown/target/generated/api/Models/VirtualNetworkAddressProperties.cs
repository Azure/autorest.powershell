...
namespace Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models
{
    ...
    public partial class VirtualNetworkAddressProperties :
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IVirtualNetworkAddressProperties,
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IVirtualNetworkAddressPropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IVirtualNetworkAddressPropertiesInternal.Domain { get => this._domain; set { {_domain = value;} } }

        /// <summary>Internal Acessors for LifecycleDetail</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IVirtualNetworkAddressPropertiesInternal.LifecycleDetail { get => this._lifecycleDetail; set { {_lifecycleDetail = value;} } }

        /// <summary>Internal Acessors for LifecycleState</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IVirtualNetworkAddressPropertiesInternal.LifecycleState { get => this._lifecycleState; set { {_lifecycleState = value;} } }

        /// <summary>Internal Acessors for Ocid</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IVirtualNetworkAddressPropertiesInternal.Ocid { get => this._ocid; set { {_ocid = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IVirtualNetworkAddressPropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for TimeAssigned</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IVirtualNetworkAddressPropertiesInternal.TimeAssigned { get => this._timeAssigned; set { {_timeAssigned = value;} } }
