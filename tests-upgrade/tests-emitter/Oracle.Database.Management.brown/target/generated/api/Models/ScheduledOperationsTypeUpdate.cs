...
namespace Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models
{
    ...
    public partial class ScheduledOperationsTypeUpdate :
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IScheduledOperationsTypeUpdate,
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IScheduledOperationsTypeUpdateInternal
    {

        /// <summary>Backing field for <see cref="DayOfWeek" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IDayOfWeekUpdate _dayOfWeek;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IDayOfWeekUpdate DayOfWeek { get => (this._dayOfWeek = this._dayOfWeek ?? new Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.DayOfWeekUpdate()); set => this._dayOfWeek = value; }
        ...
        public string DayOfWeekName { get => ((Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IDayOfWeekUpdateInternal)DayOfWeek).Name; set => ((Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IDayOfWeekUpdateInternal)DayOfWeek).Name = value ?? null; }

        /// <summary>Internal Acessors for DayOfWeek</summary>
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IDayOfWeekUpdate Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IScheduledOperationsTypeUpdateInternal.DayOfWeek { get => (this._dayOfWeek = this._dayOfWeek ?? new Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.DayOfWeekUpdate()); set { {_dayOfWeek = value;} } }
    ...
    {
        /// <summary>Day of week</summary>
        Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.Models.IDayOfWeekUpdate DayOfWeek { get; set; }
        /// <summary>Name of the day of the week.</summary>
        [global::Microsoft.Azure.PowerShell.Cmdlets.OracleDatabase.PSArgumentCompleterAttribute("Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday")]
        string DayOfWeekName { get; set; }
        /// <summary>auto start time. value must be of ISO-8601 format HH:mm</summary>
