...
$dll = Join-Path $PSScriptRoot 'bin\Az.OracleDatabase.private.dll'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Az.OracleDatabase.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.OracleDatabase.psd1'
$guid = Get-ModuleGuid -Psd1Path $psd1
$moduleName = 'Az.OracleDatabase'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: OracleDatabase cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.OracleDatabase.format.ps1xml'
...
if (-not $DisableAfterBuildTasks){
  ...
  $afterBuildTasksArgs = ConvertFrom-Json '{"SubModuleName":"Az.OracleDatabase","ModuleRootName":"$(root-module-name)"}' -AsHashtable
