        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.PrivateCloudInputObject.Id += $"/segments/{(global::System.Uri.EscapeDataString(this.SegmentId.ToString()))}";
                    ...
                    else
                    {
                        ...
                        await this.Client.WorkloadNetworksDeleteSegment(PrivateCloudInputObject.SubscriptionId ?? null, PrivateCloudInputObject.ResourceGroupName ?? null, PrivateCloudInputObject.PrivateCloudName ?? null, SegmentId, onOk, onNoContent, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SegmentId=SegmentId})
                    {
