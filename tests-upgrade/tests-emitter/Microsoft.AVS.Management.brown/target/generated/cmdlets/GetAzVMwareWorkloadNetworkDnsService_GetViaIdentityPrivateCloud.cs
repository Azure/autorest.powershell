        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.PrivateCloudInputObject.Id += $"/dnsServices/{(global::System.Uri.EscapeDataString(this.DnsServiceId.ToString()))}";
                    ...
                    else
                    {
                        ...
                        await this.Client.WorkloadNetworksGetDnsService(PrivateCloudInputObject.SubscriptionId ?? null, PrivateCloudInputObject.ResourceGroupName ?? null, PrivateCloudInputObject.PrivateCloudName ?? null, DnsServiceId, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { DnsServiceId=DnsServiceId})
                    {
