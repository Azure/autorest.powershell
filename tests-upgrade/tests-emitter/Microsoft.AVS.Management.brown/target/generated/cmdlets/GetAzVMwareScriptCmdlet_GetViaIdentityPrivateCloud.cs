...
namespace Microsoft.Azure.PowerShell.Cmdlets.VMware.Cmdlets
{
    ...
    /// subject: ScriptCmdlet
    /// variant: GetViaIdentityPrivateCloud
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzVMwareScriptCmdlet_GetViaIdentityPrivateCloud")]
    ...
    public partial class GetAzVMwareScriptCmdlet_GetViaIdentityPrivateCloud : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzVMwareScriptCmdlet_GetViaIdentityPrivateCloud" /> cmdlet class.
        /// </summary>
        public GetAzVMwareScriptCmdlet_GetViaIdentityPrivateCloud()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.PrivateCloudInputObject.Id += $"/scriptPackages/{(global::System.Uri.EscapeDataString(this.ScriptPackageName.ToString()))}/scriptCmdlets/{(global::System.Uri.EscapeDataString(this.Name.ToString()))}";
                        await this.Client.ScriptCmdletsGetViaIdentity(PrivateCloudInputObject.Id, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ScriptCmdletsGet(PrivateCloudInputObject.SubscriptionId ?? null, PrivateCloudInputObject.ResourceGroupName ?? null, PrivateCloudInputObject.PrivateCloudName ?? null, ScriptPackageName, Name, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ScriptPackageName=ScriptPackageName,Name=Name})
                    {
