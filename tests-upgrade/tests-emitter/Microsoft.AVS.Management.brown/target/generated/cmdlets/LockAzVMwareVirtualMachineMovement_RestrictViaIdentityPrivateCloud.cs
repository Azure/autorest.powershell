...
namespace Microsoft.Azure.PowerShell.Cmdlets.VMware.Cmdlets
{
    ...
    /// variant: RestrictViaIdentityPrivateCloud
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Lock, @"AzVMwareVirtualMachineMovement_RestrictViaIdentityPrivateCloud", SupportsShouldProcess = true)]
    ...
    public partial class LockAzVMwareVirtualMachineMovement_RestrictViaIdentityPrivateCloud : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IVirtualMachineRestrictMovement _restrictMovement;

        /// <summary>Set VM DRS-driven movement to restricted (enabled) or not (disabled)</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Set VM DRS-driven movement to restricted (enabled) or not (disabled)", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Set VM DRS-driven movement to restricted (enabled) or not (disabled)",
        SerializedName = @"restrictMovement",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IVirtualMachineRestrictMovement) })]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IVirtualMachineRestrictMovement RestrictMovement { get => this._restrictMovement; set => this._restrictMovement = value; }
        ...
        /// <returns>
        /// a duplicate instance of LockAzVMwareVirtualMachineMovement_RestrictViaIdentityPrivateCloud
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.VMware.Cmdlets.LockAzVMwareVirtualMachineMovement_RestrictViaIdentityPrivateCloud Clone()
        {
            var clone = new LockAzVMwareVirtualMachineMovement_RestrictViaIdentityPrivateCloud();
            ...
            clone.RestrictMovement = this.RestrictMovement;
            return clone;
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LockAzVMwareVirtualMachineMovement_RestrictViaIdentityPrivateCloud" /> cmdlet
        /// class.
        /// </summary>
        public LockAzVMwareVirtualMachineMovement_RestrictViaIdentityPrivateCloud()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (PrivateCloudInputObject?.Id != null)
                    {
                        ...
                        await this.Client.VirtualMachinesRestrictMovementViaIdentity(PrivateCloudInputObject.Id, RestrictMovement, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.VirtualMachinesRestrictMovement(PrivateCloudInputObject.SubscriptionId ?? null, PrivateCloudInputObject.ResourceGroupName ?? null, PrivateCloudInputObject.PrivateCloudName ?? null, ClusterName, VirtualMachineId, RestrictMovement, onOk, onDefault, this, Pipeline);
                    }
