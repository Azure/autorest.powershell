...
namespace Microsoft.Azure.PowerShell.Cmdlets.VMware.Cmdlets
{
    ...
    /// <summary>update a Addon</summary>
    /// <remarks>
    ...
    /// variant: UpdateViaIdentityPrivateCloudExpanded
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzVMwareAddon_UpdateViaIdentityPrivateCloudExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IAddon))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.VMware.Description(@"update a Addon")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.VMware.Generated]
    public partial class UpdateAzVMwareAddon_UpdateViaIdentityPrivateCloudExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.IContext
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Addon type")]
        ...
        public string AddonType { get => _addonBody.AddonType ?? null; set => _addonBody.AddonType = value; }
        ...
        /// <returns>
        /// a duplicate instance of UpdateAzVMwareAddon_UpdateViaIdentityPrivateCloudExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.VMware.Cmdlets.UpdateAzVMwareAddon_UpdateViaIdentityPrivateCloudExpanded Clone()
        {
            var clone = new UpdateAzVMwareAddon_UpdateViaIdentityPrivateCloudExpanded();
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (PrivateCloudInputObject?.Id != null)
                    {
                        ...
                        _addonBody = await this.Client.AddonsGetViaIdentityWithResult(PrivateCloudInputObject.Id, this, Pipeline);
                        this.Update_addonBody();
                        await this.Client.AddonsCreateOrUpdateViaIdentity(PrivateCloudInputObject.Id, _addonBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _addonBody = await this.Client.AddonsGetWithResult(PrivateCloudInputObject.SubscriptionId ?? null, PrivateCloudInputObject.ResourceGroupName ?? null, PrivateCloudInputObject.PrivateCloudName ?? null, Name, this, Pipeline);
                        this.Update_addonBody();
                        await this.Client.AddonsCreateOrUpdate(PrivateCloudInputObject.SubscriptionId ?? null, PrivateCloudInputObject.ResourceGroupName ?? null, PrivateCloudInputObject.PrivateCloudName ?? null, Name, _addonBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzVMwareAddon_UpdateViaIdentityPrivateCloudExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzVMwareAddon_UpdateViaIdentityPrivateCloudExpanded()
        {

        }

        private void Update_addonBody()
        {
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("AddonType")))
            {
                this.AddonType = (string)(this.MyInvocation?.BoundParameters["AddonType"]);
            }
        }
