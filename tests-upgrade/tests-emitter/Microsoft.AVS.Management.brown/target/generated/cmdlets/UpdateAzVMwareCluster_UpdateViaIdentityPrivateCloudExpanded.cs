...
namespace Microsoft.Azure.PowerShell.Cmdlets.VMware.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.IContext
    {
        ...
        new public string[] Host { get => _clusterUpdateBody.Host?.ToArray() ?? null /* fixedArrayOf */; set => _clusterUpdateBody.Host = (value != null ? new System.Collections.Generic.List<string>(value) : null); }
