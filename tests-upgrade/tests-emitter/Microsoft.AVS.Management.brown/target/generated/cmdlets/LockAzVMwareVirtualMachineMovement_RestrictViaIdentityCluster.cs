...
namespace Microsoft.Azure.PowerShell.Cmdlets.VMware.Cmdlets
{
    ...
    /// variant: RestrictViaIdentityCluster
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Lock, @"AzVMwareVirtualMachineMovement_RestrictViaIdentityCluster", SupportsShouldProcess = true)]
    ...
    public partial class LockAzVMwareVirtualMachineMovement_RestrictViaIdentityCluster : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.IContext
    {
        ...
        /// <returns>
        /// a duplicate instance of LockAzVMwareVirtualMachineMovement_RestrictViaIdentityCluster
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.VMware.Cmdlets.LockAzVMwareVirtualMachineMovement_RestrictViaIdentityCluster Clone()
        {
            var clone = new LockAzVMwareVirtualMachineMovement_RestrictViaIdentityCluster();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LockAzVMwareVirtualMachineMovement_RestrictViaIdentityCluster" /> cmdlet
        /// class.
        /// </summary>
        public LockAzVMwareVirtualMachineMovement_RestrictViaIdentityCluster()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (ClusterInputObject?.Id != null)
                    {
                        ...
                        await this.Client.VirtualMachinesRestrictMovementViaIdentity(ClusterInputObject.Id, RestrictMovement, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.VirtualMachinesRestrictMovement(ClusterInputObject.SubscriptionId ?? null, ClusterInputObject.ResourceGroupName ?? null, ClusterInputObject.PrivateCloudName ?? null, ClusterInputObject.ClusterName ?? null, VirtualMachineId, RestrictMovement, onOk, onDefault, this, Pipeline);
                    }
