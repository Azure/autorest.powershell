...
namespace Microsoft.Azure.PowerShell.Cmdlets.VMware.Cmdlets
{
    ...
    /// variant: GetViaIdentityDhcpConfiguration
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzVMwareWorkloadNetworkDhcp_GetViaIdentityDhcpConfiguration")]
    ...
    public partial class GetAzVMwareWorkloadNetworkDhcp_GetViaIdentityDhcpConfiguration : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.IContext
    {
        ...
        /// <summary>Backing field for <see cref="DhcpConfigurationInputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IVMwareIdentity _dhcpConfigurationInputObject;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IVMwareIdentity DhcpConfigurationInputObject { get => this._dhcpConfigurationInputObject; set => this._dhcpConfigurationInputObject = value; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzVMwareWorkloadNetworkDhcp_GetViaIdentityDhcpConfiguration" /> cmdlet
        /// class.
        /// </summary>
        public GetAzVMwareWorkloadNetworkDhcp_GetViaIdentityDhcpConfiguration()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (DhcpConfigurationInputObject?.Id != null)
                    {
                        this.DhcpConfigurationInputObject.Id += $"/privateClouds/{(global::System.Uri.EscapeDataString(this.PrivateCloudName.ToString()))}";
                        await this.Client.WorkloadNetworksGetDhcpViaIdentity(DhcpConfigurationInputObject.Id, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == DhcpConfigurationInputObject.SubscriptionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("DhcpConfigurationInputObject has null value for DhcpConfigurationInputObject.SubscriptionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, DhcpConfigurationInputObject) );
                        }
                        if (null == DhcpConfigurationInputObject.ResourceGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("DhcpConfigurationInputObject has null value for DhcpConfigurationInputObject.ResourceGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, DhcpConfigurationInputObject) );
                        }
                        if (null == DhcpConfigurationInputObject.DhcpId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("DhcpConfigurationInputObject has null value for DhcpConfigurationInputObject.DhcpId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, DhcpConfigurationInputObject) );
                        }
                        await this.Client.WorkloadNetworksGetDhcp(DhcpConfigurationInputObject.SubscriptionId ?? null, DhcpConfigurationInputObject.ResourceGroupName ?? null, DhcpConfigurationInputObject.DhcpId ?? null, PrivateCloudName, onOk, onDefault, this, Pipeline);
                    }
