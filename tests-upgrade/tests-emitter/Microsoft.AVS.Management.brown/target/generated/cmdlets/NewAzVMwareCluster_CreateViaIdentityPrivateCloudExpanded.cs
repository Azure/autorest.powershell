...
namespace Microsoft.Azure.PowerShell.Cmdlets.VMware.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.IContext
    {
        ...
        new public string[] Host { get => _clusterBody.Host?.ToArray() ?? null /* fixedArrayOf */; set => _clusterBody.Host = (value != null ? new System.Collections.Generic.List<string>(value) : null); }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the SKU. Ex - P3. It is typically a letter+number code")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.VMware.Category(global::Microsoft.Azure.PowerShell.Cmdlets.VMware.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Info(
        Required = true,
        ReadOnly = false,
