...
namespace Microsoft.Azure.PowerShell.Cmdlets.VMware.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Test, @"AzVMwareLocationTrialAvailability_CheckViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.ITrial))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.VMware.Description(@"Return trial status for subscription by region")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.VMware.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.VMware.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Microsoft.AVS/locations/{location}/checkTrialAvailability", ApiVersion = "2024-09-01")]
    public partial class TestAzVMwareLocationTrialAvailability_CheckViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.ISku _skuBody = new Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.Sku();
        ...
        public int Capacity { get => _skuBody.Capacity ?? default(int); set => _skuBody.Capacity = value; }
        ...
        public string Family { get => _skuBody.Family ?? null; set => _skuBody.Family = value; }
        ...
        SerializedName = @"name",
        PossibleTypes = new [] { typeof(string) })]
        public string Name { get => _skuBody.Name ?? null; set => _skuBody.Name = value; }
        ...
        SerializedName = @"size",
        PossibleTypes = new [] { typeof(string) })]
        public string Size { get => _skuBody.Size ?? null; set => _skuBody.Size = value; }
        ...
        public string Tier { get => _skuBody.Tier ?? null; set => _skuBody.Tier = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.ITrial">Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.ITrial</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.ITrial> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.LocationsCheckTrialAvailabilityViaIdentity(InputObject.Id, _skuBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.LocationsCheckTrialAvailability(InputObject.SubscriptionId ?? null, InputObject.Location ?? null, _skuBody, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TestAzVMwareLocationTrialAvailability_CheckViaIdentityExpanded" /> cmdlet
        /// class.
        /// </summary>
        public TestAzVMwareLocationTrialAvailability_CheckViaIdentityExpanded()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.ITrial> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.ITrial
