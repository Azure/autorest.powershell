...
namespace Microsoft.Azure.PowerShell.Cmdlets.VMware.Cmdlets
{
    ...
    /// variant: RestrictViaJsonFilePathViaJsonFilePath
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Lock, @"AzVMwareVirtualMachineMovement_RestrictViaJsonFilePath", SupportsShouldProcess = true)]
    ...
    public partial class LockAzVMwareVirtualMachineMovement_RestrictViaJsonFilePath : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.IContext
    {
        ...
        /// <summary>Path of Json file supplied to the Restrict operation</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Path of Json file supplied to the Restrict operation")]
        [Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Path of Json file supplied to the Restrict operation",
        ...
        /// <returns>
        /// a duplicate instance of LockAzVMwareVirtualMachineMovement_RestrictViaJsonFilePath
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.VMware.Cmdlets.LockAzVMwareVirtualMachineMovement_RestrictViaJsonFilePath Clone()
        {
            var clone = new LockAzVMwareVirtualMachineMovement_RestrictViaJsonFilePath();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LockAzVMwareVirtualMachineMovement_RestrictViaJsonFilePath" /> cmdlet class.
        /// </summary>
        public LockAzVMwareVirtualMachineMovement_RestrictViaJsonFilePath()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.VirtualMachinesRestrictMovementViaJsonString(SubscriptionId, ResourceGroupName, PrivateCloudName, ClusterName, VirtualMachineId, _jsonString, onOk, onDefault, this, Pipeline);
