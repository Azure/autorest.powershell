...
namespace Microsoft.Azure.PowerShell.Cmdlets.VMware.Cmdlets
{
    ...
    /// <summary>update a ScriptExecution</summary>
    /// <remarks>
    ...
    /// variant: UpdateViaIdentityPrivateCloudExpanded
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzVMwareScriptExecution_UpdateViaIdentityPrivateCloudExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IScriptExecution))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.VMware.Description(@"update a ScriptExecution")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.VMware.Generated]
    public partial class UpdateAzVMwareScriptExecution_UpdateViaIdentityPrivateCloudExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.IContext
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IScriptExecutionParameter),typeof(Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IScriptSecureStringExecutionParameter),typeof(Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IScriptStringExecutionParameter),typeof(Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IPsCredentialExecutionParameter) })]
        ...
        /// <returns>
        /// a duplicate instance of UpdateAzVMwareScriptExecution_UpdateViaIdentityPrivateCloudExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.VMware.Cmdlets.UpdateAzVMwareScriptExecution_UpdateViaIdentityPrivateCloudExpanded Clone()
        {
            var clone = new UpdateAzVMwareScriptExecution_UpdateViaIdentityPrivateCloudExpanded();
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (PrivateCloudInputObject?.Id != null)
                    {
                        ...
                        _scriptExecutionBody = await this.Client.ScriptExecutionsGetViaIdentityWithResult(PrivateCloudInputObject.Id, this, Pipeline);
                        this.Update_scriptExecutionBody();
                        await this.Client.ScriptExecutionsCreateOrUpdateViaIdentity(PrivateCloudInputObject.Id, _scriptExecutionBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _scriptExecutionBody = await this.Client.ScriptExecutionsGetWithResult(PrivateCloudInputObject.SubscriptionId ?? null, PrivateCloudInputObject.ResourceGroupName ?? null, PrivateCloudInputObject.PrivateCloudName ?? null, Name, this, Pipeline);
                        this.Update_scriptExecutionBody();
                        await this.Client.ScriptExecutionsCreateOrUpdate(PrivateCloudInputObject.SubscriptionId ?? null, PrivateCloudInputObject.ResourceGroupName ?? null, PrivateCloudInputObject.PrivateCloudName ?? null, Name, _scriptExecutionBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzVMwareScriptExecution_UpdateViaIdentityPrivateCloudExpanded" /> cmdlet
        /// class.
        /// </summary>
        public UpdateAzVMwareScriptExecution_UpdateViaIdentityPrivateCloudExpanded()
        {

        }

        private void Update_scriptExecutionBody()
        {
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("ScriptCmdletId")))
            {
                this.ScriptCmdletId = (string)(this.MyInvocation?.BoundParameters["ScriptCmdletId"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("Parameter")))
            {
                this.Parameter = (Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IScriptExecutionParameter[])(this.MyInvocation?.BoundParameters["Parameter"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("HiddenParameter")))
            {
                this.HiddenParameter = (Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IScriptExecutionParameter[])(this.MyInvocation?.BoundParameters["HiddenParameter"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("FailureReason")))
            {
                this.FailureReason = (string)(this.MyInvocation?.BoundParameters["FailureReason"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("Timeout")))
            {
                this.Timeout = (string)(this.MyInvocation?.BoundParameters["Timeout"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("Retention")))
            {
                this.Retention = (string)(this.MyInvocation?.BoundParameters["Retention"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("Output")))
            {
                this.Output = (string[])(this.MyInvocation?.BoundParameters["Output"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("NamedOutput")))
            {
                this.NamedOutput = (Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IScriptExecutionPropertiesNamedOutputs)(this.MyInvocation?.BoundParameters["NamedOutput"]);
            }
        }
