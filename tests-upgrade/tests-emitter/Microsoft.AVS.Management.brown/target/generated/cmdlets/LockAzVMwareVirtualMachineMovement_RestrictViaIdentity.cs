...
namespace Microsoft.Azure.PowerShell.Cmdlets.VMware.Cmdlets
{
    ...
    /// variant: RestrictViaIdentity
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Lock, @"AzVMwareVirtualMachineMovement_RestrictViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class LockAzVMwareVirtualMachineMovement_RestrictViaIdentity : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.IContext
    {
        ...
        /// <returns>a duplicate instance of LockAzVMwareVirtualMachineMovement_RestrictViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.VMware.Cmdlets.LockAzVMwareVirtualMachineMovement_RestrictViaIdentity Clone()
        {
            var clone = new LockAzVMwareVirtualMachineMovement_RestrictViaIdentity();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LockAzVMwareVirtualMachineMovement_RestrictViaIdentity" /> cmdlet class.
        /// </summary>
        public LockAzVMwareVirtualMachineMovement_RestrictViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.VirtualMachinesRestrictMovementViaIdentity(InputObject.Id, RestrictMovement, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.VirtualMachinesRestrictMovement(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.PrivateCloudName ?? null, InputObject.ClusterName ?? null, InputObject.VirtualMachineId ?? null, RestrictMovement, onOk, onDefault, this, Pipeline);
                    }
