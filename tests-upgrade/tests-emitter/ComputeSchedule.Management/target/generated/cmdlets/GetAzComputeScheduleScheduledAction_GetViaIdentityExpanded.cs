        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ScheduledActionsVirtualMachinesGetOperationStatusViaIdentity(InputObject.Id, _requestBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ScheduledActionsVirtualMachinesGetOperationStatus(InputObject.SubscriptionId ?? null, InputObject.Locationparameter ?? null, _requestBody, onOk, onDefault, this, Pipeline);
                    }
