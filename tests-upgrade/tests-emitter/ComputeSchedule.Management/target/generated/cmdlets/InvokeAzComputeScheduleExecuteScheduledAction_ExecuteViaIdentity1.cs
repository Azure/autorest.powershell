...
namespace Microsoft.Azure.PowerShell.Cmdlets.ComputeSchedule.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ComputeSchedule.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InvokeAzComputeScheduleExecuteScheduledAction_ExecuteViaIdentity1" /> cmdlet
        /// class.
        /// </summary>
        public InvokeAzComputeScheduleExecuteScheduledAction_ExecuteViaIdentity1()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ScheduledActionsVirtualMachinesExecuteHibernateViaIdentity(InputObject.Id, RequestBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ScheduledActionsVirtualMachinesExecuteHibernate(InputObject.SubscriptionId ?? null, InputObject.Locationparameter ?? null, RequestBody, onOk, onDefault, this, Pipeline);
                    }
