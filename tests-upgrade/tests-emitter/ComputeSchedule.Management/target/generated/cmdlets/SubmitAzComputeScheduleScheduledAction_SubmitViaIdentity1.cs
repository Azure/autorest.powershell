...
namespace Microsoft.Azure.PowerShell.Cmdlets.ComputeSchedule.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Submit, @"AzComputeScheduleScheduledAction_SubmitViaIdentity1", SupportsShouldProcess = true)]
    ...
    public partial class SubmitAzComputeScheduleScheduledAction_SubmitViaIdentity1 : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ComputeSchedule.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ComputeSchedule.Models.ISubmitHibernateRequest _requestBody;

        /// <summary>This is the request for hibernate</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "This is the request for hibernate", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.ComputeSchedule.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"This is the request for hibernate",
        SerializedName = @"requestBody",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ComputeSchedule.Models.ISubmitHibernateRequest) })]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ComputeSchedule.Models.ISubmitHibernateRequest RequestBody { get => this._requestBody; set => this._requestBody = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ScheduledActionsVirtualMachinesSubmitHibernateViaIdentity(InputObject.Id, RequestBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ScheduledActionsVirtualMachinesSubmitHibernate(InputObject.SubscriptionId ?? null, InputObject.Locationparameter ?? null, RequestBody, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SubmitAzComputeScheduleScheduledAction_SubmitViaIdentity1" /> cmdlet class.
        /// </summary>
        public SubmitAzComputeScheduleScheduledAction_SubmitViaIdentity1()
        {
