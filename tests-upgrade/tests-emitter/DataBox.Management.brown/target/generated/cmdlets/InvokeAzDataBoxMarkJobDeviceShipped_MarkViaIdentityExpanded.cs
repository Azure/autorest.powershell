...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IMarkDevicesShippedRequest _markDevicesShippedRequestBody = new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.MarkDevicesShippedRequest();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InvokeAzDataBoxMarkJobDeviceShipped_MarkViaIdentityExpanded" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        await this.Client.JobsMarkDevicesShipped(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.JobName ?? null, _markDevicesShippedRequestBody, onNoContent, onDefault, this, Pipeline);
                    }
