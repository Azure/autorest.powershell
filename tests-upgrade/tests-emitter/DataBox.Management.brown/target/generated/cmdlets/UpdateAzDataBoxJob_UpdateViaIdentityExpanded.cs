...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataBox.Description(@"update the properties of an existing job.")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IJobResourceUpdateParameter _jobResourceUpdateParameterBody = new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.JobResourceUpdateParameter();
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IUpdateJobDetails Detail { get => _jobResourceUpdateParameterBody.Detail ?? null /* object */; set => _jobResourceUpdateParameterBody.Detail = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IJobResourceUpdateParameterTags Tag { get => _jobResourceUpdateParameterBody.Tag ?? null /* object */; set => _jobResourceUpdateParameterBody.Tag = value; }
                ...
                try
                {
                    ...
                    if (InputObject?.Id != null)
                    {
                        if (this.UserAssignedIdentity?.Length > 0)
                        {
                            ...
                            _jobResourceUpdateParameterBody.IdentityUserAssignedIdentity.Clear();
                            foreach( var id in this.UserAssignedIdentity )
                            {
                                _jobResourceUpdateParameterBody.IdentityUserAssignedIdentity.Add(id, new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.UserAssignedIdentity());
                            }
                        }
                        await this.Client.JobsUpdateViaIdentity(InputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("IfMatch") ? IfMatch : null, _jobResourceUpdateParameterBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        await this.Client.JobsUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.JobName ?? null, this.InvocationInformation.BoundParameters.ContainsKey("IfMatch") ? IfMatch : null, _jobResourceUpdateParameterBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzDataBoxJob_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
