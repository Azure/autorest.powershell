...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzDataBoxMitigate_MitigateViaIdentity", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataBox.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBox/jobs/{jobName}/mitigate", ApiVersion = "2025-07-01")]
    public partial class InvokeAzDataBoxMitigate_MitigateViaIdentity : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IMitigateJobRequest _mitigateJobRequest;
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IMitigateJobRequest) })]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IMitigateJobRequest MitigateJobRequest { get => this._mitigateJobRequest; set => this._mitigateJobRequest = value; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InvokeAzDataBoxMitigate_MitigateViaIdentity" /> cmdlet class.
        /// </summary>
        public InvokeAzDataBoxMitigate_MitigateViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.MitigateViaIdentity(InputObject.Id, MitigateJobRequest, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.Mitigate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.JobName ?? null, MitigateJobRequest, onNoContent, onDefault, this, Pipeline);
                    }
