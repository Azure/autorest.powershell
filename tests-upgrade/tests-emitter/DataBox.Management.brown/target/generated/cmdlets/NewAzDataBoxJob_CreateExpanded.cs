...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Cmdlets
{
    ...
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IJobResource))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataBox.Description(@"create a new job with the specified parameters. Existing job cannot be updated with this API and should instead be updated with the create job API.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataBox.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataBox.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBox/jobs/{jobName}", ApiVersion = "2025-07-01")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IJobResource _jobResourceBody = new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.JobResource();
        ...
        public string DeliveryType { get => _jobResourceBody.DeliveryType ?? null; set => _jobResourceBody.DeliveryType = value; }
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IJobDetails),typeof(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IDataBoxCustomerDiskJobDetails),typeof(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IDataBoxDiskJobDetails),typeof(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IDataBoxHeavyJobDetails),typeof(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IDataBoxJobDetails) })]
        public Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IJobDetails Detail { get => _jobResourceBody.Detail ?? null /* object */; set => _jobResourceBody.Detail = value; }
        ...
        public global::System.Management.Automation.SwitchParameter EnableSystemAssignedIdentity { set => _jobResourceBody.IdentityType = value.IsPresent ? "SystemAssigned": null ; }
        ...
        public string SkuModel { get => _jobResourceBody.SkuModel ?? null; set => _jobResourceBody.SkuModel = value; }
        ...
        public string SkuName { get => _jobResourceBody.SkuName ?? null; set => _jobResourceBody.SkuName = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.ITrackedResourceTags Tag { get => _jobResourceBody.Tag ?? null /* object */; set => _jobResourceBody.Tag = value; }
        ...
        public string TransferType { get => _jobResourceBody.TransferType ?? null; set => _jobResourceBody.TransferType = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IJobResource">Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IJobResource</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IJobResource> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAzDataBoxJob_CreateExpanded" /> cmdlet class.
        /// </summary>
        ...
        private void PreProcessManagedIdentityParameters()
        {
            if (this.UserAssignedIdentity?.Length > 0)
            {
                ...
                _jobResourceBody.IdentityUserAssignedIdentity.Clear();
                foreach( var id in this.UserAssignedIdentity )
                {
                    _jobResourceBody.IdentityUserAssignedIdentity.Add(id, new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.UserAssignedIdentity());
                }
            }
            // calculate IdentityType
            if (this.UserAssignedIdentity?.Length > 0)
            {
                if ("SystemAssigned".Equals(_jobResourceBody.IdentityType, StringComparison.InvariantCultureIgnoreCase))
                {
                    _jobResourceBody.IdentityType = "SystemAssigned,UserAssigned";
                }
                else
                {
                    _jobResourceBody.IdentityType = "UserAssigned";
                }
            }
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.JobsCreate(SubscriptionId, ResourceGroupName, Name, _jobResourceBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.SerializationMode.IncludeCreate);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IJobResource> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IJobResource
