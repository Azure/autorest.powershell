...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models
{
    ...
    public partial class DataBoxAccountCopyLogDetails :
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IDataBoxAccountCopyLogDetails,
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IDataBoxAccountCopyLogDetailsInternal,
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.IValidates
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IDataBoxAccountCopyLogDetailsInternal.AccountName { get => this._accountName; set { {_accountName = value;} } }

        /// <summary>Internal Acessors for CopyLogLink</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IDataBoxAccountCopyLogDetailsInternal.CopyLogLink { get => this._copyLogLink; set { {_copyLogLink = value;} } }

        /// <summary>Internal Acessors for CopyVerboseLogLink</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IDataBoxAccountCopyLogDetailsInternal.CopyVerboseLogLink { get => this._copyVerboseLogLink; set { {_copyVerboseLogLink = value;} } }
        ...
        public string Type { get => "DataBox"; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.ICopyLogDetailsInternal)__copyLogDetails).Type = "DataBox"; }

        /// <summary>Creates an new <see cref="DataBoxAccountCopyLogDetails" /> instance.</summary>
        public DataBoxAccountCopyLogDetails()
        {
            this.__copyLogDetails.Type = "DataBox";
        }
