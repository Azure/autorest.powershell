...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models
{
    ...
    public partial class ValidationRequest
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IValidationRequest.
        /// Note: the Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IValidationRequest interface is polymorphic, and the precise
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IValidationRequest.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IValidationRequest FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonNode node)
        {
        ...
        internal ValidationRequest(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonObject json)
        {
            ...
            {_validationCategory = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonString>("validationCategory"), out var __jsonValidationCategory) ? (string)__jsonValidationCategory : (string)_validationCategory;}
            {_individualRequestDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonArray>("individualRequestDetails"), out var __jsonIndividualRequestDetails) ? If( __jsonIndividualRequestDetails as Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IValidationInputRequest>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IValidationInputRequest) (Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.ValidationInputRequest.FromJson(__u) )) ))() : null : _individualRequestDetail;}
            AfterFromJson(json);
        }
    }
}