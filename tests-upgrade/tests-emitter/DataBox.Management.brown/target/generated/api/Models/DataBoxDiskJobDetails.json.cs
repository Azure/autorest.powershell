...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models
{
    ...
    public partial class DataBoxDiskJobDetails
    {
        ...
        internal DataBoxDiskJobDetails(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonObject json)
        {
            ...
            __jobDetails = new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.JobDetails(json);
            {_preferredDisk = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonObject>("preferredDisks"), out var __jsonPreferredDisks) ? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.DataBoxDiskJobDetailsPreferredDisks.FromJson(__jsonPreferredDisks) : _preferredDisk;}
            {_copyProgress = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonArray>("copyProgress"), out var __jsonCopyProgress) ? If( __jsonCopyProgress as Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IDataBoxDiskCopyProgress>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IDataBoxDiskCopyProgress) (Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.DataBoxDiskCopyProgress.FromJson(__u) )) ))() : null : _copyProgress;}
            {_granularCopyProgress = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonArray>("granularCopyProgress"), out var __jsonGranularCopyProgress) ? If( __jsonGranularCopyProgress as Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IDataBoxDiskGranularCopyProgress>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IDataBoxDiskGranularCopyProgress) (Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.DataBoxDiskGranularCopyProgress.FromJson(__p) )) ))() : null : _granularCopyProgress;}
            {_granularCopyLogDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonArray>("granularCopyLogDetails"), out var __jsonGranularCopyLogDetails) ? If( __jsonGranularCopyLogDetails as Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IDataBoxDiskGranularCopyLogDetails>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__l, (__k)=>(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IDataBoxDiskGranularCopyLogDetails) (Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.DataBoxDiskGranularCopyLogDetails.FromJson(__k) )) ))() : null : _granularCopyLogDetail;}
            ...
            {_passkey = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonString>("passkey"), out var __jsonPasskey) ? (string)__jsonPasskey : (string)_passkey;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IDataBoxDiskJobDetails.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IDataBoxDiskJobDetails.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IDataBoxDiskJobDetails FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonNode node)
        {
