...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models
{
    ...
    public partial class KeyEncryptionKey
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IKeyEncryptionKey.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IKeyEncryptionKey.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IKeyEncryptionKey FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonNode node)
        {
        ...
        internal KeyEncryptionKey(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonObject json)
        {
            ...
            {_identityProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonObject>("identityProperties"), out var __jsonIdentityProperties) ? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IdentityProperties.FromJson(__jsonIdentityProperties) : _identityProperty;}
            {_kekType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonString>("kekType"), out var __jsonKekType) ? (string)__jsonKekType : (string)_kekType;}
            {_kekUrl = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonString>("kekUrl"), out var __jsonKekUrl) ? (string)__jsonKekUrl : (string)_kekUrl;}
            {_kekVaultResourceId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonString>("kekVaultResourceID"), out var __jsonKekVaultResourceId) ? (string)__jsonKekVaultResourceId : (string)_kekVaultResourceId;}
            AfterFromJson(json);
        }
