...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models
{
    ...
    public partial class DataBoxHeavySecret :
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IDataBoxHeavySecret,
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IDataBoxHeavySecretInternal
    {
        ...
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IAccountCredentialDetails> Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IDataBoxHeavySecretInternal.AccountCredentialDetail { get => this._accountCredentialDetail; set { {_accountCredentialDetail = value;} } }

        /// <summary>Internal Acessors for DevicePassword</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IDataBoxHeavySecretInternal.DevicePassword { get => this._devicePassword; set { {_devicePassword = value;} } }

        /// <summary>Internal Acessors for DeviceSerialNumber</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IDataBoxHeavySecretInternal.DeviceSerialNumber { get => this._deviceSerialNumber; set { {_deviceSerialNumber = value;} } }

        /// <summary>Internal Acessors for EncodedValidationCertPubKey</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IDataBoxHeavySecretInternal.EncodedValidationCertPubKey { get => this._encodedValidationCertPubKey; set { {_encodedValidationCertPubKey = value;} } }

        /// <summary>Internal Acessors for NetworkConfiguration</summary>
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IApplianceNetworkConfiguration> Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IDataBoxHeavySecretInternal.NetworkConfiguration { get => this._networkConfiguration; set { {_networkConfiguration = value;} } }
