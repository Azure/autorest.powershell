...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models
{
    ...
    public partial class JobProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IJobProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IJobProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IJobProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonNode node)
        {
        ...
        internal JobProperties(Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonObject json)
        {
            ...
            {_deliveryInfo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonObject>("deliveryInfo"), out var __jsonDeliveryInfo) ? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.JobDeliveryInfo.FromJson(__jsonDeliveryInfo) : _deliveryInfo;}
            ...
            {_isCancellable = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonBoolean>("isCancellable"), out var __jsonIsCancellable) ? (bool?)__jsonIsCancellable : _isCancellable;}
            {_isDeletable = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonBoolean>("isDeletable"), out var __jsonIsDeletable) ? (bool?)__jsonIsDeletable : _isDeletable;}
            {_isShippingAddressEditable = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonBoolean>("isShippingAddressEditable"), out var __jsonIsShippingAddressEditable) ? (bool?)__jsonIsShippingAddressEditable : _isShippingAddressEditable;}
            {_reverseShippingDetailsUpdate = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonString>("reverseShippingDetailsUpdate"), out var __jsonReverseShippingDetailsUpdate) ? (string)__jsonReverseShippingDetailsUpdate : (string)_reverseShippingDetailsUpdate;}
            {_reverseTransportPreferenceUpdate = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonString>("reverseTransportPreferenceUpdate"), out var __jsonReverseTransportPreferenceUpdate) ? (string)__jsonReverseTransportPreferenceUpdate : (string)_reverseTransportPreferenceUpdate;}
            {_isPrepareToShipEnabled = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonBoolean>("isPrepareToShipEnabled"), out var __jsonIsPrepareToShipEnabled) ? (bool?)__jsonIsPrepareToShipEnabled : _isPrepareToShipEnabled;}
            {_status = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonString>("status"), out var __jsonStatus) ? (string)__jsonStatus : (string)_status;}
            {_delayedStage = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonString>("delayedStage"), out var __jsonDelayedStage) ? (string)__jsonDelayedStage : (string)_delayedStage;}
            ...
            {_cancellationReason = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonString>("cancellationReason"), out var __jsonCancellationReason) ? (string)__jsonCancellationReason : (string)_cancellationReason;}
            {_deliveryType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonString>("deliveryType"), out var __jsonDeliveryType) ? (string)__jsonDeliveryType : (string)_deliveryType;}
            {_isCancellableWithoutFee = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonBoolean>("isCancellableWithoutFee"), out var __jsonIsCancellableWithoutFee) ? (bool?)__jsonIsCancellableWithoutFee : _isCancellableWithoutFee;}
            {_allDevicesLost = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonBoolean>("allDevicesLost"), out var __jsonAllDevicesLost) ? (bool?)__jsonAllDevicesLost : _allDevicesLost;}
            {_detail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.Json.JsonObject>("details"), out var __jsonDetails) ? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.JobDetails.FromJson(__jsonDetails) : _detail;}
            AfterFromJson(json);
        }
