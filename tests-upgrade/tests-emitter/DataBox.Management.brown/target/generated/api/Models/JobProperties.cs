...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models
{
    ...
    public partial class JobProperties :
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IJobProperties,
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IJobPropertiesInternal
    {
        ...
        private string _delayedStage;

        /// <summary>Name of the stage where delay might be present.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBox.PropertyOrigin.Owned)]
        public string DelayedStage { get => this._delayedStage; }

        /// <summary>Backing field for <see cref="DeliveryInfo" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IJobDeliveryInfo _deliveryInfo;

        /// <summary>Delivery Info of Job.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBox.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IJobDeliveryInfo DeliveryInfo { get => (this._deliveryInfo = this._deliveryInfo ?? new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.JobDeliveryInfo()); set => this._deliveryInfo = value; }

        /// <summary>Scheduled date time.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBox.PropertyOrigin.Inlined)]
        public global::System.DateTime? DeliveryInfoScheduledDateTime { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IJobDeliveryInfoInternal)DeliveryInfo).ScheduledDateTime; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IJobDeliveryInfoInternal)DeliveryInfo).ScheduledDateTime = value ?? default(global::System.DateTime); }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBox.PropertyOrigin.Owned)]
        public string DeliveryType { get => this._deliveryType; set => this._deliveryType = value; }

        /// <summary>Backing field for <see cref="Detail" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IJobDetails _detail;

        /// <summary>Details of a job run. This field will only be sent for expand details filter.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBox.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IJobDetails Detail { get => (this._detail = this._detail ?? new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.JobDetails()); set => this._detail = value; }
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBox.PropertyOrigin.Inlined)]
        public System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.ICloudError> ErrorDetail { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.ICloudErrorInternal)Error).Detail; }
        ...
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IAdditionalErrorInfo1> Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IJobPropertiesInternal.AdditionalInfo { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.ICloudErrorInternal)Error).AdditionalInfo; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.ICloudErrorInternal)Error).AdditionalInfo = value ?? null /* arrayOf */; }

        /// <summary>Internal Acessors for AllDevicesLost</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IJobPropertiesInternal.AllDevicesLost { get => this._allDevicesLost; set { {_allDevicesLost = value;} } }

        /// <summary>Internal Acessors for CancellationReason</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IJobPropertiesInternal.CancellationReason { get => this._cancellationReason; set { {_cancellationReason = value;} } }

        /// <summary>Internal Acessors for Code</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IJobPropertiesInternal.Code { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.ICloudErrorInternal)Error).Code; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.ICloudErrorInternal)Error).Code = value ?? null; }

        /// <summary>Internal Acessors for DelayedStage</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IJobPropertiesInternal.DelayedStage { get => this._delayedStage; set { {_delayedStage = value;} } }

        /// <summary>Internal Acessors for DeliveryInfo</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IJobDeliveryInfo Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IJobPropertiesInternal.DeliveryInfo { get => (this._deliveryInfo = this._deliveryInfo ?? new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.JobDeliveryInfo()); set { {_deliveryInfo = value;} } }

        /// <summary>Internal Acessors for Error</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.ICloudError Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IJobPropertiesInternal.Error { get => (this._error = this._error ?? new Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.CloudError()); set { {_error = value;} } }

        /// <summary>Internal Acessors for ErrorDetail</summary>
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.ICloudError> Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IJobPropertiesInternal.ErrorDetail { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.ICloudErrorInternal)Error).Detail; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.ICloudErrorInternal)Error).Detail = value ?? null /* arrayOf */; }

        /// <summary>Internal Acessors for IsCancellable</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IJobPropertiesInternal.IsCancellable { get => this._isCancellable; set { {_isCancellable = value;} } }

        /// <summary>Internal Acessors for IsCancellableWithoutFee</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IJobPropertiesInternal.IsCancellableWithoutFee { get => this._isCancellableWithoutFee; set { {_isCancellableWithoutFee = value;} } }

        /// <summary>Internal Acessors for IsDeletable</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IJobPropertiesInternal.IsDeletable { get => this._isDeletable; set { {_isDeletable = value;} } }

        /// <summary>Internal Acessors for IsPrepareToShipEnabled</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IJobPropertiesInternal.IsPrepareToShipEnabled { get => this._isPrepareToShipEnabled; set { {_isPrepareToShipEnabled = value;} } }

        /// <summary>Internal Acessors for IsShippingAddressEditable</summary>
        bool? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IJobPropertiesInternal.IsShippingAddressEditable { get => this._isShippingAddressEditable; set { {_isShippingAddressEditable = value;} } }

        /// <summary>Internal Acessors for Message</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IJobPropertiesInternal.Message { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.ICloudErrorInternal)Error).Message; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.ICloudErrorInternal)Error).Message = value ?? null; }

        /// <summary>Internal Acessors for ReverseShippingDetailsUpdate</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IJobPropertiesInternal.ReverseShippingDetailsUpdate { get => this._reverseShippingDetailsUpdate; set { {_reverseShippingDetailsUpdate = value;} } }

        /// <summary>Internal Acessors for ReverseTransportPreferenceUpdate</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IJobPropertiesInternal.ReverseTransportPreferenceUpdate { get => this._reverseTransportPreferenceUpdate; set { {_reverseTransportPreferenceUpdate = value;} } }

        /// <summary>Internal Acessors for StartTime</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IJobPropertiesInternal.StartTime { get => this._startTime; set { {_startTime = value;} } }

        /// <summary>Internal Acessors for Status</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IJobPropertiesInternal.Status { get => this._status; set { {_status = value;} } }

        /// <summary>Internal Acessors for Target</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IJobPropertiesInternal.Target { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.ICloudErrorInternal)Error).Target; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.ICloudErrorInternal)Error).Target = value ?? null; }

        /// <summary>Backing field for <see cref="ReverseShippingDetailsUpdate" /> property.</summary>
        private string _reverseShippingDetailsUpdate;

        /// <summary>The Editable status for Reverse Shipping Address and Contact Info</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBox.PropertyOrigin.Owned)]
        public string ReverseShippingDetailsUpdate { get => this._reverseShippingDetailsUpdate; }

        /// <summary>Backing field for <see cref="ReverseTransportPreferenceUpdate" /> property.</summary>
        private string _reverseTransportPreferenceUpdate;

        /// <summary>The Editable status for Reverse Transport preferences</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataBox.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataBox.PropertyOrigin.Owned)]
        public string ReverseTransportPreferenceUpdate { get => this._reverseTransportPreferenceUpdate; }
