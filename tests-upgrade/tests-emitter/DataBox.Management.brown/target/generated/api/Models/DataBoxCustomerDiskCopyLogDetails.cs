...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models
{
    ...
    public partial class DataBoxCustomerDiskCopyLogDetails :
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IDataBoxCustomerDiskCopyLogDetails,
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IDataBoxCustomerDiskCopyLogDetailsInternal,
        Microsoft.Azure.PowerShell.Cmdlets.DataBox.Runtime.IValidates
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IDataBoxCustomerDiskCopyLogDetailsInternal.ErrorLogLink { get => this._errorLogLink; set { {_errorLogLink = value;} } }

        /// <summary>Internal Acessors for SerialNumber</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IDataBoxCustomerDiskCopyLogDetailsInternal.SerialNumber { get => this._serialNumber; set { {_serialNumber = value;} } }

        /// <summary>Internal Acessors for VerboseLogLink</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.IDataBoxCustomerDiskCopyLogDetailsInternal.VerboseLogLink { get => this._verboseLogLink; set { {_verboseLogLink = value;} } }
        ...
        public string Type { get => "DataBoxCustomerDisk"; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataBox.Models.ICopyLogDetailsInternal)__copyLogDetails).Type = "DataBoxCustomerDisk"; }
        ...
        {
            this.__copyLogDetails.Type = "DataBoxCustomerDisk";
        }
