namespace Microsoft.Azure.PowerShell.Cmdlets.Sphere.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzSphereDeployment_Get")]
    ...
    public partial class GetAzSphereDeployment_Get : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Sphere.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzSphereDeployment_Get" /> cmdlet class.
        /// </summary>
        public GetAzSphereDeployment_Get()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.DeploymentsGet(SubscriptionId, ResourceGroupName, CatalogName, ProductName, DeviceGroupName, Name, onOk, onDefault, this, Pipeline);
