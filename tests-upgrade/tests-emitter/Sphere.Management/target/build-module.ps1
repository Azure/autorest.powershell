...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: Az.Sphere cmdlets'
...
if (-not $DisableAfterBuildTasks){
  ...
  $afterBuildTasksArgs = ConvertFrom-Json '{"SubModuleName":"Az.Sphere","ModuleRootName":"$(root-module-name)"}' -AsHashtable
