...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: ComputeFleet cmdlets'
...
if (-not $DisableAfterBuildTasks){
  ...
  $afterBuildTasksArgs = ConvertFrom-Json '{"SubModuleName":"Az.ComputeFleet","ModuleRootName":"$(root-module-name)"}' -AsHashtable
