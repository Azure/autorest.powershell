...
namespace Microsoft.Azure.PowerShell.Cmdlets.NeonPostgres.Models
{
    ...
    public partial class OrganizationsDeleteAcceptedResponseHeaders :
        Microsoft.Azure.PowerShell.Cmdlets.NeonPostgres.Models.IOrganizationsDeleteAcceptedResponseHeaders,
        Microsoft.Azure.PowerShell.Cmdlets.NeonPostgres.Models.IOrganizationsDeleteAcceptedResponseHeadersInternal,
        Microsoft.Azure.PowerShell.Cmdlets.NeonPostgres.Runtime.IHeaderSerializable
    {
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.NeonPostgres.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.NeonPostgres.Models.IOrganizationsDeleteAcceptedResponseHeadersInternal)this).Location = System.Linq.Enumerable.FirstOrDefault(__locationHeader0) is string __headerLocationHeader0 ? __headerLocationHeader0 : (string)null;
            }
            if (headers.TryGetValues("Retry-After", out var __retryAfterHeader1))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.NeonPostgres.Models.IOrganizationsDeleteAcceptedResponseHeadersInternal)this).RetryAfter = System.Linq.Enumerable.FirstOrDefault(__retryAfterHeader1) is string __headerRetryAfterHeader1 ? int.TryParse( __headerRetryAfterHeader1, out int __headerRetryAfterHeader1Value ) ? __headerRetryAfterHeader1Value : default(int?) : default(int?);
            }
        }
