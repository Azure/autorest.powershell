...
namespace Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Runtime.IContext
    {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.FirewallRulesDelete(SubscriptionId, ResourceGroupName, MongoClusterName, Name, onNoContent, onOk, onDefault, this, Pipeline);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveAzMongoClusterFirewallRule_Delete" /> cmdlet class.
        /// </summary>
