        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.MongoClustersPromoteViaIdentity(InputObject.Id, Body, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.MongoClustersPromote(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.MongoClusterName ?? null, Body, onDefault, this, Pipeline);
                    }
