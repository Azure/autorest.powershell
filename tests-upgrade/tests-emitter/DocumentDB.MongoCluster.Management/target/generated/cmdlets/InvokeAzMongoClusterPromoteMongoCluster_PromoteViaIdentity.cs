...
namespace Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzMongoClusterPromoteMongoCluster_PromoteViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class InvokeAzMongoClusterPromoteMongoCluster_PromoteViaIdentity : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.IPromoteReplicaRequest _body;

        /// <summary>Promote replica request properties.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Promote replica request properties.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Promote replica request properties.",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.IPromoteReplicaRequest) })]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.IPromoteReplicaRequest Body { get => this._body; set => this._body = value; }
        ...
        /// <returns>
        /// a duplicate instance of InvokeAzMongoClusterPromoteMongoCluster_PromoteViaIdentity
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Cmdlets.InvokeAzMongoClusterPromoteMongoCluster_PromoteViaIdentity Clone()
        {
            var clone = new InvokeAzMongoClusterPromoteMongoCluster_PromoteViaIdentity();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InvokeAzMongoClusterPromoteMongoCluster_PromoteViaIdentity" /> cmdlet class.
        /// </summary>
        public InvokeAzMongoClusterPromoteMongoCluster_PromoteViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.MongoClustersPromoteViaIdentity(InputObject.Id, Body, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.MongoClustersPromote(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.MongoClusterName ?? null, Body, onOk, onDefault, this, Pipeline);
                    }
