...
namespace Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzMongoClusterFirewallRule_GetViaIdentityMongoCluster")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzMongoClusterFirewallRule_GetViaIdentityMongoCluster" /> cmdlet class.
        /// </summary>
        public GetAzMongoClusterFirewallRule_GetViaIdentityMongoCluster()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (MongoClusterInputObject?.Id != null)
                    {
                        ...
                        await this.Client.FirewallRulesGetViaIdentity(MongoClusterInputObject.Id, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.FirewallRulesGet(MongoClusterInputObject.SubscriptionId ?? null, MongoClusterInputObject.ResourceGroupName ?? null, MongoClusterInputObject.MongoClusterName ?? null, Name, onOk, onDefault, this, Pipeline);
                    }
