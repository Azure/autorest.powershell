...
namespace Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Runtime.IContext
    {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.MongoClustersDeleteViaIdentity(InputObject.Id, onNoContent, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.MongoClustersDelete(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.MongoClusterName ?? null, onNoContent, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveAzMongoCluster_DeleteViaIdentity" /> cmdlet class.
        /// </summary>
