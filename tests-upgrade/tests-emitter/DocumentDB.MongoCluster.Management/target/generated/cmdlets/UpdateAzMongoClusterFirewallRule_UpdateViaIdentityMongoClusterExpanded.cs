...
namespace Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzMongoClusterFirewallRule_UpdateViaIdentityMongoClusterExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Description(@"update a new firewall rule or update an existing firewall rule on a mongo cluster.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Generated]
    public partial class UpdateAzMongoClusterFirewallRule_UpdateViaIdentityMongoClusterExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.IFirewallRule _resourceBody = new Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.FirewallRule();
        ...
        /// <summary>Backing field for <see cref="MongoClusterInputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.IMongoClusterIdentity _mongoClusterInputObject;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.IMongoClusterIdentity MongoClusterInputObject { get => this._mongoClusterInputObject; set => this._mongoClusterInputObject = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.IFirewallRule">Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.IFirewallRule</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.IFirewallRule> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>
        /// a duplicate instance of UpdateAzMongoClusterFirewallRule_UpdateViaIdentityMongoClusterExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Cmdlets.UpdateAzMongoClusterFirewallRule_UpdateViaIdentityMongoClusterExpanded Clone()
        {
            var clone = new UpdateAzMongoClusterFirewallRule_UpdateViaIdentityMongoClusterExpanded();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (MongoClusterInputObject?.Id != null)
                    {
                        this.MongoClusterInputObject.Id += $"/firewallRules/{(global::System.Uri.EscapeDataString(this.Name.ToString()))}";
                        _resourceBody = await this.Client.FirewallRulesGetViaIdentityWithResult(MongoClusterInputObject.Id, this, Pipeline);
                        this.Update_resourceBody();
                        await this.Client.FirewallRulesCreateOrUpdateViaIdentity(MongoClusterInputObject.Id, _resourceBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == MongoClusterInputObject.SubscriptionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("MongoClusterInputObject has null value for MongoClusterInputObject.SubscriptionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, MongoClusterInputObject) );
                        }
                        if (null == MongoClusterInputObject.ResourceGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("MongoClusterInputObject has null value for MongoClusterInputObject.ResourceGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, MongoClusterInputObject) );
                        }
                        if (null == MongoClusterInputObject.MongoClusterName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("MongoClusterInputObject has null value for MongoClusterInputObject.MongoClusterName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, MongoClusterInputObject) );
                        }
                        _resourceBody = await this.Client.FirewallRulesGetWithResult(MongoClusterInputObject.SubscriptionId ?? null, MongoClusterInputObject.ResourceGroupName ?? null, MongoClusterInputObject.MongoClusterName ?? null, Name, this, Pipeline);
                        this.Update_resourceBody();
                        await this.Client.FirewallRulesCreateOrUpdate(MongoClusterInputObject.SubscriptionId ?? null, MongoClusterInputObject.ResourceGroupName ?? null, MongoClusterInputObject.MongoClusterName ?? null, Name, _resourceBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzMongoClusterFirewallRule_UpdateViaIdentityMongoClusterExpanded" />
        /// cmdlet class.
        /// </summary>
        public UpdateAzMongoClusterFirewallRule_UpdateViaIdentityMongoClusterExpanded()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.IFirewallRule> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.IFirewallRule
