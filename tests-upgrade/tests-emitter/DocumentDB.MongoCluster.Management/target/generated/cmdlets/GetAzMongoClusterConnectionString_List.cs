...
namespace Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Cmdlets
{
    ...
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.IListConnectionStringsResult))]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Runtime.IContext
    {
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.IListConnectionStringsResult">Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.IListConnectionStringsResult</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.IListConnectionStringsResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzMongoClusterConnectionString_List" /> cmdlet class.
        /// </summary>
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.IListConnectionStringsResult> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.IListConnectionStringsResult
                var result = (await response);
                // response should be returning an array of some kind. +Pageable
                // nested-array / connectionStrings / <none>
                if (null != result.ConnectionString)
                {
                    if (0 == _responseSize && 1 == result.ConnectionString.Count)
                    {
                        _firstResponse = result.ConnectionString[0];
                        _responseSize = 1;
                    }
                    else
                    {
                        ...
                        foreach( var value in result.ConnectionString )
                        {
