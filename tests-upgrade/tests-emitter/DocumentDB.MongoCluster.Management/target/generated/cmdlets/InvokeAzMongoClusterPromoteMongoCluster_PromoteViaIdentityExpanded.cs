        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.MongoClustersPromoteViaIdentity(InputObject.Id, _body, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.MongoClustersPromote(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.MongoClusterName ?? null, _body, onDefault, this, Pipeline);
                    }
