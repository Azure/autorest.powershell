...
namespace Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models
{
    ...
    public partial class FirewallRuleListResult :
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.IFirewallRuleListResult,
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.IFirewallRuleListResultInternal
    {
        ...
        private System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.IFirewallRule> _value;

        /// <summary>The FirewallRule items on this page</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Origin(Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.IFirewallRule> Value { get => this._value; set => this._value = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.IFirewallRule) })]
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.MongoCluster.Models.IFirewallRule> Value { get; set; }
