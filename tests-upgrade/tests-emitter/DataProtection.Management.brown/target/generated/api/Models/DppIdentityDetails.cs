...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models
{
    ...
    public partial class DppIdentityDetails :
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IDppIdentityDetails,
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IDppIdentityDetailsInternal
    {

        /// <summary>Internal Acessors for PrincipalId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IDppIdentityDetailsInternal.PrincipalId { get => this._principalId; set { {_principalId = value;} } }

        /// <summary>Internal Acessors for TenantId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IDppIdentityDetailsInternal.TenantId { get => this._tenantId; set { {_tenantId = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IDppIdentityDetailsUserAssignedIdentities _userAssignedIdentity;

        /// <summary>Gets or sets the user assigned identities.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IDppIdentityDetailsUserAssignedIdentities UserAssignedIdentity { get => (this._userAssignedIdentity = this._userAssignedIdentity ?? new Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.DppIdentityDetailsUserAssignedIdentities()); set => this._userAssignedIdentity = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IDppIdentityDetailsUserAssignedIdentities UserAssignedIdentity { get; set; }
