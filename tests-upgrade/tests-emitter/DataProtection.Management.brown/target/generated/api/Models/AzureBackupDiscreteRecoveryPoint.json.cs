...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models
{
    ...
    public partial class AzureBackupDiscreteRecoveryPoint
    {
        ...
        internal AzureBackupDiscreteRecoveryPoint(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonObject json)
        {
            ...
            {_recoveryPointState = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonString>("recoveryPointState"), out var __jsonRecoveryPointState) ? (string)__jsonRecoveryPointState : (string)_recoveryPointState;}
            AfterFromJson(json);
        }
