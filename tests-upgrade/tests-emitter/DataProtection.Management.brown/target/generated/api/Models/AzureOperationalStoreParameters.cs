...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models
{
    ...
    public partial class AzureOperationalStoreParameters :
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IAzureOperationalStoreParameters,
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IAzureOperationalStoreParametersInternal,
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IDataStoreParameters"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IDataStoreParameters __dataStoreParameters = new Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.DataStoreParameters();

        /// <summary>type of datastore; Operational/Vault/Archive</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.PropertyOrigin.Inherited)]
        public string DataStoreType { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IDataStoreParametersInternal)__dataStoreParameters).DataStoreType; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IDataStoreParametersInternal)__dataStoreParameters).DataStoreType = value ; }

        /// <summary>Type of the specific object - used for deserializing</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Constant]
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.PropertyOrigin.Inherited)]
        public string ObjectType { get => "AzureOperationalStoreParameters"; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IDataStoreParametersInternal)__dataStoreParameters).ObjectType = "AzureOperationalStoreParameters"; }
        ...
        {
            this.__dataStoreParameters.ObjectType = "AzureOperationalStoreParameters";
        }
