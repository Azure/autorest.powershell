...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models
{
    ...
    public partial class CustomCopyOption :
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.ICustomCopyOption,
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.ICustomCopyOptionInternal,
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.IValidates
    {
        ...
        public string ObjectType { get => "CustomCopyOption"; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.ICopyOptionInternal)__copyOption).ObjectType = "CustomCopyOption"; }

        /// <summary>Creates an new <see cref="CustomCopyOption" /> instance.</summary>
        public CustomCopyOption()
        {
            this.__copyOption.ObjectType = "CustomCopyOption";
        }
