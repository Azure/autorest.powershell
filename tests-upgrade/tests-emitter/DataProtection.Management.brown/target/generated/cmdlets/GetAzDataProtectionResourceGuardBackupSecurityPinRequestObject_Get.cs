...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] GetBackupSecurityPINRequestsObjects=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataProtection/resourceGuards/{resourceGuardsName}/getBackupSecurityPINRequests"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzDataProtectionResourceGuardBackupSecurityPinRequestObject_Get")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataProtection.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataProtection/resourceGuards/{resourceGuardsName}/getBackupSecurityPINRequests", ApiVersion = "2025-09-01")]
    public partial class GetAzDataProtectionResourceGuardBackupSecurityPinRequestObject_Get : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzDataProtectionResourceGuardBackupSecurityPinRequestObject_Get" /> cmdlet
        /// class.
        /// </summary>
        public GetAzDataProtectionResourceGuardBackupSecurityPinRequestObject_Get()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ResourceGuardsGetBackupSecurityPinRequestsObjects(SubscriptionId, ResourceGroupName, ResourceGuardsName, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.ResourceGuardsGetBackupSecurityPinRequestsObjects_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
