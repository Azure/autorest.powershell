...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzDataProtectionOperationResult_GetViaIdentity" /> cmdlet class.
        /// </summary>
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.OperationResultGetViaIdentity(InputObject.Id, onOk, onAccepted, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.OperationResultGet(InputObject.SubscriptionId ?? null, InputObject.OperationId ?? null, InputObject.Location ?? null, onOk, onAccepted, onDefault, this, Pipeline);
                    }
