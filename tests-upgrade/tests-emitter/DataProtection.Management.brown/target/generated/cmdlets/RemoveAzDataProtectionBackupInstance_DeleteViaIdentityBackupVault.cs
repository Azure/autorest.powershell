...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Description(@"Delete a backup instance in a backup vault")]
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (BackupVaultInputObject?.Id != null)
                    {
                        ...
                        await this.Client.BackupInstancesDeleteViaIdentity(BackupVaultInputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("XmsAuthorizationAuxiliary") ? XmsAuthorizationAuxiliary : null, onOk, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
