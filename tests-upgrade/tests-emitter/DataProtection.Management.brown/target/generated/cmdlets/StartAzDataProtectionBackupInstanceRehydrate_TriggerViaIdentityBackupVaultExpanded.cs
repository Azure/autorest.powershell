...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Start, @"AzDataProtectionBackupInstanceRehydrate_TriggerViaIdentityBackupVaultExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataProtection.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataProtection/backupVaults/{vaultName}/backupInstances/{backupInstanceName}/rehydrate", ApiVersion = "2025-09-01")]
    public partial class StartAzDataProtectionBackupInstanceRehydrate_TriggerViaIdentityBackupVaultExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IAzureBackupRehydrationRequest _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.AzureBackupRehydrationRequest();
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string RecoveryPointId { get => _parametersBody.RecoveryPointId ?? null; set => _parametersBody.RecoveryPointId = value; }
        ...
        public string RehydrationPriority { get => _parametersBody.RehydrationPriority ?? null; set => _parametersBody.RehydrationPriority = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string RehydrationRetentionDuration { get => _parametersBody.RehydrationRetentionDuration ?? null; set => _parametersBody.RehydrationRetentionDuration = value; }
        ...
        /// <returns>
        /// a duplicate instance of StartAzDataProtectionBackupInstanceRehydrate_TriggerViaIdentityBackupVaultExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Cmdlets.StartAzDataProtectionBackupInstanceRehydrate_TriggerViaIdentityBackupVaultExpanded Clone()
        {
            var clone = new StartAzDataProtectionBackupInstanceRehydrate_TriggerViaIdentityBackupVaultExpanded();
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (BackupVaultInputObject?.Id != null)
                    {
                        ...
                        await this.Client.BackupInstancesTriggerRehydrateViaIdentity(BackupVaultInputObject.Id, _parametersBody, onNoContent, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.BackupInstancesTriggerRehydrate(BackupVaultInputObject.SubscriptionId ?? null, BackupVaultInputObject.ResourceGroupName ?? null, BackupVaultInputObject.VaultName ?? null, BackupInstanceName, _parametersBody, onNoContent, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StartAzDataProtectionBackupInstanceRehydrate_TriggerViaIdentityBackupVaultExpanded"
        /// /> cmdlet class.
        /// </summary>
        public StartAzDataProtectionBackupInstanceRehydrate_TriggerViaIdentityBackupVaultExpanded()
        {
