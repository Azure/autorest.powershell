...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.ICheckNameAvailabilityRequest _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.CheckNameAvailabilityRequest();
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        await this.Client.BackupVaultsCheckNameAvailability(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.Location ?? null, _parametersBody, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TestAzDataProtectionBackupVaultNameAvailability_CheckViaIdentityExpanded"
        /// /> cmdlet class.
        /// </summary>
