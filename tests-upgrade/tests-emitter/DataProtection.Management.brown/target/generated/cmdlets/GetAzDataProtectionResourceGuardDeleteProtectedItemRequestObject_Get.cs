...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] GetDeleteProtectedItemRequestsObjects=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataProtection/resourceGuards/{resourceGuardsName}/deleteProtectedItemRequests"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzDataProtectionResourceGuardDeleteProtectedItemRequestObject_Get")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataProtection.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataProtection/resourceGuards/{resourceGuardsName}/deleteProtectedItemRequests", ApiVersion = "2025-09-01")]
    public partial class GetAzDataProtectionResourceGuardDeleteProtectedItemRequestObject_Get : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzDataProtectionResourceGuardDeleteProtectedItemRequestObject_Get" />
        /// cmdlet class.
        /// </summary>
        public GetAzDataProtectionResourceGuardDeleteProtectedItemRequestObject_Get()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ResourceGuardsGetDeleteProtectedItemRequestsObjects(SubscriptionId, ResourceGroupName, ResourceGuardsName, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.ResourceGuardsGetDeleteProtectedItemRequestsObjects_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
