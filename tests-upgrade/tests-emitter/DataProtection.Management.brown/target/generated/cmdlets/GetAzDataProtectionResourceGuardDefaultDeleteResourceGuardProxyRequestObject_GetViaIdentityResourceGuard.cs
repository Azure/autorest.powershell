...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] GetDefaultDeleteResourceGuardProxyRequestsObject=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataProtection/resourceGuards/{resourceGuardsName}/deleteResourceGuardProxyRequests/{requestName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzDataProtectionResourceGuardDefaultDeleteResourceGuardProxyRequestObject_GetViaIdentityResourceGuard")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IDppBaseResource))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Description(@"Returns collection of operation request objects for a critical operation protected by the given ResourceGuard resource.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataProtection.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataProtection/resourceGuards/{resourceGuardsName}/deleteResourceGuardProxyRequests/{requestName}", ApiVersion = "2025-09-01")]
    public partial class GetAzDataProtectionResourceGuardDefaultDeleteResourceGuardProxyRequestObject_GetViaIdentityResourceGuard : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.IContext
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the DppBaseResource")]
        ...
        /// <summary>Backing field for <see cref="ResourceGuardInputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IDataProtectionIdentity _resourceGuardInputObject;

        /// <summary>Identity Parameter</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Identity Parameter", ValueFromPipeline = true)]
        [global::Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Category(global::Microsoft.Azure.PowerShell.Cmdlets.DataProtection.ParameterCategory.Path)]
        public Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IDataProtectionIdentity ResourceGuardInputObject { get => this._resourceGuardInputObject; set => this._resourceGuardInputObject = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IDppBaseResource">Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IDppBaseResource</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IDppBaseResource> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzDataProtectionResourceGuardDefaultDeleteResourceGuardProxyRequestObject_GetViaIdentityResourceGuard"
        /// /> cmdlet class.
        /// </summary>
        public GetAzDataProtectionResourceGuardDefaultDeleteResourceGuardProxyRequestObject_GetViaIdentityResourceGuard()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (ResourceGuardInputObject?.Id != null)
                    {
                        this.ResourceGuardInputObject.Id += $"/deleteResourceGuardProxyRequests/{(global::System.Uri.EscapeDataString(this.RequestName.ToString()))}";
                        await this.Client.ResourceGuardsGetDefaultDeleteResourceGuardProxyRequestsObjectViaIdentity(ResourceGuardInputObject.Id, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == ResourceGuardInputObject.SubscriptionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("ResourceGuardInputObject has null value for ResourceGuardInputObject.SubscriptionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, ResourceGuardInputObject) );
                        }
                        if (null == ResourceGuardInputObject.ResourceGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("ResourceGuardInputObject has null value for ResourceGuardInputObject.ResourceGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, ResourceGuardInputObject) );
                        }
                        if (null == ResourceGuardInputObject.ResourceGuardsName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("ResourceGuardInputObject has null value for ResourceGuardInputObject.ResourceGuardsName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, ResourceGuardInputObject) );
                        }
                        await this.Client.ResourceGuardsGetDefaultDeleteResourceGuardProxyRequestsObject(ResourceGuardInputObject.SubscriptionId ?? null, ResourceGuardInputObject.ResourceGroupName ?? null, ResourceGuardInputObject.ResourceGuardsName ?? null, RequestName, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { RequestName=RequestName})
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IDppBaseResource> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IDppBaseResource
