...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Test, @"AzDataProtectionBackupInstance_ValidateViaIdentityBackupVault1", SupportsShouldProcess = true)]
    ...
    public partial class TestAzDataProtectionBackupInstance_ValidateViaIdentityBackupVault1 : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.IContext
    {
        ...
        /// <summary>Backing field for <see cref="BackupVault1InputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IDataProtectionIdentity _backupVault1InputObject;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IDataProtectionIdentity BackupVault1InputObject { get => this._backupVault1InputObject; set => this._backupVault1InputObject = value; }
        ...
        /// <returns>
        /// a duplicate instance of TestAzDataProtectionBackupInstance_ValidateViaIdentityBackupVault1
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Cmdlets.TestAzDataProtectionBackupInstance_ValidateViaIdentityBackupVault1 Clone()
        {
            var clone = new TestAzDataProtectionBackupInstance_ValidateViaIdentityBackupVault1();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (BackupVault1InputObject?.Id != null)
                    {
                        this.BackupVault1InputObject.Id += $"/backupInstances/{(global::System.Uri.EscapeDataString(this.Name.ToString()))}";
                        await this.Client.BackupInstancesValidateForRestoreViaIdentity(BackupVault1InputObject.Id, Parameter, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == BackupVault1InputObject.SubscriptionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("BackupVault1InputObject has null value for BackupVault1InputObject.SubscriptionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, BackupVault1InputObject) );
                        }
                        if (null == BackupVault1InputObject.ResourceGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("BackupVault1InputObject has null value for BackupVault1InputObject.ResourceGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, BackupVault1InputObject) );
                        }
                        if (null == BackupVault1InputObject.VaultName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("BackupVault1InputObject has null value for BackupVault1InputObject.VaultName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, BackupVault1InputObject) );
                        }
                        await this.Client.BackupInstancesValidateForRestore(BackupVault1InputObject.SubscriptionId ?? null, BackupVault1InputObject.ResourceGroupName ?? null, BackupVault1InputObject.VaultName ?? null, Name, Parameter, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TestAzDataProtectionBackupInstance_ValidateViaIdentityBackupVault1" /> cmdlet
        /// class.
        /// </summary>
        public TestAzDataProtectionBackupInstance_ValidateViaIdentityBackupVault1()
        {
