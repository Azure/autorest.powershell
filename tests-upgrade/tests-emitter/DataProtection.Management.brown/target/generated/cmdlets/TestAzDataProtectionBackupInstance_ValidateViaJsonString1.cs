        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.BackupInstancesValidateForModifyBackupViaJsonString(SubscriptionId, ResourceGroupName, VaultName, Name, _jsonString, onOk, onDefault, this, Pipeline);
