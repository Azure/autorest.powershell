...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BackupAzDataProtectionBackupInstanceAdhoc_BackupViaIdentity" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        await this.Client.BackupInstancesAdhocBackup(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.VaultName ?? null, InputObject.BackupInstanceName ?? null, Parameter, onOk, onDefault, this, Pipeline);
                    }
