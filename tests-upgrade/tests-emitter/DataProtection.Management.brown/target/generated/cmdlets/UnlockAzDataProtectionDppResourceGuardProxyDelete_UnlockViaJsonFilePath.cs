        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.DppResourceGuardProxyUnlockDeleteViaJsonString(SubscriptionId, ResourceGroupName, VaultName, ResourceGuardProxyName, this.InvocationInformation.BoundParameters.ContainsKey("XmsAuthorizationAuxiliary") ? XmsAuthorizationAuxiliary : null, _jsonString, onOk, onDefault, this, Pipeline);
