...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] GetDisableSoftDeleteRequestsObjects=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataProtection/resourceGuards/{resourceGuardsName}/disableSoftDeleteRequests"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzDataProtectionResourceGuardDisableSoftDeleteRequestObject_Get")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataProtection.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataProtection/resourceGuards/{resourceGuardsName}/disableSoftDeleteRequests", ApiVersion = "2025-09-01")]
    public partial class GetAzDataProtectionResourceGuardDisableSoftDeleteRequestObject_Get : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzDataProtectionResourceGuardDisableSoftDeleteRequestObject_Get" /> cmdlet
        /// class.
        /// </summary>
        public GetAzDataProtectionResourceGuardDisableSoftDeleteRequestObject_Get()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ResourceGuardsGetDisableSoftDeleteRequestsObjects(SubscriptionId, ResourceGroupName, ResourceGuardsName, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.ResourceGuardsGetDisableSoftDeleteRequestsObjects_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
