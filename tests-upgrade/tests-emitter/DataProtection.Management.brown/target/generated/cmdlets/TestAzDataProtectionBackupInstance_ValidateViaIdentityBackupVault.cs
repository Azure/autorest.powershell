            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (BackupVaultInputObject?.Id != null)
                    {
                        ...
                        await this.Client.BackupInstancesValidateForModifyBackupViaIdentity(BackupVaultInputObject.Id, Parameter, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.BackupInstancesValidateForModifyBackup(BackupVaultInputObject.SubscriptionId ?? null, BackupVaultInputObject.ResourceGroupName ?? null, BackupVaultInputObject.VaultName ?? null, Name, Parameter, onOk, onDefault, this, Pipeline);
                    }
