        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.BackupInstancesTriggerRestoreViaJsonString(SubscriptionId, ResourceGroupName, VaultName, BackupInstanceName, this.InvocationInformation.BoundParameters.ContainsKey("XmsAuthorizationAuxiliary") ? XmsAuthorizationAuxiliary : null, _jsonString, onOk, onDefault, this, Pipeline);
