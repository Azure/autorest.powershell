        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.BackupInstancesStopProtection(SubscriptionId, ResourceGroupName, VaultName, BackupInstanceName, this.InvocationInformation.BoundParameters.ContainsKey("XmsAuthorizationAuxiliary") ? XmsAuthorizationAuxiliary : null, _parametersBody, onOk, onDefault, this, Pipeline);
