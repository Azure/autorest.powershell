...
$dll = Join-Path $PSScriptRoot 'bin\Az.LambdaTest.private.dll'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Az.LambdaTest.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.LambdaTest.psd1'
$guid = Get-ModuleGuid -Psd1Path $psd1
$moduleName = 'Az.LambdaTest'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: LambdaTest cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.LambdaTest.format.ps1xml'
...
if (-not $DisableAfterBuildTasks){
  ...
  $afterBuildTasksArgs = ConvertFrom-Json '{"SubModuleName":"Az.LambdaTest","ModuleRootName":"$(root-module-name)"}' -AsHashtable
