...
namespace Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Models
{
    ...
    public partial class ManagedServiceIdentityUserAssignedIdentities
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Models.IManagedServiceIdentityUserAssignedIdentities.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Models.IManagedServiceIdentityUserAssignedIdentities.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Models.IManagedServiceIdentityUserAssignedIdentities FromJson(Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Runtime.Json.JsonObject json ? new ManagedServiceIdentityUserAssignedIdentities(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Runtime.Json.JsonObject into a new instance of <see cref="ManagedServiceIdentityUserAssignedIdentities"
        /// />.
        /// </summary>
        ...
        internal ManagedServiceIdentityUserAssignedIdentities(Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Runtime.Json.JsonObject json, global::System.Collections.Generic.HashSet<string> exclusions = null)
        {
        ...
        /// <summary>
        /// Serializes this instance of <see cref="ManagedServiceIdentityUserAssignedIdentities" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ManagedServiceIdentityUserAssignedIdentities" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Runtime.Json.JsonNode"
        /// />.
        /// </returns>
