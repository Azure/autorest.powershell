...
namespace Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Models
{
    ...
    public partial class MarketplaceDetails :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Models.IMarketplaceDetailsInternal
    {

        /// <summary>Internal Acessors for OfferDetail</summary>
        Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Models.IOfferDetails Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Models.IMarketplaceDetailsInternal.OfferDetail { get => (this._offerDetail = this._offerDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Models.OfferDetails()); set { {_offerDetail = value;} } }

        /// <summary>Internal Acessors for SubscriptionStatus</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Models.IMarketplaceDetailsInternal.SubscriptionStatus { get => this._subscriptionStatus; set { {_subscriptionStatus = value;} } }

        /// <summary>Backing field for <see cref="OfferDetail" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Models.IOfferDetails _offerDetail;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Models.IOfferDetails OfferDetail { get => (this._offerDetail = this._offerDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Models.OfferDetails()); set => this._offerDetail = value; }
        ...
        public string OfferDetailOfferId { get => ((Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Models.IOfferDetailsInternal)OfferDetail).OfferId; set => ((Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Models.IOfferDetailsInternal)OfferDetail).OfferId = value ; }

        /// <summary>Plan Id for the marketplace offer</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Origin(Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.PropertyOrigin.Inlined)]
        public string OfferDetailPlanId { get => ((Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Models.IOfferDetailsInternal)OfferDetail).PlanId; set => ((Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Models.IOfferDetailsInternal)OfferDetail).PlanId = value ; }

        /// <summary>Plan Name for the marketplace offer</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Origin(Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.PropertyOrigin.Inlined)]
        public string OfferDetailPlanName { get => ((Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Models.IOfferDetailsInternal)OfferDetail).PlanName; set => ((Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Models.IOfferDetailsInternal)OfferDetail).PlanName = value ?? null; }

        /// <summary>Publisher Id for the marketplace offer</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Origin(Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.PropertyOrigin.Inlined)]
        public string OfferDetailPublisherId { get => ((Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Models.IOfferDetailsInternal)OfferDetail).PublisherId; set => ((Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Models.IOfferDetailsInternal)OfferDetail).PublisherId = value ; }

        /// <summary>Plan Display Name for the marketplace offer</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Origin(Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.PropertyOrigin.Inlined)]
        public string OfferDetailTermId { get => ((Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Models.IOfferDetailsInternal)OfferDetail).TermId; set => ((Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Models.IOfferDetailsInternal)OfferDetail).TermId = value ?? null; }

        /// <summary>Plan Display Name for the marketplace offer</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Origin(Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.PropertyOrigin.Inlined)]
        public string OfferDetailTermUnit { get => ((Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Models.IOfferDetailsInternal)OfferDetail).TermUnit; set => ((Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Models.IOfferDetailsInternal)OfferDetail).TermUnit = value ?? null; }
    ...
    {
        /// <summary>Offer details for the marketplace that is selected by the user</summary>
        Microsoft.Azure.PowerShell.Cmdlets.LambdaTest.Models.IOfferDetails OfferDetail { get; set; }
        /// <summary>Offer Id for the marketplace offer</summary>
        string OfferDetailOfferId { get; set; }
        /// <summary>Plan Id for the marketplace offer</summary>
        string OfferDetailPlanId { get; set; }
