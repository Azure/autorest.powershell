...
namespace Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Cmdlets
{
    ...
    /// <summary>create a managed private endpoint for a grafana resource.</summary>
    /// <remarks>
    /// [OpenAPI] Create=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Dashboard/grafana/{workspaceName}/managedPrivateEndpoints/{managedPrivateEndpointName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzDashboardManagedPrivateEndpoint_CreateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.IManagedPrivateEndpointModel))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Description(@"create a managed private endpoint for a grafana resource.")]
    ...
    public partial class NewAzDashboardManagedPrivateEndpoint_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.IManagedPrivateEndpointModel _requestBodyParametersBody = new Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.ManagedPrivateEndpointModel();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The group Ids of the managed private endpoint.")]
        ...
        public string[] GroupId { get => _requestBodyParametersBody.GroupId?.ToArray() ?? null /* fixedArrayOf */; set => _requestBodyParametersBody.GroupId = (value != null ? new System.Collections.Generic.List<string>(value) : null); }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The ARM resource ID of the resource for which the managed private endpoint is pointing to.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Dashboard.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string PrivateLinkResourceId { get => _requestBodyParametersBody.PrivateLinkResourceId ?? null; set => _requestBodyParametersBody.PrivateLinkResourceId = value; }

        /// <summary>
        /// The region of the resource to which the managed private endpoint is pointing to.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The region of the resource to which the managed private endpoint is pointing to.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Dashboard.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string PrivateLinkResourceRegion { get => _requestBodyParametersBody.PrivateLinkResourceRegion ?? null; set => _requestBodyParametersBody.PrivateLinkResourceRegion = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The URL of the data store behind the private link service. It would be the URL in the Grafana data source configuration page without the protocol and port.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Dashboard.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string PrivateLinkServiceUrl { get => _requestBodyParametersBody.PrivateLinkServiceUrl ?? null; set => _requestBodyParametersBody.PrivateLinkServiceUrl = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "User input request message of the managed private endpoint.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Dashboard.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string RequestMessage { get => _requestBodyParametersBody.RequestMessage ?? null; set => _requestBodyParametersBody.RequestMessage = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.IManagedPrivateEndpointModel">Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.IManagedPrivateEndpointModel</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.IManagedPrivateEndpointModel> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of NewAzDashboardManagedPrivateEndpoint_CreateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Cmdlets.NewAzDashboardManagedPrivateEndpoint_CreateExpanded Clone()
        {
            var clone = new NewAzDashboardManagedPrivateEndpoint_CreateExpanded();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAzDashboardManagedPrivateEndpoint_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzDashboardManagedPrivateEndpoint_CreateExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ManagedPrivateEndpointsCreate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ManagedPrivateEndpointsCreate(SubscriptionId, ResourceGroupName, WorkspaceName, Name, _requestBodyParametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Runtime.SerializationMode.IncludeCreate);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.IManagedPrivateEndpointModel> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Dashboard.Models.IManagedPrivateEndpointModel
