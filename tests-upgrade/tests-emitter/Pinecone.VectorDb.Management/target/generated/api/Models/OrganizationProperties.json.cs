...
namespace Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Models
{
    ...
    public partial class OrganizationProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Models.IOrganizationProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Models.IOrganizationProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Models.IOrganizationProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.Json.JsonObject json ? new OrganizationProperties(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.Json.JsonObject into a new instance of <see cref="OrganizationProperties" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal OrganizationProperties(Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.Json.JsonObject json)
        {
            ...
            {_marketplace = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.Json.JsonObject>("marketplace"), out var __jsonMarketplace) ? Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Models.MarketplaceDetails.FromJson(__jsonMarketplace) : _marketplace;}
            {_user = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.Json.JsonObject>("user"), out var __jsonUser) ? Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Models.UserDetails.FromJson(__jsonUser) : _user;}
            {_partnerProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.Json.JsonObject>("partnerProperties"), out var __jsonPartnerProperties) ? Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Models.PartnerProperties.FromJson(__jsonPartnerProperties) : _partnerProperty;}
            {_singleSignOnProperty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.Json.JsonObject>("singleSignOnProperties"), out var __jsonSingleSignOnProperties) ? Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Models.SingleSignOnPropertiesV2.FromJson(__jsonSingleSignOnProperties) : _singleSignOnProperty;}
            {_provisioningState = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.Json.JsonString>("provisioningState"), out var __jsonProvisioningState) ? (string)__jsonProvisioningState : (string)_provisioningState;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="OrganizationProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="OrganizationProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.SerializationMode serializationMode)
        {
            ...
            {
                AddIf( null != (((object)this._provisioningState)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.Json.JsonString(this._provisioningState.ToString()) : null, "provisioningState" ,container.Add );
            }
