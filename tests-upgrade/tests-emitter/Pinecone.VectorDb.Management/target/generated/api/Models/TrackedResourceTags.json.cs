...
namespace Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Models
{
    ...
    public partial class TrackedResourceTags
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Models.ITrackedResourceTags.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Models.ITrackedResourceTags.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Models.ITrackedResourceTags FromJson(Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.Json.JsonObject json ? new TrackedResourceTags(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="TrackedResourceTags" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="TrackedResourceTags" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.Json.JsonNode" />.
        /// </returns>
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.Json.JsonObject into a new instance of <see cref="TrackedResourceTags" />.
        /// </summary>
        ...
        internal TrackedResourceTags(Microsoft.Azure.PowerShell.Cmdlets.Pinecone.Runtime.Json.JsonObject json, global::System.Collections.Generic.HashSet<string> exclusions = null)
        {
            bool returnNow = false;
