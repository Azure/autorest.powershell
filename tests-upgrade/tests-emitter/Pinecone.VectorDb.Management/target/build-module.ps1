...
$dll = Join-Path $PSScriptRoot 'bin\Az.Pinecone.private.dll'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Az.Pinecone.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.Pinecone.psd1'
$guid = Get-ModuleGuid -Psd1Path $psd1
$moduleName = 'Az.Pinecone'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: Pinecone cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.Pinecone.format.ps1xml'
...
if (-not $DisableAfterBuildTasks){
  ...
  $afterBuildTasksArgs = ConvertFrom-Json '{"SubModuleName":"Az.Pinecone","ModuleRootName":"$(root-module-name)"}' -AsHashtable
