...
namespace Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzMlWorkspaceIndexLatest_Get")]
    ...
    public partial class GetAzMlWorkspaceIndexLatest_Get : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzMlWorkspaceIndexLatest_Get" /> cmdlet class.
        /// </summary>
        public GetAzMlWorkspaceIndexLatest_Get()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.IndexesGetLatest(Name, SubscriptionId, ResourceGroupName, WorkspaceName, Endpoint, onOk, onDefault, this, Pipeline);
