...
namespace Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Cmdlets
{
    ...
    /// <summary>create a IndexVersion.</summary>
    /// <remarks>
    /// [OpenAPI] CreateOrUpdate=>PUT:"/indexes/{name}/versions/{version}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzMlWorkspaceIndex_CreateViaIdentityIndexExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Description(@"create a IndexVersion.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.HttpPath(Path = "/indexes/{name}/versions/{version}", ApiVersion = "2024-05-01-preview")]
    public partial class NewAzMlWorkspaceIndex_CreateViaIdentityIndexExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.IContext
    {
        ...
        /// <summary>Backing field for <see cref="IndexInputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IMachineLearningServicesIdentity _indexInputObject;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IMachineLearningServicesIdentity IndexInputObject { get => this._indexInputObject; set => this._indexInputObject = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Default workspace blob storage Uri. Should work across storage types and auth scenarios.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Category(global::Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Version of the index.")]
        [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAzMlWorkspaceIndex_CreateViaIdentityIndexExpanded" /> cmdlet class.
        /// </summary>
        public NewAzMlWorkspaceIndex_CreateViaIdentityIndexExpanded()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (IndexInputObject?.Id != null)
                    {
                        this.IndexInputObject.Id += $"/versions/{(global::System.Uri.EscapeDataString(this.Version.ToString()))}";
                        await this.Client.IndexesCreateOrUpdateViaIdentity(IndexInputObject.Id, ResourceGroupName, WorkspaceName, Endpoint, SubscriptionId, _body, onCreated, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.SerializationMode.IncludeCreate);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == IndexInputObject.Name)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("IndexInputObject has null value for IndexInputObject.Name"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, IndexInputObject) );
                        }
                        await this.Client.IndexesCreateOrUpdate(IndexInputObject.Name ?? null, Version, ResourceGroupName, WorkspaceName, Endpoint, SubscriptionId, _body, onCreated, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.SerializationMode.IncludeCreate);
                    }
