...
namespace Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzMlWorkspacePrompt_CreateViaIdentityPromptExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Description(@"create a Prompt")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.HttpPath(Path = "/prompts/{name}/versions/{version}", ApiVersion = "2024-05-01-preview")]
    public partial class NewAzMlWorkspacePrompt_CreateViaIdentityPromptExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.IContext
    {
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Default workspace blob storage Ui. Should work across storage types and auth scenarios.")]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAzMlWorkspacePrompt_CreateViaIdentityPromptExpanded" /> cmdlet class.
        /// </summary>
        public NewAzMlWorkspacePrompt_CreateViaIdentityPromptExpanded()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (PromptInputObject?.Id != null)
                    {
                        ...
                        await this.Client.PromptsCreateOrUpdateViaIdentity(PromptInputObject.Id, ResourceGroupName, WorkspaceName, Endpoint, SubscriptionId, _body, onCreated, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.SerializationMode.IncludeCreate);
                    }
                    else
                    {
                        ...
                        await this.Client.PromptsCreateOrUpdate(PromptInputObject.Name ?? null, Version, ResourceGroupName, WorkspaceName, Endpoint, SubscriptionId, _body, onCreated, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.SerializationMode.IncludeCreate);
                    }
