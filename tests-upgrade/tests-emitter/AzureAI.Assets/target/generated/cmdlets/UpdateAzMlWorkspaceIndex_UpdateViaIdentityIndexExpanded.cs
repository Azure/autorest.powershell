...
namespace Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzMlWorkspaceIndex_UpdateViaIdentityIndexExpanded", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzMlWorkspaceIndex_UpdateViaIdentityIndexExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.IContext
    {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (IndexInputObject?.Id != null)
                    {
                        ...
                        _body = await this.Client.IndexesGetViaIdentityWithResult(IndexInputObject.Id, ResourceGroupName, WorkspaceName, Endpoint, SubscriptionId, this, Pipeline);
                        this.Update_body();
                        await this.Client.IndexesCreateOrUpdateViaIdentity(IndexInputObject.Id, ResourceGroupName, WorkspaceName, Endpoint, SubscriptionId, _body, onCreated, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _body = await this.Client.IndexesGetWithResult(IndexInputObject.Name ?? null, Version, ResourceGroupName, WorkspaceName, Endpoint, SubscriptionId, this, Pipeline);
                        this.Update_body();
                        await this.Client.IndexesCreateOrUpdate(IndexInputObject.Name ?? null, Version, ResourceGroupName, WorkspaceName, Endpoint, SubscriptionId, _body, onCreated, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzMlWorkspaceIndex_UpdateViaIdentityIndexExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzMlWorkspaceIndex_UpdateViaIdentityIndexExpanded()
        {
        ...
        private void Update_body()
        {
            ...
            {
                this.Tag = (Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IIndexTags)(this.MyInvocation?.BoundParameters["Tag"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("Property")))
            {
                this.Property = (Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IIndexProperties)(this.MyInvocation?.BoundParameters["Property"]);
            }
