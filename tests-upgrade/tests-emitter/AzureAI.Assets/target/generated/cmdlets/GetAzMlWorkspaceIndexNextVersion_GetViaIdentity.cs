...
namespace Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] GetNextVersion=>POST:"/indexes/{name}:getNextVersion"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzMlWorkspaceIndexNextVersion_GetViaIdentity", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Description(@"Get next Index version as defined by the server. The server keeps track of all versions that are string-representations of integers. If one exists, the nextVersion will be a string representation of the highest integer value + 1. Otherwise, the nextVersion will default to '1'.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.HttpPath(Path = "/indexes/{name}:getNextVersion", ApiVersion = "2024-05-01-preview")]
    public partial class GetAzMlWorkspaceIndexNextVersion_GetViaIdentity : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzMlWorkspaceIndexNextVersion_GetViaIdentity" /> cmdlet class.
        /// </summary>
        public GetAzMlWorkspaceIndexNextVersion_GetViaIdentity()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'IndexesGetNextVersion' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        {
                            await this.Client.IndexesGetNextVersionViaIdentity(InputObject.Id, Endpoint, SubscriptionId, ResourceGroupName, WorkspaceName, onOk, onDefault, this, Pipeline);
                        }
                        else
                        {
                            ...
                            await this.Client.IndexesGetNextVersion(InputObject.Name ?? null, Endpoint, SubscriptionId, ResourceGroupName, WorkspaceName, onOk, onDefault, this, Pipeline);
                        }
