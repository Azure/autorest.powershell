...
namespace Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/prompts/{name}/versions/{version}"
    /// [OpenAPI] CreateOrUpdate=>PUT:"/prompts/{name}/versions/{version}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzMlWorkspacePrompt_UpdateViaIdentityPromptExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Description(@"update a Prompt")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Generated]
    public partial class UpdateAzMlWorkspacePrompt_UpdateViaIdentityPromptExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IPrompt _body = new Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.Prompt();
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Default workspace blob storage Ui. Should work across storage types and auth scenarios.")]
        ...
        /// <summary>Backing field for <see cref="PromptInputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IMachineLearningServicesIdentity _promptInputObject;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IMachineLearningServicesIdentity PromptInputObject { get => this._promptInputObject; set => this._promptInputObject = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Relative path of the prompt data file at the dataUri location")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Category(global::Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Info(
        Required = false,
        ReadOnly = false,
        Description = @"Relative path of the prompt data file at the dataUri location",
        SerializedName = @"templatePath",
        PossibleTypes = new [] { typeof(string) })]
        public string TemplatePath { get => _body.TemplatePath ?? null; set => _body.TemplatePath = value; }

        /// <summary>Backing field for <see cref="Version" /> property.</summary>
        private string _version;

        /// <summary>Version of the prompt</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Version of the prompt")]
        [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IPrompt">Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IPrompt</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onCreated method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IPrompt> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IPrompt> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'PromptsCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (PromptInputObject?.Id != null)
                    {
                        this.PromptInputObject.Id += $"/versions/{(global::System.Uri.EscapeDataString(this.Version.ToString()))}";
                        _body = await this.Client.PromptsGetViaIdentityWithResult(PromptInputObject.Id, ResourceGroupName, WorkspaceName, Endpoint, SubscriptionId, this, Pipeline);
                        this.Update_body();
                        await this.Client.PromptsCreateOrUpdateViaIdentity(PromptInputObject.Id, ResourceGroupName, WorkspaceName, Endpoint, SubscriptionId, _body, onCreated, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == PromptInputObject.Name)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("PromptInputObject has null value for PromptInputObject.Name"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, PromptInputObject) );
                        }
                        _body = await this.Client.PromptsGetWithResult(PromptInputObject.Name ?? null, Version, ResourceGroupName, WorkspaceName, Endpoint, SubscriptionId, this, Pipeline);
                        this.Update_body();
                        await this.Client.PromptsCreateOrUpdate(PromptInputObject.Name ?? null, Version, ResourceGroupName, WorkspaceName, Endpoint, SubscriptionId, _body, onCreated, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzMlWorkspacePrompt_UpdateViaIdentityPromptExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzMlWorkspacePrompt_UpdateViaIdentityPromptExpanded()
        {
        ...
        private void Update_body()
        {
            ...
            {
                this.Tag = (Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IPromptTags)(this.MyInvocation?.BoundParameters["Tag"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("Property")))
            {
                this.Property = (Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IPromptProperties)(this.MyInvocation?.BoundParameters["Property"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("DataUri")))
            {
                this.DataUri = (string)(this.MyInvocation?.BoundParameters["DataUri"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("TemplatePath")))
            {
                this.TemplatePath = (string)(this.MyInvocation?.BoundParameters["TemplatePath"]);
            }
        }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IPrompt> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IPrompt
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Models.IPrompt> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
