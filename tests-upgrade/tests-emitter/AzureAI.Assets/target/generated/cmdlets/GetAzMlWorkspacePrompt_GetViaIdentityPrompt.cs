...
namespace Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzMlWorkspacePrompt_GetViaIdentityPrompt")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Description(@"Get a specific version of a Prompt.")]
    ...
    public partial class GetAzMlWorkspacePrompt_GetViaIdentityPrompt : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzMlWorkspacePrompt_GetViaIdentityPrompt" /> cmdlet class.
        /// </summary>
        public GetAzMlWorkspacePrompt_GetViaIdentityPrompt()
        {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        if (PromptInputObject?.Id != null)
                        {
                            ...
                            await this.Client.PromptsGetViaIdentity(PromptInputObject.Id, ResourceGroupName, WorkspaceName, Endpoint, SubscriptionId, onOk, onDefault, this, Pipeline);
                        }
                        else
                        {
                            ...
                            await this.Client.PromptsGet(PromptInputObject.Name ?? null, Version, ResourceGroupName, WorkspaceName, Endpoint, SubscriptionId, onOk, onDefault, this, Pipeline);
                        }
