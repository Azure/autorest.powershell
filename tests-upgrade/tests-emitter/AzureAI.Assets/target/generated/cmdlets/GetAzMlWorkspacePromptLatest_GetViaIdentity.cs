...
namespace Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] GetLatest=>GET:"/prompts/{name}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzMlWorkspacePromptLatest_GetViaIdentity")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Description(@"Get latest version of the Prompt. Latest is defined by most recent created by date.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.HttpPath(Path = "/prompts/{name}", ApiVersion = "2024-05-01-preview")]
    public partial class GetAzMlWorkspacePromptLatest_GetViaIdentity : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzMlWorkspacePromptLatest_GetViaIdentity" /> cmdlet class.
        /// </summary>
        public GetAzMlWorkspacePromptLatest_GetViaIdentity()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        {
                            await this.Client.PromptsGetLatestViaIdentity(InputObject.Id, SubscriptionId, ResourceGroupName, WorkspaceName, Endpoint, onOk, onDefault, this, Pipeline);
                        }
                        else
                        {
                            ...
                            await this.Client.PromptsGetLatest(InputObject.Name ?? null, SubscriptionId, ResourceGroupName, WorkspaceName, Endpoint, onOk, onDefault, this, Pipeline);
                        }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,WorkspaceName=WorkspaceName,Endpoint=Endpoint})
                    {
