...
namespace Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] GetLatest=>GET:"/indexes/{name}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzMlWorkspaceIndexLatest_GetViaIdentity")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Description(@"Get latest version of the Index. Latest is defined by most recent created by date.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.HttpPath(Path = "/indexes/{name}", ApiVersion = "2024-05-01-preview")]
    public partial class GetAzMlWorkspaceIndexLatest_GetViaIdentity : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzMlWorkspaceIndexLatest_GetViaIdentity" /> cmdlet class.
        /// </summary>
        public GetAzMlWorkspaceIndexLatest_GetViaIdentity()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        {
                            await this.Client.IndexesGetLatestViaIdentity(InputObject.Id, SubscriptionId, ResourceGroupName, WorkspaceName, Endpoint, onOk, onDefault, this, Pipeline);
                        }
                        else
                        {
                            ...
                            await this.Client.IndexesGetLatest(InputObject.Name ?? null, SubscriptionId, ResourceGroupName, WorkspaceName, Endpoint, onOk, onDefault, this, Pipeline);
                        }
