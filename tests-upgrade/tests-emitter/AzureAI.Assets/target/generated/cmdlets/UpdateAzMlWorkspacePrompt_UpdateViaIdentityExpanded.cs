...
namespace Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzMlWorkspacePrompt_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzMlWorkspacePrompt_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.IContext
    {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        _body = await this.Client.PromptsGetViaIdentityWithResult(InputObject.Id, ResourceGroupName, WorkspaceName, Endpoint, SubscriptionId, this, Pipeline);
                        this.Update_body();
                        await this.Client.PromptsCreateOrUpdateViaIdentity(InputObject.Id, ResourceGroupName, WorkspaceName, Endpoint, SubscriptionId, _body, onCreated, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _body = await this.Client.PromptsGetWithResult(InputObject.Name ?? null, InputObject.Version ?? null, ResourceGroupName, WorkspaceName, Endpoint, SubscriptionId, this, Pipeline);
                        this.Update_body();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzMlWorkspacePrompt_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzMlWorkspacePrompt_UpdateViaIdentityExpanded()
        {
