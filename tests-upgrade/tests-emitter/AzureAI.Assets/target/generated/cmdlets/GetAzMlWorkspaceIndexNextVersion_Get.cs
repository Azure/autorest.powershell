...
namespace Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzMlWorkspaceIndexNextVersion_Get", SupportsShouldProcess = true)]
    ...
    public partial class GetAzMlWorkspaceIndexNextVersion_Get : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.IContext
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Name of the index.")]
        [Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzMlWorkspaceIndexNextVersion_Get" /> cmdlet class.
        /// </summary>
        public GetAzMlWorkspaceIndexNextVersion_Get()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.IndexesGetNextVersion(Name, Endpoint, SubscriptionId, ResourceGroupName, WorkspaceName, onOk, onDefault, this, Pipeline);
