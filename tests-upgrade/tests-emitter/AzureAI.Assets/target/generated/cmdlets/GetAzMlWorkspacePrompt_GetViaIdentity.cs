...
namespace Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzMlWorkspacePrompt_GetViaIdentity")]
    ...
    public partial class GetAzMlWorkspacePrompt_GetViaIdentity : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzMlWorkspacePrompt_GetViaIdentity" /> cmdlet class.
        /// </summary>
        public GetAzMlWorkspacePrompt_GetViaIdentity()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        {
                            await this.Client.PromptsGetViaIdentity(InputObject.Id, ResourceGroupName, WorkspaceName, Endpoint, SubscriptionId, onOk, onDefault, this, Pipeline);
                        }
                        else
                        {
                            ...
                            await this.Client.PromptsGet(InputObject.Name ?? null, InputObject.Version ?? null, ResourceGroupName, WorkspaceName, Endpoint, SubscriptionId, onOk, onDefault, this, Pipeline);
                        }
