...
namespace Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzMlWorkspaceIndex_GetViaIdentityIndex")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Description(@"Get a specific version of an Index.")]
    ...
    public partial class GetAzMlWorkspaceIndex_GetViaIdentityIndex : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzMlWorkspaceIndex_GetViaIdentityIndex" /> cmdlet class.
        /// </summary>
        public GetAzMlWorkspaceIndex_GetViaIdentityIndex()
        {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        if (IndexInputObject?.Id != null)
                        {
                            ...
                            await this.Client.IndexesGetViaIdentity(IndexInputObject.Id, ResourceGroupName, WorkspaceName, Endpoint, SubscriptionId, onOk, onDefault, this, Pipeline);
                        }
                        else
                        {
                            ...
                            await this.Client.IndexesGet(IndexInputObject.Name ?? null, Version, ResourceGroupName, WorkspaceName, Endpoint, SubscriptionId, onOk, onDefault, this, Pipeline);
                        }
