...
namespace Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzMlWorkspaceIndex_Get")]
    ...
    public partial class GetAzMlWorkspaceIndex_Get : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MachineLearningServices.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzMlWorkspaceIndex_Get" /> cmdlet class.
        /// </summary>
        public GetAzMlWorkspaceIndex_Get()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.IndexesGet(Name, Version, ResourceGroupName, WorkspaceName, Endpoint, SubscriptionId, onOk, onDefault, this, Pipeline);
