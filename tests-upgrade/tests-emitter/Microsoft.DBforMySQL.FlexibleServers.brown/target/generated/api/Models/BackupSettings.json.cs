...
namespace Microsoft.Azure.PowerShell.Cmdlets.MySql.Models
{
    ...
    public partial class BackupSettings
    {
        ...
        internal BackupSettings(Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.Json.JsonObject json)
        {
            ...
            {_backupFormat = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.Json.JsonString>("backupFormat"), out var __jsonBackupFormat) ? (string)__jsonBackupFormat : (string)_backupFormat;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.IBackupSettings.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.IBackupSettings.</returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.IBackupSettings FromJson(Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.Json.JsonNode node)
        {
