...
namespace Microsoft.Azure.PowerShell.Cmdlets.MySql.Models
{
    ...
    public partial class Network
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.INetwork.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.INetwork.</returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.INetwork FromJson(Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.Json.JsonNode node)
        {
        ...
        internal Network(Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.Json.JsonObject json)
        {
            ...
            {_publicNetworkAccess = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.Json.JsonString>("publicNetworkAccess"), out var __jsonPublicNetworkAccess) ? (string)__jsonPublicNetworkAccess : (string)_publicNetworkAccess;}
            {_delegatedSubnetResourceId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.Json.JsonString>("delegatedSubnetResourceId"), out var __jsonDelegatedSubnetResourceId) ? (string)__jsonDelegatedSubnetResourceId : (string)_delegatedSubnetResourceId;}
            {_privateDnsZoneResourceId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.Json.JsonString>("privateDnsZoneResourceId"), out var __jsonPrivateDnsZoneResourceId) ? (string)__jsonPrivateDnsZoneResourceId : (string)_privateDnsZoneResourceId;}
            AfterFromJson(json);
        }
