...
namespace Microsoft.Azure.PowerShell.Cmdlets.MySql.Models
{
    ...
    public partial class SkuCapability :
        Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.ISkuCapability,
        Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.ISkuCapabilityInternal
    {

        /// <summary>Internal Acessors for Name</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.ISkuCapabilityInternal.Name { get => this._name; set { {_name = value;} } }

        /// <summary>Internal Acessors for SupportedIop</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.ISkuCapabilityInternal.SupportedIop { get => this._supportedIop; set { {_supportedIop = value;} } }

        /// <summary>Internal Acessors for SupportedMemoryPerVCoreMb</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.ISkuCapabilityInternal.SupportedMemoryPerVCoreMb { get => this._supportedMemoryPerVCoreMb; set { {_supportedMemoryPerVCoreMb = value;} } }

        /// <summary>Internal Acessors for VCore</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.ISkuCapabilityInternal.VCore { get => this._vCore; set { {_vCore = value;} } }
