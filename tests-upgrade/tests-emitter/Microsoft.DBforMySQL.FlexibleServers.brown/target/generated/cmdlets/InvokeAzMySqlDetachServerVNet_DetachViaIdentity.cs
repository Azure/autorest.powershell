...
namespace Microsoft.Azure.PowerShell.Cmdlets.MySql.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzMySqlDetachServerVNet_DetachViaIdentity", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.MySql.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMySQL/flexibleServers/{serverName}/detachVNet", ApiVersion = "2025-06-01-preview")]
    public partial class InvokeAzMySqlDetachServerVNet_DetachViaIdentity : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.IServerDetachVNetParameter _parameter;

        /// <summary>Parameters to detach Vnet.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Parameters to detach Vnet.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Parameters to detach Vnet.",
        SerializedName = @"parameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.IServerDetachVNetParameter) })]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.IServerDetachVNetParameter Parameter { get => this._parameter; set => this._parameter = value; }
        ...
        /// <returns>a duplicate instance of InvokeAzMySqlDetachServerVNet_DetachViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.MySql.Cmdlets.InvokeAzMySqlDetachServerVNet_DetachViaIdentity Clone()
        {
            var clone = new InvokeAzMySqlDetachServerVNet_DetachViaIdentity();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InvokeAzMySqlDetachServerVNet_DetachViaIdentity" /> cmdlet class.
        /// </summary>
        public InvokeAzMySqlDetachServerVNet_DetachViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ServersDetachVNetViaIdentity(InputObject.Id, Parameter, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ServersDetachVNet(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ServerName ?? null, Parameter, onOk, onDefault, this, Pipeline);
                    }
