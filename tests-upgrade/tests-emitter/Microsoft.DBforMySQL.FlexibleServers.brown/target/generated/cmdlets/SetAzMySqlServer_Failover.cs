...
namespace Microsoft.Azure.PowerShell.Cmdlets.MySql.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"AzMySqlServer_Failover", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.MySql.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMySQL/flexibleServers/{serverName}/failover", ApiVersion = "2025-06-01-preview")]
    public partial class SetAzMySqlServer_Failover : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.IContext
    {
        ...
        /// <returns>a duplicate instance of SetAzMySqlServer_Failover</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.MySql.Cmdlets.SetAzMySqlServer_Failover Clone()
        {
            var clone = new SetAzMySqlServer_Failover();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ServersFailover' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ServersFailover(SubscriptionId, ResourceGroupName, Name, onOk, onDefault, this, Pipeline);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SetAzMySqlServer_Failover" /> cmdlet class.
        /// </summary>
        public SetAzMySqlServer_Failover()
        {
