...
namespace Microsoft.Azure.PowerShell.Cmdlets.MySql.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.MySql.Description(@"update a new server or update an existing server. The update action will overwrite the existing server.")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.IContext
    {
        ...
        public string MaintenanceWindowBatchOfMaintenance { get => _parametersBody.MaintenanceWindowBatchOfMaintenance ?? null; set => _parametersBody.MaintenanceWindowBatchOfMaintenance = value; }
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (InputObject?.Id != null)
                    {
                        ...
                        await this.Client.ServersCreateViaIdentity(InputObject.Id, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        this.PreProcessManagedIdentityParametersWithGetResult();
                        this.Update_parametersBody();
                        await this.Client.ServersCreate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ServerName ?? null, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzMySqlServer_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        ...
        private void Update_parametersBody()
        {
            ...
            {
                this.Tag = (Microsoft.Azure.PowerShell.Cmdlets.MySql.Models.ITrackedResourceTags)(this.MyInvocation?.BoundParameters["Tag"]);
            }
            ...
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("HighAvailabilityReplicationMode")))
            {
                this.HighAvailabilityReplicationMode = (string)(this.MyInvocation?.BoundParameters["HighAvailabilityReplicationMode"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("MaintenancePolicyPatchStrategy")))
            {
                this.MaintenancePolicyPatchStrategy = (string)(this.MyInvocation?.BoundParameters["MaintenancePolicyPatchStrategy"]);
            }
            ...
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("StorageLogOnDisk")))
            {
                this.StorageLogOnDisk = (string)(this.MyInvocation?.BoundParameters["StorageLogOnDisk"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("StorageAutoIoScaling")))
            {
                this.StorageAutoIoScaling = (string)(this.MyInvocation?.BoundParameters["StorageAutoIoScaling"]);
            }
            ...
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("BackupIntervalHour")))
            {
                this.BackupIntervalHour = (int)(this.MyInvocation?.BoundParameters["BackupIntervalHour"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("BackupGeoRedundantBackup")))
            {
                this.BackupGeoRedundantBackup = (string)(this.MyInvocation?.BoundParameters["BackupGeoRedundantBackup"]);
            }
            ...
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("MaintenanceWindowBatchOfMaintenance")))
            {
                this.MaintenanceWindowBatchOfMaintenance = (string)(this.MyInvocation?.BoundParameters["MaintenanceWindowBatchOfMaintenance"]);
            }
        }
