...
namespace Microsoft.Azure.PowerShell.Cmdlets.MySql.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzMySqlCutoverServersMigration_CutoverViaIdentity", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.MySql.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMySQL/flexibleServers/{serverName}/cutoverMigration", ApiVersion = "2025-06-01-preview")]
    public partial class InvokeAzMySqlCutoverServersMigration_CutoverViaIdentity : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.IContext
    {
        ...
        /// <returns>a duplicate instance of InvokeAzMySqlCutoverServersMigration_CutoverViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.MySql.Cmdlets.InvokeAzMySqlCutoverServersMigration_CutoverViaIdentity Clone()
        {
            var clone = new InvokeAzMySqlCutoverServersMigration_CutoverViaIdentity();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InvokeAzMySqlCutoverServersMigration_CutoverViaIdentity" /> cmdlet class.
        /// </summary>
        public InvokeAzMySqlCutoverServersMigration_CutoverViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ServersMigrationCutoverMigrationViaIdentity(InputObject.Id, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ServersMigrationCutoverMigration(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ServerName ?? null, onOk, onDefault, this, Pipeline);
                    }
