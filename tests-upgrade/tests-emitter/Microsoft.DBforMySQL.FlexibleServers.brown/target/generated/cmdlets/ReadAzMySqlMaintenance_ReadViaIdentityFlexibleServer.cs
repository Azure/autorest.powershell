...
namespace Microsoft.Azure.PowerShell.Cmdlets.MySql.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommunications.Read, @"AzMySqlMaintenance_ReadViaIdentityFlexibleServer")]
    ...
    public partial class ReadAzMySqlMaintenance_ReadViaIdentityFlexibleServer : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.IContext
    {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (FlexibleServerInputObject?.Id != null)
                    {
                        ...
                        await this.Client.MaintenancesReadViaIdentity(FlexibleServerInputObject.Id, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.MaintenancesRead(FlexibleServerInputObject.SubscriptionId ?? null, FlexibleServerInputObject.ResourceGroupName ?? null, FlexibleServerInputObject.ServerName ?? null, Name, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ReadAzMySqlMaintenance_ReadViaIdentityFlexibleServer" /> cmdlet class.
        /// </summary>
        public ReadAzMySqlMaintenance_ReadViaIdentityFlexibleServer()
        {
