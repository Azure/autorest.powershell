...
namespace Microsoft.Azure.PowerShell.Cmdlets.MySql.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Delete=>DELETE:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMySQL/flexibleServers/{serverName}/backupsV2/{backupName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzMySqlLongRunningBackup_DeleteViaIdentityFlexibleServer", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.MySql.Description(@"Delete backup for a given server with specified backup name")]
    ...
    public partial class RemoveAzMySqlLongRunningBackup_DeleteViaIdentityFlexibleServer : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.IContext
    {
        ...
        /// <returns>
        /// a duplicate instance of RemoveAzMySqlLongRunningBackup_DeleteViaIdentityFlexibleServer
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.MySql.Cmdlets.RemoveAzMySqlLongRunningBackup_DeleteViaIdentityFlexibleServer Clone()
        {
            var clone = new RemoveAzMySqlLongRunningBackup_DeleteViaIdentityFlexibleServer();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'LongRunningBackupDelete' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (FlexibleServerInputObject?.Id != null)
                    {
                        ...
                        await this.Client.LongRunningBackupDeleteViaIdentity(FlexibleServerInputObject.Id, onNoContent, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.LongRunningBackupDelete(FlexibleServerInputObject.SubscriptionId ?? null, FlexibleServerInputObject.ResourceGroupName ?? null, FlexibleServerInputObject.ServerName ?? null, BackupName, onNoContent, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveAzMySqlLongRunningBackup_DeleteViaIdentityFlexibleServer" /> cmdlet
        /// class.
        /// </summary>
        public RemoveAzMySqlLongRunningBackup_DeleteViaIdentityFlexibleServer()
        {
