...
namespace Microsoft.Azure.PowerShell.Cmdlets.MySql.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzMySqlFirewallRule_DeleteViaIdentityFlexibleServer", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.MySql.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMySQL/flexibleServers/{serverName}/firewallRules/{firewallRuleName}", ApiVersion = "2025-06-01-preview")]
    public partial class RemoveAzMySqlFirewallRule_DeleteViaIdentityFlexibleServer : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.IContext
    {
        ...
        /// <returns>
        /// a duplicate instance of RemoveAzMySqlFirewallRule_DeleteViaIdentityFlexibleServer
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.MySql.Cmdlets.RemoveAzMySqlFirewallRule_DeleteViaIdentityFlexibleServer Clone()
        {
            var clone = new RemoveAzMySqlFirewallRule_DeleteViaIdentityFlexibleServer();
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (FlexibleServerInputObject?.Id != null)
                    {
                        ...
                        await this.Client.FirewallRulesDeleteViaIdentity(FlexibleServerInputObject.Id, onOk, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.FirewallRulesDelete(FlexibleServerInputObject.SubscriptionId ?? null, FlexibleServerInputObject.ResourceGroupName ?? null, FlexibleServerInputObject.ServerName ?? null, Name, onOk, onNoContent, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveAzMySqlFirewallRule_DeleteViaIdentityFlexibleServer" /> cmdlet class.
        /// </summary>
        public RemoveAzMySqlFirewallRule_DeleteViaIdentityFlexibleServer()
        {
