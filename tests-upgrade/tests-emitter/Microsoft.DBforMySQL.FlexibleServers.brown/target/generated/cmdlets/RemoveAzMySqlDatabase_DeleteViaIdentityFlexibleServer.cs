...
namespace Microsoft.Azure.PowerShell.Cmdlets.MySql.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzMySqlDatabase_DeleteViaIdentityFlexibleServer", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.MySql.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMySQL/flexibleServers/{serverName}/databases/{databaseName}", ApiVersion = "2025-06-01-preview")]
    public partial class RemoveAzMySqlDatabase_DeleteViaIdentityFlexibleServer : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.MySql.Runtime.IContext
    {
        ...
        /// <returns>a duplicate instance of RemoveAzMySqlDatabase_DeleteViaIdentityFlexibleServer</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.MySql.Cmdlets.RemoveAzMySqlDatabase_DeleteViaIdentityFlexibleServer Clone()
        {
            var clone = new RemoveAzMySqlDatabase_DeleteViaIdentityFlexibleServer();
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (FlexibleServerInputObject?.Id != null)
                    {
                        ...
                        await this.Client.DatabasesDeleteViaIdentity(FlexibleServerInputObject.Id, onOk, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.DatabasesDelete(FlexibleServerInputObject.SubscriptionId ?? null, FlexibleServerInputObject.ResourceGroupName ?? null, FlexibleServerInputObject.ServerName ?? null, Name, onOk, onNoContent, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveAzMySqlDatabase_DeleteViaIdentityFlexibleServer" /> cmdlet class.
        /// </summary>
        public RemoveAzMySqlDatabase_DeleteViaIdentityFlexibleServer()
        {
