...
namespace Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Cmdlets
{
    ...
    /// <summary>
    /// create the first version of a new key if it does not exist. If it already exists, then the existing key is returned without
    /// any write operations being performed. This API does not create subsequent versions, and does not create existing keys.
    /// </summary>
    /// <remarks>
    /// [OpenAPI] CreateIfNotExist=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.KeyVault/managedHSMs/{name}/keys/{keyName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzKeyVaultManagedHsmKeyIfNotExist_CreateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.IManagedHsmKey))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Description(@"create the first version of a new key if it does not exist. If it already exists, then the existing key is returned without any write operations being performed. This API does not create subsequent versions, and does not create existing keys.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.KeyVault.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.KeyVault/managedHSMs/{name}/keys/{keyName}", ApiVersion = "2025-05-01")]
    public partial class NewAzKeyVaultManagedHsmKeyIfNotExist_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.IManagedHsmKeyCreateParameters _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.ManagedHsmKeyCreateParameters();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Determines whether or not the object is enabled.")]
        ...
        public global::System.Management.Automation.SwitchParameter AttributeEnabled { get => _parametersBody.AttributeEnabled ?? default(global::System.Management.Automation.SwitchParameter); set => _parametersBody.AttributeEnabled = value; }

        /// <summary>Expiry date in seconds since 1970-01-01T00:00:00Z.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Expiry date in seconds since 1970-01-01T00:00:00Z.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Category(global::Microsoft.Azure.PowerShell.Cmdlets.KeyVault.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public long AttributeExpire { get => _parametersBody.AttributeExpire ?? default(long); set => _parametersBody.AttributeExpire = value; }

        /// <summary>
        /// The expiration time for the new key version. It should be in ISO8601 format. Eg: 'P90D', 'P1Y'.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The expiration time for the new key version. It should be in ISO8601 format. Eg: 'P90D', 'P1Y'.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Category(global::Microsoft.Azure.PowerShell.Cmdlets.KeyVault.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public string AttributeExpiryTime { get => _parametersBody.AttributeExpiryTime ?? null; set => _parametersBody.AttributeExpiryTime = value; }

        /// <summary>Indicates if the private key can be exported.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Indicates if the private key can be exported.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Category(global::Microsoft.Azure.PowerShell.Cmdlets.KeyVault.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(global::System.Management.Automation.SwitchParameter) })]
        public global::System.Management.Automation.SwitchParameter AttributeExportable { get => _parametersBody.AttributeExportable ?? default(global::System.Management.Automation.SwitchParameter); set => _parametersBody.AttributeExportable = value; }

        /// <summary>Not before date in seconds since 1970-01-01T00:00:00Z.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Not before date in seconds since 1970-01-01T00:00:00Z.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Category(global::Microsoft.Azure.PowerShell.Cmdlets.KeyVault.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        SerializedName = @"nbf",
        PossibleTypes = new [] { typeof(long) })]
        public long AttributeNotBefore { get => _parametersBody.AttributeNotBefore ?? default(long); set => _parametersBody.AttributeNotBefore = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The elliptic curve name. For valid values, see JsonWebKeyCurveName. Default for EC and EC-HSM keys is P-256")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Category(global::Microsoft.Azure.PowerShell.Cmdlets.KeyVault.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public string CurveName { get => _parametersBody.CurveName ?? null; set => _parametersBody.CurveName = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the key to be created. The value you provide may be copied globally for the purpose of running the service. The value provided should not include personally identifiable or sensitive information.")]
        [Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Array of JsonWebKeyOperation")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Category(global::Microsoft.Azure.PowerShell.Cmdlets.KeyVault.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public string[] KeyOp { get => _parametersBody.KeyOp?.ToArray() ?? null /* fixedArrayOf */; set => _parametersBody.KeyOp = (value != null ? new System.Collections.Generic.List<string>(value) : null); }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The key size in bits. For example: 2048, 3072, or 4096 for RSA. Default for RSA and RSA-HSM keys is 2048. Exception made for bring your own key (BYOK), key exchange keys default to 4096.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Category(global::Microsoft.Azure.PowerShell.Cmdlets.KeyVault.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public int KeySize { get => _parametersBody.KeySize ?? default(int); set => _parametersBody.KeySize = value; }

        /// <summary>The type of the key. For valid values, see JsonWebKeyType.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The type of the key. For valid values, see JsonWebKeyType.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Category(global::Microsoft.Azure.PowerShell.Cmdlets.KeyVault.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public string Kty { get => _parametersBody.Kty ?? null; set => _parametersBody.Kty = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the Managed HSM Pool within the specified resource group.")]
        [Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Content type and version of key release policy")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Category(global::Microsoft.Azure.PowerShell.Cmdlets.KeyVault.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string ReleasePolicyContentType { get => _parametersBody.ReleasePolicyContentType ?? null; set => _parametersBody.ReleasePolicyContentType = value; }

        /// <summary>Blob encoding the policy rules under which the key can be released.</summary>
        internal byte[] ReleasePolicyData { get => _parametersBody.ReleasePolicyData ?? null /* byte array */; set => _parametersBody.ReleasePolicyData = value; }

        /// <summary>
        /// Input File for ReleasePolicyData (Blob encoding the policy rules under which the key can be released.)
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Input File for ReleasePolicyData (Blob encoding the policy rules under which the key can be released.)")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Category(global::Microsoft.Azure.PowerShell.Cmdlets.KeyVault.ParameterCategory.Body)]
        public string ReleasePolicyDataInputFile
        {
         set
         {
         ...
         ReleasePolicyData = global::System.IO.File.ReadAllBytes(paths[0]);
         }
        }
        ...
        [global::System.Management.Automation.AllowEmptyCollection]
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The lifetimeActions for key rotation action.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Category(global::Microsoft.Azure.PowerShell.Cmdlets.KeyVault.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.IManagedHsmLifetimeAction[] RotationPolicyLifetimeAction { get => _parametersBody.RotationPolicyLifetimeAction?.ToArray() ?? null /* fixedArrayOf */; set => _parametersBody.RotationPolicyLifetimeAction = (value != null ? new System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.IManagedHsmLifetimeAction>(value) : null); }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The tags that will be assigned to the key.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Category(global::Microsoft.Azure.PowerShell.Cmdlets.KeyVault.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.IManagedHsmKeyCreateParametersTags Tag { get => _parametersBody.Tag ?? null /* object */; set => _parametersBody.Tag = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.IManagedHsmKey">Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.IManagedHsmKey</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.IManagedHsmKey> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAzKeyVaultManagedHsmKeyIfNotExist_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzKeyVaultManagedHsmKeyIfNotExist_CreateExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ManagedHsmKeysCreateIfNotExist' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ManagedHsmKeysCreateIfNotExist(SubscriptionId, ResourceGroupName, Name, KeyName, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Runtime.SerializationMode.IncludeCreate);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,Name=Name,KeyName=KeyName})
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.IManagedHsmKey> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.IManagedHsmKey
