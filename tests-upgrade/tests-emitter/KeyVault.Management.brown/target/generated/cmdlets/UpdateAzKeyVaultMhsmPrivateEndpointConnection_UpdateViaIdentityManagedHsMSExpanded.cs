...
namespace Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.KeyVault/managedHSMs/{name}/privateEndpointConnections/{privateEndpointConnectionName}"
    /// [OpenAPI] Put=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.KeyVault/managedHSMs/{name}/privateEndpointConnections/{privateEndpointConnectionName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzKeyVaultMhsmPrivateEndpointConnection_UpdateViaIdentityManagedHsMSExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.IMhsmPrivateEndpointConnection))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Description(@"put the specified private endpoint connection associated with the managed hsm pool.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Generated]
    public partial class UpdateAzKeyVaultMhsmPrivateEndpointConnection_UpdateViaIdentityManagedHsMSExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.IMhsmPrivateEndpointConnection _propertiesBody = new Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.MhsmPrivateEndpointConnection();
        ...
        /// <summary>Backing field for <see cref="ManagedHsMSInputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.IKeyVaultIdentity _managedHsMSInputObject;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.IKeyVaultIdentity ManagedHsMSInputObject { get => this._managedHsMSInputObject; set => this._managedHsMSInputObject = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Name of the private endpoint connection associated with the managed hsm pool.")]
        [Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Indicates whether the connection has been approved, rejected or removed by the key vault owner.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Category(global::Microsoft.Azure.PowerShell.Cmdlets.KeyVault.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.IMhsmPrivateEndpointConnectionTags Tag { get => _propertiesBody.Tag ?? null /* object */; set => _propertiesBody.Tag = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.IMhsmPrivateEndpointConnection">Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.IMhsmPrivateEndpointConnection</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.IMhsmPrivateEndpointConnection> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        {
            bool supportsSystemAssignedIdentity = (true == this.EnableSystemAssignedIdentity || null == this.EnableSystemAssignedIdentity && true == _propertiesBody?.IdentityType?.Contains("SystemAssigned"));
            ...
            if (this.UserAssignedIdentity?.Length > 0)
            {
                ...
                {
                    _propertiesBody.IdentityUserAssignedIdentity.Add(id, new Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.UserAssignedIdentity());
                }
            }
            supportsUserAssignedIdentity = true == this.MyInvocation?.BoundParameters?.ContainsKey("UserAssignedIdentity") && this.UserAssignedIdentity?.Length > 0 ||
                    true != this.MyInvocation?.BoundParameters?.ContainsKey("UserAssignedIdentity") && true == _propertiesBody.IdentityType?.Contains("UserAssigned");
            if (!supportsUserAssignedIdentity)
            {
                _propertiesBody.IdentityUserAssignedIdentity = null;
            }
            // calculate IdentityType
            if ((supportsUserAssignedIdentity && supportsSystemAssignedIdentity))
            {
                _propertiesBody.IdentityType = "SystemAssigned,UserAssigned";
            }
            else if ((supportsUserAssignedIdentity && !supportsSystemAssignedIdentity))
            {
                _propertiesBody.IdentityType = "UserAssigned";
            }
            else if ((!supportsUserAssignedIdentity && supportsSystemAssignedIdentity))
            {
                _propertiesBody.IdentityType = "SystemAssigned";
            }
            else
            {
                _propertiesBody.IdentityType = "None";
            }
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'MhsmPrivateEndpointConnectionsPut' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (ManagedHsMSInputObject?.Id != null)
                    {
                        this.ManagedHsMSInputObject.Id += $"/privateEndpointConnections/{(global::System.Uri.EscapeDataString(this.PrivateEndpointConnectionName.ToString()))}";
                        _propertiesBody = await this.Client.MhsmPrivateEndpointConnectionsGetViaIdentityWithResult(ManagedHsMSInputObject.Id, this, Pipeline);
                        this.PreProcessManagedIdentityParametersWithGetResult();
                        this.Update_propertiesBody();
                        await this.Client.MhsmPrivateEndpointConnectionsPutViaIdentity(ManagedHsMSInputObject.Id, _propertiesBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == ManagedHsMSInputObject.SubscriptionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("ManagedHsMSInputObject has null value for ManagedHsMSInputObject.SubscriptionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, ManagedHsMSInputObject) );
                        }
                        if (null == ManagedHsMSInputObject.ResourceGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("ManagedHsMSInputObject has null value for ManagedHsMSInputObject.ResourceGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, ManagedHsMSInputObject) );
                        }
                        if (null == ManagedHsMSInputObject.Name)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("ManagedHsMSInputObject has null value for ManagedHsMSInputObject.Name"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, ManagedHsMSInputObject) );
                        }
                        _propertiesBody = await this.Client.MhsmPrivateEndpointConnectionsGetWithResult(ManagedHsMSInputObject.SubscriptionId ?? null, ManagedHsMSInputObject.ResourceGroupName ?? null, ManagedHsMSInputObject.Name ?? null, PrivateEndpointConnectionName, this, Pipeline);
                        this.PreProcessManagedIdentityParametersWithGetResult();
                        this.Update_propertiesBody();
                        await this.Client.MhsmPrivateEndpointConnectionsPut(ManagedHsMSInputObject.SubscriptionId ?? null, ManagedHsMSInputObject.ResourceGroupName ?? null, ManagedHsMSInputObject.Name ?? null, PrivateEndpointConnectionName, _propertiesBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzKeyVaultMhsmPrivateEndpointConnection_UpdateViaIdentityManagedHsMSExpanded"
        /// /> cmdlet class.
        /// </summary>
        public UpdateAzKeyVaultMhsmPrivateEndpointConnection_UpdateViaIdentityManagedHsMSExpanded()
        {
        ...
        private void Update_propertiesBody()
        {
            ...
            {
                this.Tag = (Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.IMhsmPrivateEndpointConnectionTags)(this.MyInvocation?.BoundParameters["Tag"]);
            }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.IMhsmPrivateEndpointConnection> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.IMhsmPrivateEndpointConnection
