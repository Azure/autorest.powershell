...
namespace Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] CreateIfNotExist=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.KeyVault/vaults/{vaultName}/keys/{keyName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzKeyVaultKeyIfNotExist_CreateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.IKey))]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.KeyVault.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.KeyVault/vaults/{vaultName}/keys/{keyName}", ApiVersion = "2025-05-01")]
    public partial class NewAzKeyVaultKeyIfNotExist_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.IKeyCreateParameters _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.KeyCreateParameters();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the key to be retrieved.")]
        [Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.ILifetimeAction[] RotationPolicyLifetimeAction { get => _parametersBody.RotationPolicyLifetimeAction?.ToArray() ?? null /* fixedArrayOf */; set => _parametersBody.RotationPolicyLifetimeAction = (value != null ? new System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.ILifetimeAction>(value) : null); }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.IKeyCreateParametersTags Tag { get => _parametersBody.Tag ?? null /* object */; set => _parametersBody.Tag = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the vault which contains the key to be retrieved.")]
        [Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.IKey">Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.IKey</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.IKey> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAzKeyVaultKeyIfNotExist_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzKeyVaultKeyIfNotExist_CreateExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'KeysCreateIfNotExist' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.KeysCreateIfNotExist(SubscriptionId, ResourceGroupName, VaultName, KeyName, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Runtime.SerializationMode.IncludeCreate);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,VaultName=VaultName,KeyName=KeyName})
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.IKey> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.IKey
