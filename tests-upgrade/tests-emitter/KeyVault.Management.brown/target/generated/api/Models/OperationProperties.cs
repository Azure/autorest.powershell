...
namespace Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models
{
    ...
    public partial class OperationProperties :
        Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.IOperationProperties,
        Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.IOperationPropertiesInternal
    {

        /// <summary>Internal Acessors for ServiceSpecification</summary>
        Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.IServiceSpecification Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.IOperationPropertiesInternal.ServiceSpecification { get => (this._serviceSpecification = this._serviceSpecification ?? new Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.ServiceSpecification()); set { {_serviceSpecification = value;} } }

        /// <summary>Backing field for <see cref="ServiceSpecification" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.IServiceSpecification _serviceSpecification;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.IServiceSpecification ServiceSpecification { get => (this._serviceSpecification = this._serviceSpecification ?? new Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.ServiceSpecification()); set => this._serviceSpecification = value; }
    ...
    {
        /// <summary>One property of operation, include metric specifications.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.IServiceSpecification ServiceSpecification { get; set; }
        /// <summary>Log specifications of operation.</summary>
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.ILogSpecification> ServiceSpecificationLogSpecification { get; set; }
        /// <summary>Metric specifications of operation.</summary>
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.KeyVault.Models.IMetricSpecification> ServiceSpecificationMetricSpecification { get; set; }
