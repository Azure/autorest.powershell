...
$dll = Join-Path $PSScriptRoot 'bin\Az.CodeSigning.private.dll'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Az.CodeSigning.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.CodeSigning.psd1'
$guid = Get-ModuleGuid -Psd1Path $psd1
$moduleName = 'Az.CodeSigning'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: CodeSigning cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.CodeSigning.format.ps1xml'
...
if (-not $DisableAfterBuildTasks){
  ...
  $afterBuildTasksArgs = ConvertFrom-Json '{"SubModuleName":"Az.CodeSigning","ModuleRootName":"$(root-module-name)"}' -AsHashtable
