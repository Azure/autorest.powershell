...
using Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.Runtime.Json;
using System;
...
namespace Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.Runtime
{
    ...
    internal static class JsonSerializable
    {
        ...
        internal static JsonNode ToJsonValue(object value)
        {
            ...
            if (value is Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.Runtime.IJsonSerializable jsonSerializable)
            {
            ...
            {
                return Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.Runtime.JsonSerializable.ToJson(dictionary, null);
            }
            ...
            if (value is System.Collections.Hashtable hashtable)
            {
                ...
                return Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.Runtime.JsonSerializable.ToJson(dict, null);
            }
