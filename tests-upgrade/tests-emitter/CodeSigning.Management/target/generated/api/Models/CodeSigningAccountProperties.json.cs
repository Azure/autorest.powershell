...
namespace Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.Models
{
    ...
    public partial class CodeSigningAccountProperties
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.Runtime.Json.JsonObject into a new instance of <see cref="CodeSigningAccountProperties" />.
        /// </summary>
        ...
        internal CodeSigningAccountProperties(Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.Runtime.Json.JsonObject json)
        {
            ...
            {_accountUri = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.Runtime.Json.JsonString>("accountUri"), out var __jsonAccountUri) ? (string)__jsonAccountUri : (string)_accountUri;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.Models.ICodeSigningAccountProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.Models.ICodeSigningAccountProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.Models.ICodeSigningAccountProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.Runtime.Json.JsonObject json ? new CodeSigningAccountProperties(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="CodeSigningAccountProperties" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="CodeSigningAccountProperties" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._sku ? (Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.Runtime.Json.JsonNode) this._sku.ToJson(null,serializationMode) : null, "sku" ,container.Add );
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.Runtime.SerializationMode.IncludeRead))
            {
                AddIf( null != (((object)this._accountUri)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.Runtime.Json.JsonString(this._accountUri.ToString()) : null, "accountUri" ,container.Add );
            }
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.Runtime.SerializationMode.IncludeRead))
            {
