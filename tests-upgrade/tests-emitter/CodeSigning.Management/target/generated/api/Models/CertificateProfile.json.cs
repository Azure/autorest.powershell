...
namespace Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.Models
{
    ...
    public partial class CertificateProfile
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.Runtime.Json.JsonObject into a new instance of <see cref="CertificateProfile" />.
        /// </summary>
        ...
        internal CertificateProfile(Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.Runtime.Json.JsonObject json)
        {
            ...
            __proxyResource = new Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.Models.ProxyResource(json);
            {_property = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.Models.CertificateProfileProperties.FromJson(__jsonProperties) : _property;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.Models.ICertificateProfile.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.Models.ICertificateProfile.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.Models.ICertificateProfile FromJson(Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.Runtime.Json.JsonObject json ? new CertificateProfile(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="CertificateProfile" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="CertificateProfile" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.Runtime.Json.JsonNode" />.
        /// </returns>
