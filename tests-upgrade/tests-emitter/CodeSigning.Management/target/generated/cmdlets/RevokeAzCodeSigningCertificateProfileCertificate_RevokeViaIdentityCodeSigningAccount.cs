...
namespace Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsSecurity.Revoke, @"AzCodeSigningCertificateProfileCertificate_RevokeViaIdentityCodeSigningAccount", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.CodeSigning/codeSigningAccounts/{accountName}/certificateProfiles/{profileName}/revokeCertificate", ApiVersion = "2024-02-05-preview")]
    public partial class RevokeAzCodeSigningCertificateProfileCertificate_RevokeViaIdentityCodeSigningAccount : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.Models.IRevokeCertificate _body;
        ...
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.Models.IRevokeCertificate) })]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.Models.IRevokeCertificate Body { get => this._body; set => this._body = value; }
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (CodeSigningAccountInputObject?.Id != null)
                    {
                        ...
                        await this.Client.CertificateProfilesRevokeCertificateViaIdentity(CodeSigningAccountInputObject.Id, Body, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.CertificateProfilesRevokeCertificate(CodeSigningAccountInputObject.SubscriptionId ?? null, CodeSigningAccountInputObject.ResourceGroupName ?? null, CodeSigningAccountInputObject.AccountName ?? null, ProfileName, Body, onNoContent, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RevokeAzCodeSigningCertificateProfileCertificate_RevokeViaIdentityCodeSigningAccount"
        /// /> cmdlet class.
        /// </summary>
        public RevokeAzCodeSigningCertificateProfileCertificate_RevokeViaIdentityCodeSigningAccount()
        {
