            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        await this.Client.VolumeSnapshotsDelete(VolumegroupInputObject.SubscriptionId ?? null, VolumegroupInputObject.ResourceGroupName ?? null, VolumegroupInputObject.ElasticSanName ?? null, VolumegroupInputObject.VolumeGroupName ?? null, SnapshotName, onOk, onNoContent, onDefault, this, Pipeline);
                    }
