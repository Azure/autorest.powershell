...
namespace Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzElasticSanVolumeSnapshot_UpdateViaIdentityVolumegroupExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Models.ISnapshot))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Description(@"update a Volume Snapshot.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Generated]
    public partial class UpdateAzElasticSanVolumeSnapshot_UpdateViaIdentityVolumegroupExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Runtime.IContext
    {
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Fully qualified resource ID of the volume. E.g. \"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ElasticSan/elasticSans/{elasticSanName}/volumegroups/{volumeGroupName}/volumes/{volumeName}\"")]
        ...
        /// <returns>
        /// a duplicate instance of UpdateAzElasticSanVolumeSnapshot_UpdateViaIdentityVolumegroupExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Cmdlets.UpdateAzElasticSanVolumeSnapshot_UpdateViaIdentityVolumegroupExpanded Clone()
        {
            var clone = new UpdateAzElasticSanVolumeSnapshot_UpdateViaIdentityVolumegroupExpanded();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.VolumegroupInputObject.Id += $"/snapshots/{(global::System.Uri.EscapeDataString(this.SnapshotName.ToString()))}";
                        _parametersBody = await this.Client.VolumeSnapshotsGetViaIdentityWithResult(VolumegroupInputObject.Id, this, Pipeline);
                        this.Update_parametersBody();
                        await this.Client.VolumeSnapshotsCreateViaIdentity(VolumegroupInputObject.Id, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _parametersBody = await this.Client.VolumeSnapshotsGetWithResult(VolumegroupInputObject.SubscriptionId ?? null, VolumegroupInputObject.ResourceGroupName ?? null, VolumegroupInputObject.ElasticSanName ?? null, VolumegroupInputObject.VolumeGroupName ?? null, SnapshotName, this, Pipeline);
                        this.Update_parametersBody();
                        await this.Client.VolumeSnapshotsCreate(VolumegroupInputObject.SubscriptionId ?? null, VolumegroupInputObject.ResourceGroupName ?? null, VolumegroupInputObject.ElasticSanName ?? null, VolumegroupInputObject.VolumeGroupName ?? null, SnapshotName, _parametersBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Runtime.SerializationMode.IncludeUpdate);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SnapshotName=SnapshotName})
                    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzElasticSanVolumeSnapshot_UpdateViaIdentityVolumegroupExpanded" />
        /// cmdlet class.
        /// </summary>
        public UpdateAzElasticSanVolumeSnapshot_UpdateViaIdentityVolumegroupExpanded()
        {
        ...
        {
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("CreationDataSourceId")))
            {
                this.CreationDataSourceId = (string)(this.MyInvocation?.BoundParameters["CreationDataSourceId"]);
            }
        }
