            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        await this.Client.VolumeSnapshotsDelete(ElasticSanInputObject.SubscriptionId ?? null, ElasticSanInputObject.ResourceGroupName ?? null, ElasticSanInputObject.ElasticSanName ?? null, VolumeGroupName, SnapshotName, onOk, onNoContent, onDefault, this, Pipeline);
                    }
