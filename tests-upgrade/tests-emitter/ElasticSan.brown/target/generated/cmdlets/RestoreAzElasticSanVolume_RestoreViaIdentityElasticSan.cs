            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        await this.Client.RestoreVolume(ElasticSanInputObject.SubscriptionId ?? null, ElasticSanInputObject.ResourceGroupName ?? null, ElasticSanInputObject.ElasticSanName ?? null, GroupName, Name, onOk, onDefault, this, Pipeline);
                    }
