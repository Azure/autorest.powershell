            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.VolumesListByVolumeGroup(SubscriptionId, ResourceGroupName, ElasticSanName, GroupName, this.InvocationInformation.BoundParameters.ContainsKey("XmsAccessSoftDeletedResource") ? XmsAccessSoftDeletedResource : null, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,ElasticSanName=ElasticSanName,GroupName=GroupName,XmsAccessSoftDeletedResource=this.InvocationInformation.BoundParameters.ContainsKey("XmsAccessSoftDeletedResource") ? XmsAccessSoftDeletedResource : null})
                    {
