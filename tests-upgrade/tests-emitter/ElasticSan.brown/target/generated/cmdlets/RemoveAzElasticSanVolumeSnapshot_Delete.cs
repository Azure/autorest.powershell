        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.VolumeSnapshotsDelete(SubscriptionId, ResourceGroupName, ElasticSanName, VolumeGroupName, SnapshotName, onOk, onNoContent, onDefault, this, Pipeline);
