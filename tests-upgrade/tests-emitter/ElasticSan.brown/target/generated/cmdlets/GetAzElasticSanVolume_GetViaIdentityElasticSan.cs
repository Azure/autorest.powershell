...
namespace Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.ElasticSan.Description(@"Get an Volume.")]
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        await this.Client.VolumesGet(ElasticSanInputObject.SubscriptionId ?? null, ElasticSanInputObject.ResourceGroupName ?? null, ElasticSanInputObject.ElasticSanName ?? null, GroupName, Name, onOk, onDefault, this, Pipeline);
                    }
