    ...
    public class ExportPsd1 : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            try
            {
                ...
                sb.AppendLine($@"{Indent}Description = '{"Microsoft Azure PowerShell: Az.StorageMover cmdlets"}'");
                ...
                sb.AppendLine($@"{Indent}{Indent}{Indent}Tags = {"Azure ResourceManager ARM PSModule Az.StorageMover".Split(' ').ToPsList().NullIfEmpty() ?? "''"}");
