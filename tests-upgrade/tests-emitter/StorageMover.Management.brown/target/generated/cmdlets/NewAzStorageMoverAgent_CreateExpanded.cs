...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageMover/storageMovers/{storageMoverName}/agents/{agentName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzStorageMoverAgent_CreateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.IAgent))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Description(@"create an Agent resource, which references a hybrid compute machine that can run jobs.")]
    ...
    public partial class NewAzStorageMoverAgent_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.IAgent _agentBody = new Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.Agent();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The fully qualified resource ID of the Hybrid Compute resource for the Agent.")]
        ...
        public string ArcResourceId { get => _agentBody.ArcResourceId ?? null; set => _agentBody.ArcResourceId = value; }

        /// <summary>The VM UUID of the Hybrid Compute resource for the Agent.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The VM UUID of the Hybrid Compute resource for the Agent.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Category(global::Microsoft.Azure.PowerShell.Cmdlets.StorageMover.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string ArcVMUuid { get => _agentBody.ArcVMUuid ?? null; set => _agentBody.ArcVMUuid = value; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAzStorageMoverAgent_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzStorageMoverAgent_CreateExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'AgentsCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.AgentsCreateOrUpdate(SubscriptionId, ResourceGroupName, StorageMoverName, Name, _agentBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.SerializationMode.IncludeCreate);
