            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (StorageMoverInputObject?.Id != null)
                    {
                        ...
                        _endpointBody = await this.Client.EndpointsGetViaIdentityWithResult(StorageMoverInputObject.Id, this, Pipeline);
                        this.PreProcessManagedIdentityParametersWithGetResult();
                        this.Update_endpointBody();
                        await this.Client.EndpointsCreateOrUpdateViaIdentity(StorageMoverInputObject.Id, _endpointBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _endpointBody = await this.Client.EndpointsGetWithResult(StorageMoverInputObject.SubscriptionId ?? null, StorageMoverInputObject.ResourceGroupName ?? null, StorageMoverInputObject.StorageMoverName ?? null, Name, this, Pipeline);
                        this.PreProcessManagedIdentityParametersWithGetResult();
                        this.Update_endpointBody();
                        await this.Client.EndpointsCreateOrUpdate(StorageMoverInputObject.SubscriptionId ?? null, StorageMoverInputObject.ResourceGroupName ?? null, StorageMoverInputObject.StorageMoverName ?? null, Name, _endpointBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.SerializationMode.IncludeUpdate);
                    }
