...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models
{
    ...
    public partial class NfsMountEndpointUpdateProperties :
        Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.INfsMountEndpointUpdateProperties,
        Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.INfsMountEndpointUpdatePropertiesInternal,
        Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.IValidates
    {
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Origin(Microsoft.Azure.PowerShell.Cmdlets.StorageMover.PropertyOrigin.Inherited)]
        public string EndpointType { get => "NfsMount"; set => ((Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.IEndpointBaseUpdatePropertiesInternal)__endpointBaseUpdateProperties).EndpointType = "NfsMount"; }

        /// <summary>Creates an new <see cref="NfsMountEndpointUpdateProperties" /> instance.</summary>
        public NfsMountEndpointUpdateProperties()
        {
            this.__endpointBaseUpdateProperties.EndpointType = "NfsMount";
        }
