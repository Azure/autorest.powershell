...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models
{
    ...
    public partial class JobDefinitionProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.IJobDefinitionProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.IJobDefinitionProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.IJobDefinitionProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonNode node)
        {
        ...
        internal JobDefinitionProperties(Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonObject json)
        {
            ...
            {_sourceSubpath = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonString>("sourceSubpath"), out var __jsonSourceSubpath) ? (string)__jsonSourceSubpath : (string)_sourceSubpath;}
            ...
            {_targetSubpath = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonString>("targetSubpath"), out var __jsonTargetSubpath) ? (string)__jsonTargetSubpath : (string)_targetSubpath;}
            {_latestJobRunName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonString>("latestJobRunName"), out var __jsonLatestJobRunName) ? (string)__jsonLatestJobRunName : (string)_latestJobRunName;}
            {_latestJobRunResourceId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonString>("latestJobRunResourceId"), out var __jsonLatestJobRunResourceId) ? (string)__jsonLatestJobRunResourceId : (string)_latestJobRunResourceId;}
            {_latestJobRunStatus = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonString>("latestJobRunStatus"), out var __jsonLatestJobRunStatus) ? (string)__jsonLatestJobRunStatus : (string)_latestJobRunStatus;}
