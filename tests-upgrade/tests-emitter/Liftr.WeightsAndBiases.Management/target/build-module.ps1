...
$dll = Join-Path $PSScriptRoot 'bin\Az.WeightsBiases.private.dll'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Az.WeightsBiases.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.WeightsBiases.psd1'
$guid = Get-ModuleGuid -Psd1Path $psd1
$moduleName = 'Az.WeightsBiases'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: WeightsBiases cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.WeightsBiases.format.ps1xml'
...
if (-not $DisableAfterBuildTasks){
  ...
  $afterBuildTasksArgs = ConvertFrom-Json '{"SubModuleName":"Az.WeightsBiases","ModuleRootName":"$(root-module-name)"}' -AsHashtable
