...
namespace Microsoft.Azure.PowerShell.Cmdlets.WeightsBiases.Models
{
    ...
    public partial class InstanceResourceUpdateTags
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.WeightsBiases.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.WeightsBiases.Models.IInstanceResourceUpdateTags.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.WeightsBiases.Models.IInstanceResourceUpdateTags.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.WeightsBiases.Models.IInstanceResourceUpdateTags FromJson(Microsoft.Azure.PowerShell.Cmdlets.WeightsBiases.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.WeightsBiases.Runtime.Json.JsonObject json ? new InstanceResourceUpdateTags(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.WeightsBiases.Runtime.Json.JsonObject into a new instance of <see cref="InstanceResourceUpdateTags" />.
        /// </summary>
        ...
        internal InstanceResourceUpdateTags(Microsoft.Azure.PowerShell.Cmdlets.WeightsBiases.Runtime.Json.JsonObject json, global::System.Collections.Generic.HashSet<string> exclusions = null)
        {
            ...
            Microsoft.Azure.PowerShell.Cmdlets.WeightsBiases.Runtime.JsonSerializable.FromJson( json, ((Microsoft.Azure.PowerShell.Cmdlets.WeightsBiases.Runtime.IAssociativeArray<string>)this).AdditionalProperties, null ,exclusions );
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="InstanceResourceUpdateTags" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.WeightsBiases.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="InstanceResourceUpdateTags" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.WeightsBiases.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.WeightsBiases.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.WeightsBiases.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.WeightsBiases.Runtime.SerializationMode serializationMode)
        {
            ...
            Microsoft.Azure.PowerShell.Cmdlets.WeightsBiases.Runtime.JsonSerializable.ToJson( ((Microsoft.Azure.PowerShell.Cmdlets.WeightsBiases.Runtime.IAssociativeArray<string>)this).AdditionalProperties, container);
