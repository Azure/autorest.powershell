...
$dll = Join-Path $PSScriptRoot 'bin\Az.ContainerServiceFleet.private.dll'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Az.ContainerServiceFleet.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.ContainerServiceFleet.psd1'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: ContainerServiceFleet cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.ContainerServiceFleet.format.ps1xml'
...
if (-not $DisableAfterBuildTasks){
  ...
  $afterBuildTasksArgs = ConvertFrom-Json '{"SubModuleName":"Az.ContainerServiceFleet","ModuleRootName":"$(root-module-name)"}' -AsHashtable
