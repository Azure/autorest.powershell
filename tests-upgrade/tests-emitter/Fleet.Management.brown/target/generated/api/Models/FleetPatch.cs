...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models
{
    ...
    public partial class FleetPatch :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.IFleetPatch,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.IFleetPatchInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.IManagedServiceIdentity Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.IFleetPatchInternal.Identity { get => (this._identity = this._identity ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.ManagedServiceIdentity()); set { {_identity = value;} } }

        /// <summary>Internal Acessors for IdentityPrincipalId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.IFleetPatchInternal.IdentityPrincipalId { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.IManagedServiceIdentityInternal)Identity).PrincipalId; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.IManagedServiceIdentityInternal)Identity).PrincipalId = value ?? null; }

        /// <summary>Internal Acessors for IdentityTenantId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.IFleetPatchInternal.IdentityTenantId { get => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.IManagedServiceIdentityInternal)Identity).TenantId; set => ((Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.IManagedServiceIdentityInternal)Identity).TenantId = value ?? null; }

        /// <summary>Backing field for <see cref="Tag" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.IFleetPatchTags _tag;

        /// <summary>Resource tags.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.IFleetPatchTags Tag { get => (this._tag = this._tag ?? new Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.FleetPatchTags()); set => this._tag = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Runtime.IJsonSerializable
    {
        ...
        SerializedName = @"tags",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.IFleetPatchTags) })]
        Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.IFleetPatchTags Tag { get; set; }
