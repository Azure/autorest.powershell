...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models
{
    ...
    public partial class FleetCredentialResult :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.IFleetCredentialResult,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.IFleetCredentialResultInternal
    {

        /// <summary>Internal Acessors for Name</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.IFleetCredentialResultInternal.Name { get => this._name; set { {_name = value;} } }

        /// <summary>Internal Acessors for Value</summary>
        byte[] Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.IFleetCredentialResultInternal.Value { get => this._value; set { {_value = value;} } }
