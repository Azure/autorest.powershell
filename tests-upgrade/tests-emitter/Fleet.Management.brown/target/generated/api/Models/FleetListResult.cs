...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models
{
    ...
    public partial class FleetListResult :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.IFleetListResult,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.IFleetListResultInternal
    {
        ...
        private System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.IFleet> _value;

        /// <summary>The Fleet items on this page</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Origin(Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.IFleet> Value { get => this._value; set => this._value = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.IFleet) })]
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.IFleet> Value { get; set; }
