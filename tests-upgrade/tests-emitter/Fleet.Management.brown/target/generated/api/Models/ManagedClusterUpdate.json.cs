...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models
{
    ...
    public partial class ManagedClusterUpdate
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.IManagedClusterUpdate.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.IManagedClusterUpdate.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.IManagedClusterUpdate FromJson(Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Runtime.Json.JsonNode node)
        {
        ...
        internal ManagedClusterUpdate(Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Runtime.Json.JsonObject json)
        {
            ...
            {_upgrade = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Runtime.Json.JsonObject>("upgrade"), out var __jsonUpgrade) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.ManagedClusterUpgradeSpec.FromJson(__jsonUpgrade) : _upgrade;}
            {_nodeImageSelection = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Runtime.Json.JsonObject>("nodeImageSelection"), out var __jsonNodeImageSelection) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.Models.NodeImageSelection.FromJson(__jsonNodeImageSelection) : _nodeImageSelection;}
            AfterFromJson(json);
        }
