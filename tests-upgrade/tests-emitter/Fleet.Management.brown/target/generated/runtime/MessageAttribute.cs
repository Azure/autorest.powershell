...
{
    using Microsoft.Azure.PowerShell.Cmdlets.ContainerServiceFleet.generated.runtime.Properties;
    using System;
    ...
    public class GenericBreakingChangeAttribute : Attribute
    {
        ...
        public string moduleName { get; set; } = String.IsNullOrEmpty(@"") ? @"Az.ContainerServiceFleet" : @"";
