...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: Az.StorageMover cmdlets'
...
if (-not $DisableAfterBuildTasks){
  ...
  $afterBuildTasksArgs = ConvertFrom-Json '{"SubModuleName":"Az.StorageMover","ModuleRootName":"$(root-module-name)"}' -AsHashtable
