        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    _endpointBody = await this.Client.EndpointsGetWithResult(SubscriptionId, ResourceGroupName, StorageMoverName, Name, this, Pipeline);
                    this.PreProcessManagedIdentityParametersWithGetResult();
                    this.Update_endpointBody();
                    await this.Client.EndpointsCreateOrUpdate(SubscriptionId, ResourceGroupName, StorageMoverName, Name, _endpointBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.SerializationMode.IncludeUpdate);
