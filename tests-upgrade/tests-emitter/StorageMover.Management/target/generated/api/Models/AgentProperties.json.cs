...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models
{
    ...
    public partial class AgentProperties
    {
        ...
        internal AgentProperties(Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonObject json)
        {
            ...
            {_errorDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonObject>("errorDetails"), out var __jsonErrorDetails) ? Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.AgentPropertiesErrorDetails.FromJson(__jsonErrorDetails) : _errorDetail;}
            ...
            {_agentVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonString>("agentVersion"), out var __jsonAgentVersion) ? (string)__jsonAgentVersion : (string)_agentVersion;}
            {_arcResourceId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonString>("arcResourceId"), out var __jsonArcResourceId) ? (string)__jsonArcResourceId : (string)_arcResourceId;}
            {_arcVMUuid = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonString>("arcVmUuid"), out var __jsonArcVMUuid) ? (string)__jsonArcVMUuid : (string)_arcVMUuid;}
            {_agentStatus = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonString>("agentStatus"), out var __jsonAgentStatus) ? (string)__jsonAgentStatus : (string)_agentStatus;}
            ...
            {_localIPAddress = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonString>("localIPAddress"), out var __jsonLocalIPAddress) ? (string)__jsonLocalIPAddress : (string)_localIPAddress;}
            {_memoryInMb = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonNumber>("memoryInMB"), out var __jsonMemoryInMb) ? (long?)__jsonMemoryInMb : _memoryInMb;}
            {_numberOfCore = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonNumber>("numberOfCores"), out var __jsonNumberOfCores) ? (long?)__jsonNumberOfCores : _numberOfCore;}
            {_uptimeInSecond = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonNumber>("uptimeInSeconds"), out var __jsonUptimeInSeconds) ? (long?)__jsonUptimeInSeconds : _uptimeInSecond;}
            {_timeZone = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonString>("timeZone"), out var __jsonTimeZone) ? (string)__jsonTimeZone : (string)_timeZone;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.IAgentProperties.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.IAgentProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Models.IAgentProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.StorageMover.Runtime.Json.JsonNode node)
        {
