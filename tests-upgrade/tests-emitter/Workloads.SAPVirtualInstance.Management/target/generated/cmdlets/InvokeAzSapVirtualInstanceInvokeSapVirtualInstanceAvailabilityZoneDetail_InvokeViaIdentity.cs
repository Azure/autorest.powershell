...
namespace Microsoft.Azure.PowerShell.Cmdlets.SAPVirtualInstance.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] InvokeAvailabilityZoneDetails=>POST:"/subscriptions/{subscriptionId}/providers/Microsoft.Workloads/locations/{location}/sapVirtualInstanceMetadata/default/getAvailabilityZoneDetails"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzSapVirtualInstanceInvokeSapVirtualInstanceAvailabilityZoneDetail_InvokeViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.SAPVirtualInstance.Models.ISapAvailabilityZoneDetailsResult))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.SAPVirtualInstance.Description(@"Get the recommended SAP Availability Zone Pair Details for your region.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.SAPVirtualInstance.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.SAPVirtualInstance.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Microsoft.Workloads/locations/{location}/sapVirtualInstanceMetadata/default/getAvailabilityZoneDetails", ApiVersion = "2024-09-01")]
    public partial class InvokeAzSapVirtualInstanceInvokeSapVirtualInstanceAvailabilityZoneDetail_InvokeViaIdentity : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SAPVirtualInstance.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.SAPVirtualInstance.Models.ISapAvailabilityZoneDetailsRequest _body;

        /// <summary>The SAP request to get list of availability zones.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The SAP request to get list of availability zones.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.SAPVirtualInstance.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"The SAP request to get list of availability zones.",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.SAPVirtualInstance.Models.ISapAvailabilityZoneDetailsRequest) })]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.SAPVirtualInstance.Models.ISapAvailabilityZoneDetailsRequest Body { get => this._body; set => this._body = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.SAPVirtualInstance.Models.ISapAvailabilityZoneDetailsResult">Microsoft.Azure.PowerShell.Cmdlets.SAPVirtualInstance.Models.ISapAvailabilityZoneDetailsResult</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.SAPVirtualInstance.Models.ISapAvailabilityZoneDetailsResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InvokeAzSapVirtualInstanceInvokeSapVirtualInstanceAvailabilityZoneDetail_InvokeViaIdentity"
        /// /> cmdlet class.
        /// </summary>
        public InvokeAzSapVirtualInstanceInvokeSapVirtualInstanceAvailabilityZoneDetail_InvokeViaIdentity()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'SapVirtualInstancesInvokeAvailabilityZoneDetails' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.SapVirtualInstancesInvokeAvailabilityZoneDetailsViaIdentity(InputObject.Id, Body, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.SapVirtualInstancesInvokeAvailabilityZoneDetails(InputObject.SubscriptionId ?? null, InputObject.Location ?? null, Body, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.SAPVirtualInstance.Models.ISapAvailabilityZoneDetailsResult> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.SAPVirtualInstance.Models.ISapAvailabilityZoneDetailsResult
                var result = (await response);
                // response should be returning an array of some kind. +Pageable
                // nested-array / availabilityZonePairs / <none>
                if (null != result.AvailabilityZonePair)
                {
                    if (0 == _responseSize && 1 == result.AvailabilityZonePair.Count)
                    {
                        _firstResponse = result.AvailabilityZonePair[0];
                        _responseSize = 1;
                    }
                    else
                    {
                        ...
                        foreach( var value in result.AvailabilityZonePair )
                        {
