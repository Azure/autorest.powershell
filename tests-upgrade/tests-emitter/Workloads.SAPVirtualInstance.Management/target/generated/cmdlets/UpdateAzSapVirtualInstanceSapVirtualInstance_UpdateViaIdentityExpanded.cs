...
namespace Microsoft.Azure.PowerShell.Cmdlets.SAPVirtualInstance.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzSapVirtualInstanceSapVirtualInstance_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.SAPVirtualInstance.Models.ISapVirtualInstance))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.SAPVirtualInstance.Description(@"update a Virtual Instance for SAP solutions (VIS) resource")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.SAPVirtualInstance.Generated]
    public partial class UpdateAzSapVirtualInstanceSapVirtualInstance_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SAPVirtualInstance.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.SAPVirtualInstance.Models.ISapVirtualInstance _resourceBody = new Microsoft.Azure.PowerShell.Cmdlets.SAPVirtualInstance.Models.SapVirtualInstance();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The configuration type. Eg: Deployment/Discovery")]
        ...
        public string ConfigurationType { get => _resourceBody.ConfigurationType ?? null; set => _resourceBody.ConfigurationType = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.SAPVirtualInstance.Models.ISapVirtualInstance">Microsoft.Azure.PowerShell.Cmdlets.SAPVirtualInstance.Models.ISapVirtualInstance</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.SAPVirtualInstance.Models.ISapVirtualInstance> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>
        /// a duplicate instance of UpdateAzSapVirtualInstanceSapVirtualInstance_UpdateViaIdentityExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.SAPVirtualInstance.Cmdlets.UpdateAzSapVirtualInstanceSapVirtualInstance_UpdateViaIdentityExpanded Clone()
        {
            var clone = new UpdateAzSapVirtualInstanceSapVirtualInstance_UpdateViaIdentityExpanded();
        ...
        private void PreProcessManagedIdentityParametersWithGetResult()
        {
            ...
            if (this.UserAssignedIdentity?.Length > 0)
            {
                ...
                {
                    _resourceBody.IdentityUserAssignedIdentity.Add(id, new Microsoft.Azure.PowerShell.Cmdlets.SAPVirtualInstance.Models.UserAssignedIdentity());
                }
            }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        _resourceBody = await this.Client.SapVirtualInstancesGetViaIdentityWithResult(InputObject.Id, this, Pipeline);
                        this.PreProcessManagedIdentityParametersWithGetResult();
                        this.Update_resourceBody();
                        await this.Client.SapVirtualInstancesCreateViaIdentity(InputObject.Id, _resourceBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.SAPVirtualInstance.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.SAPVirtualInstance.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _resourceBody = await this.Client.SapVirtualInstancesGetWithResult(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.SapVirtualInstanceName ?? null, this, Pipeline);
                        this.PreProcessManagedIdentityParametersWithGetResult();
                        this.Update_resourceBody();
                        await this.Client.SapVirtualInstancesCreate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.SapVirtualInstanceName ?? null, _resourceBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.SAPVirtualInstance.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.SAPVirtualInstance.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzSapVirtualInstanceSapVirtualInstance_UpdateViaIdentityExpanded" />
        /// cmdlet class.
        /// </summary>
        public UpdateAzSapVirtualInstanceSapVirtualInstance_UpdateViaIdentityExpanded()
        {
        ...
        private void Update_resourceBody()
        {
            ...
            {
                this.Tag = (Microsoft.Azure.PowerShell.Cmdlets.SAPVirtualInstance.Models.ITrackedResourceTags)(this.MyInvocation?.BoundParameters["Tag"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("ManagedResourcesNetworkAccessType")))
            {
                this.ManagedResourcesNetworkAccessType = (string)(this.MyInvocation?.BoundParameters["ManagedResourcesNetworkAccessType"]);
            }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.SAPVirtualInstance.Models.ISapVirtualInstance> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.SAPVirtualInstance.Models.ISapVirtualInstance
