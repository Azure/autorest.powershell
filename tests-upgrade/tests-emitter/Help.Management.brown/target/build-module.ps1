...
$dll = Join-Path $PSScriptRoot 'bin\Az.Help.private.dll'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Az.Help.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.Help.psd1'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: Help cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.Help.format.ps1xml'
...
if (-not $DisableAfterBuildTasks){
  ...
  $afterBuildTasksArgs = ConvertFrom-Json '{"SubModuleName":"Az.Help","ModuleRootName":"$(root-module-name)"}' -AsHashtable
