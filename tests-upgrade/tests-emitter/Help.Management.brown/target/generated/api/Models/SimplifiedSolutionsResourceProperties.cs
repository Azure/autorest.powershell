...
namespace Microsoft.Azure.PowerShell.Cmdlets.Help.Models
{
    ...
    public partial class SimplifiedSolutionsResourceProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Help.Models.ISimplifiedSolutionsResourceProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Help.Models.ISimplifiedSolutionsResourcePropertiesInternal
    {

        /// <summary>Backing field for <see cref="Appendix" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Help.Models.ISimplifiedSolutionsResourcePropertiesAppendix _appendix;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Help.Models.ISimplifiedSolutionsResourcePropertiesAppendix Appendix { get => (this._appendix = this._appendix ?? new Microsoft.Azure.PowerShell.Cmdlets.Help.Models.SimplifiedSolutionsResourcePropertiesAppendix()); }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Help.Models.ISimplifiedSolutionsResourcePropertiesAppendix Microsoft.Azure.PowerShell.Cmdlets.Help.Models.ISimplifiedSolutionsResourcePropertiesInternal.Appendix { get => (this._appendix = this._appendix ?? new Microsoft.Azure.PowerShell.Cmdlets.Help.Models.SimplifiedSolutionsResourcePropertiesAppendix()); set { {_appendix = value;} } }

        /// <summary>Internal Acessors for Content</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Help.Models.ISimplifiedSolutionsResourcePropertiesInternal.Content { get => this._content; set { {_content = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Help.Models.ISimplifiedSolutionsResourcePropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for Title</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Help.Models.ISimplifiedSolutionsResourcePropertiesInternal.Title { get => this._title; set { {_title = value;} } }

        /// <summary>Backing field for <see cref="Parameter" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Help.Models.ISimplifiedSolutionsResourcePropertiesParameters _parameter;

        /// <summary>Client input parameters to run Simplified Solutions</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Help.Origin(Microsoft.Azure.PowerShell.Cmdlets.Help.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Help.Models.ISimplifiedSolutionsResourcePropertiesParameters Parameter { get => (this._parameter = this._parameter ?? new Microsoft.Azure.PowerShell.Cmdlets.Help.Models.SimplifiedSolutionsResourcePropertiesParameters()); set => this._parameter = value; }
