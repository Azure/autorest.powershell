...
namespace Microsoft.Azure.PowerShell.Cmdlets.Help.Models
{
    ...
    public partial class DiagnosticResourceProperties :
        Microsoft.Azure.PowerShell.Cmdlets.Help.Models.IDiagnosticResourceProperties,
        Microsoft.Azure.PowerShell.Cmdlets.Help.Models.IDiagnosticResourcePropertiesInternal
    {
        ...
        private System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Help.Models.IDiagnostic> _diagnostic;

        /// <summary>Array of Diagnostics.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Help.Origin(Microsoft.Azure.PowerShell.Cmdlets.Help.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Help.Models.IDiagnostic> Diagnostic { get => this._diagnostic; }

        /// <summary>Backing field for <see cref="GlobalParameter" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Help.Models.IDiagnosticResourcePropertiesGlobalParameters _globalParameter;
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Help.Origin(Microsoft.Azure.PowerShell.Cmdlets.Help.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Help.Models.IDiagnosticResourcePropertiesGlobalParameters GlobalParameter { get => (this._globalParameter = this._globalParameter ?? new Microsoft.Azure.PowerShell.Cmdlets.Help.Models.DiagnosticResourcePropertiesGlobalParameters()); set => this._globalParameter = value; }

        /// <summary>Backing field for <see cref="Insight" /> property.</summary>
        private System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Help.Models.IDiagnosticInvocation> _insight;

        /// <summary>SolutionIds that are needed to be invoked.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Help.Origin(Microsoft.Azure.PowerShell.Cmdlets.Help.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Help.Models.IDiagnosticInvocation> Insight { get => this._insight; set => this._insight = value; }

        /// <summary>Internal Acessors for AcceptedAt</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Help.Models.IDiagnosticResourcePropertiesInternal.AcceptedAt { get => this._acceptedAt; set { {_acceptedAt = value;} } }

        /// <summary>Internal Acessors for Diagnostic</summary>
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Help.Models.IDiagnostic> Microsoft.Azure.PowerShell.Cmdlets.Help.Models.IDiagnosticResourcePropertiesInternal.Diagnostic { get => this._diagnostic; set { {_diagnostic = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Help.Models.IDiagnosticResourcePropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }
