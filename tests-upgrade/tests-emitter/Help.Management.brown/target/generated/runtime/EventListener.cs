...
namespace Microsoft.Azure.PowerShell.Cmdlets.Help.Runtime
{
    ...
    {
        Task Validate(Microsoft.Azure.PowerShell.Cmdlets.Help.Runtime.IEventListener listener);
    }
    ...
    internal static partial class Extensions
    {
        ...
        public static async Task AssertNotNull(this IEventListener instance, string parameterName, object value)
        {
            if (value == null)
            {
                await instance.Signal(Microsoft.Azure.PowerShell.Cmdlets.Help.Runtime.Events.ValidationWarning, instance.Token, () => new EventData { Id = Microsoft.Azure.PowerShell.Cmdlets.Help.Runtime.Events.ValidationWarning, Message = $"'{parameterName}' should not be null", Parameter = parameterName, Cancel = instance.Cancel });
            }
        }
        public static async Task AssertMinimumLength(this IEventListener instance, string parameterName, string value, int length)
        {
            ...
            {
                await instance.Signal(Microsoft.Azure.PowerShell.Cmdlets.Help.Runtime.Events.ValidationWarning, instance.Token, () => new EventData { Id = Microsoft.Azure.PowerShell.Cmdlets.Help.Runtime.Events.ValidationWarning, Message = $"Length of '{parameterName}' is less than {length}", Parameter = parameterName, Cancel = instance.Cancel });
            }
        }
        public static async Task AssertMaximumLength(this IEventListener instance, string parameterName, string value, int length)
        {
            if (value != null && value.Length > length)
            {
                await instance.Signal(Microsoft.Azure.PowerShell.Cmdlets.Help.Runtime.Events.ValidationWarning, instance.Token, () => new EventData { Id = Microsoft.Azure.PowerShell.Cmdlets.Help.Runtime.Events.ValidationWarning, Message = $"Length of '{parameterName}' is greater than {length}", Parameter = parameterName, Cancel = instance.Cancel });
            }
        }
        ...
        {
            await (inst as Microsoft.Azure.PowerShell.Cmdlets.Help.Runtime.IValidates)?.Validate(instance);
        }
