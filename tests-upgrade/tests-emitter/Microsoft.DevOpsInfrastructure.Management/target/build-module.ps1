...
$dll = Join-Path $PSScriptRoot 'bin\Az.DevOpsInfrastructure.private.dll'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Az.DevOpsInfrastructure.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.DevOpsInfrastructure.psd1'
$guid = Get-ModuleGuid -Psd1Path $psd1
$moduleName = 'Az.DevOpsInfrastructure'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: DevOpsInfrastructure cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.DevOpsInfrastructure.format.ps1xml'
...
if (-not $DisableAfterBuildTasks){
  ...
  $afterBuildTasksArgs = ConvertFrom-Json '{"SubModuleName":"Az.DevOpsInfrastructure","ModuleRootName":"$(root-module-name)"}' -AsHashtable
