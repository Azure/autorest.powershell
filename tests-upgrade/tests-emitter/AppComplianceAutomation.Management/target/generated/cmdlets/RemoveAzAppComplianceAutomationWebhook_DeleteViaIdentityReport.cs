            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (ReportInputObject?.Id != null)
                    {
                        ...
                        await this.Client.WebhookDeleteViaIdentity(ReportInputObject.Id, onOk, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.WebhookDelete(ReportInputObject.ReportName ?? null, Name, onOk, onNoContent, onDefault, this, Pipeline);
                    }
