        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.SnapshotDownloadViaIdentity(InputObject.Id, Body, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.SnapshotDownload(InputObject.ReportName ?? null, InputObject.SnapshotName ?? null, Body, onOk, onDefault, this, Pipeline);
                    }
