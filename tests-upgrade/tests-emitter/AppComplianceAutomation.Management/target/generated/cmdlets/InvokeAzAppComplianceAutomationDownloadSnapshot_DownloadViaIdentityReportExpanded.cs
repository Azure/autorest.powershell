            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (ReportInputObject?.Id != null)
                    {
                        ...
                        await this.Client.SnapshotDownloadViaIdentity(ReportInputObject.Id, _body, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.SnapshotDownload(ReportInputObject.ReportName ?? null, SnapshotName, _body, onOk, onDefault, this, Pipeline);
                    }
