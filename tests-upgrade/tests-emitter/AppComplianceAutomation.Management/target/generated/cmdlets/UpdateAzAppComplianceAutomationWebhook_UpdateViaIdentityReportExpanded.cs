            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (ReportInputObject?.Id != null)
                    {
                        ...
                        await this.Client.WebhookUpdateViaIdentity(ReportInputObject.Id, _propertiesBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.AppComplianceAutomation.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        await this.Client.WebhookUpdate(ReportInputObject.ReportName ?? null, Name, _propertiesBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.AppComplianceAutomation.Runtime.SerializationMode.IncludeUpdate);
                    }
