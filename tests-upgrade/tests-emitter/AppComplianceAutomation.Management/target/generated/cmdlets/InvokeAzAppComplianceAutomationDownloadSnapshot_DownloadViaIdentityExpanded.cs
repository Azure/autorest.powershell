        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.SnapshotDownloadViaIdentity(InputObject.Id, _body, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.SnapshotDownload(InputObject.ReportName ?? null, InputObject.SnapshotName ?? null, _body, onOk, onDefault, this, Pipeline);
                    }
