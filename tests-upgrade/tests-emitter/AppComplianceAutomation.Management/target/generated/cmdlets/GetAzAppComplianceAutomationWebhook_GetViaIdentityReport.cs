...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppComplianceAutomation.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzAppComplianceAutomationWebhook_GetViaIdentityReport")]
    ...
    public partial class GetAzAppComplianceAutomationWebhook_GetViaIdentityReport : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.AppComplianceAutomation.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzAppComplianceAutomationWebhook_GetViaIdentityReport" /> cmdlet class.
        /// </summary>
        public GetAzAppComplianceAutomationWebhook_GetViaIdentityReport()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (ReportInputObject?.Id != null)
                    {
                        ...
                        await this.Client.WebhookGetViaIdentity(ReportInputObject.Id, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.WebhookGet(ReportInputObject.ReportName ?? null, Name, onOk, onDefault, this, Pipeline);
                    }
