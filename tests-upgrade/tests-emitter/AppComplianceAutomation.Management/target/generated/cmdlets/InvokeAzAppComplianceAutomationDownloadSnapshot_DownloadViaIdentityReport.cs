            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (ReportInputObject?.Id != null)
                    {
                        ...
                        await this.Client.SnapshotDownloadViaIdentity(ReportInputObject.Id, Body, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.SnapshotDownload(ReportInputObject.ReportName ?? null, SnapshotName, Body, onOk, onDefault, this, Pipeline);
                    }
