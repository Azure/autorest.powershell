...
online version: https://learn.microsoft.com/powershell/module/az.appcomplianceautomation/get-azappcomplianceautomationreportscopingquestion
schema: 2.0.0
---

# Get-AzAppComplianceAutomationReportScopingQuestion
...
### Get (Default)
```
Get-AzAppComplianceAutomationReportScopingQuestion -ReportName <String> [-DefaultProfile <PSObject>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzAppComplianceAutomationReportScopingQuestion -InputObject <IAppComplianceAutomationIdentity>
