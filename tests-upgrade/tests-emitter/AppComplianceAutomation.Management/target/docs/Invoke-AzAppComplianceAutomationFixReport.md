...
online version: https://learn.microsoft.com/powershell/module/az.appcomplianceautomation/invoke-azappcomplianceautomationfixreport
schema: 2.0.0
---

# Invoke-AzAppComplianceAutomationFixReport
...
### Fix (Default)
```
Invoke-AzAppComplianceAutomationFixReport -ReportName <String> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### FixViaIdentity
```
Invoke-AzAppComplianceAutomationFixReport -InputObject <IAppComplianceAutomationIdentity>
