...
$dll = Join-Path $PSScriptRoot 'bin\Az.AzureLargeInstance.private.dll'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Az.AzureLargeInstance.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.AzureLargeInstance.psd1'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: AzureLargeInstance cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.AzureLargeInstance.format.ps1xml'
...
if (-not $DisableAfterBuildTasks){
  ...
  $afterBuildTasksArgs = ConvertFrom-Json '{"SubModuleName":"Az.AzureLargeInstance","ModuleRootName":"$(root-module-name)"}' -AsHashtable
