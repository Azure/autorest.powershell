...
namespace Microsoft.Azure.PowerShell.Cmdlets.AzureLargeInstance.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Stop, @"AzAzureLargeInstanceAzureLargeInstance_ShutdownViaIdentity", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.AzureLargeInstance.Description(@"The operation to shutdown an Azure Large Instance (only for compute instances)")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.AzureLargeInstance.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.AzureLargeInstance.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureLargeInstance/azureLargeInstances/{azureLargeInstanceName}/shutdown", ApiVersion = "2024-08-01-preview")]
    public partial class StopAzAzureLargeInstanceAzureLargeInstance_ShutdownViaIdentity : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.AzureLargeInstance.Runtime.IContext
    {
        ...
        /// <returns>
        /// a duplicate instance of StopAzAzureLargeInstanceAzureLargeInstance_ShutdownViaIdentity
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.AzureLargeInstance.Cmdlets.StopAzAzureLargeInstanceAzureLargeInstance_ShutdownViaIdentity Clone()
        {
            var clone = new StopAzAzureLargeInstanceAzureLargeInstance_ShutdownViaIdentity();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'AzureLargeInstancesShutdown' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.AzureLargeInstancesShutdownViaIdentity(InputObject.Id, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.AzureLargeInstancesShutdown(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.AzureLargeInstanceName ?? null, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StopAzAzureLargeInstanceAzureLargeInstance_ShutdownViaIdentity" /> cmdlet
        /// class.
        /// </summary>
        public StopAzAzureLargeInstanceAzureLargeInstance_ShutdownViaIdentity()
        {
