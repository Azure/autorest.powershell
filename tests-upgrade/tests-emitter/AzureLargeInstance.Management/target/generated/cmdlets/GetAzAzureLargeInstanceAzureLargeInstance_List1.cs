...
namespace Microsoft.Azure.PowerShell.Cmdlets.AzureLargeInstance.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzAzureLargeInstanceAzureLargeInstance_List1")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.AzureLargeInstance.Description(@"Gets a list of Azure Large Instances in the specified subscription. The\noperations returns various properties of each Azure Large Instance.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.AzureLargeInstance.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.AzureLargeInstance.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Microsoft.AzureLargeInstance/azureLargeInstances", ApiVersion = "2024-08-01-preview")]
    public partial class GetAzAzureLargeInstanceAzureLargeInstance_List1 : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.AzureLargeInstance.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzAzureLargeInstanceAzureLargeInstance_List1" /> cmdlet class.
        /// </summary>
        public GetAzAzureLargeInstanceAzureLargeInstance_List1()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.AzureLargeInstancesListBySubscription(SubscriptionId, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.AzureLargeInstancesListBySubscription_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
