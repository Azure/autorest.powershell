...
namespace Microsoft.Azure.PowerShell.Cmdlets.AzureLargeInstance.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzAzureLargeInstanceAzureLargeStorageInstance_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.AzureLargeInstance.Description(@"update an Azure Large Storage Instance for the specified subscription,\nresource group, and instance name.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.AzureLargeInstance.Generated]
    public partial class UpdateAzAzureLargeInstanceAzureLargeStorageInstance_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.AzureLargeInstance.Runtime.IContext
    {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        _resourceBody = await this.Client.AzureLargeStorageInstanceGetViaIdentityWithResult(InputObject.Id, this, Pipeline);
                        this.PreProcessManagedIdentityParametersWithGetResult();
                        this.Update_resourceBody();
                        await this.Client.AzureLargeStorageInstanceCreateViaIdentity(InputObject.Id, _resourceBody, onOk, onCreated, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.AzureLargeInstance.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.AzureLargeInstance.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _resourceBody = await this.Client.AzureLargeStorageInstanceGetWithResult(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.AzureLargeStorageInstanceName ?? null, this, Pipeline);
                        this.PreProcessManagedIdentityParametersWithGetResult();
                        this.Update_resourceBody();
                        await this.Client.AzureLargeStorageInstanceCreate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.AzureLargeStorageInstanceName ?? null, _resourceBody, onOk, onCreated, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.AzureLargeInstance.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.AzureLargeInstance.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzAzureLargeInstanceAzureLargeStorageInstance_UpdateViaIdentityExpanded"
        /// /> cmdlet class.
        /// </summary>
        public UpdateAzAzureLargeInstanceAzureLargeStorageInstance_UpdateViaIdentityExpanded()
        {
        ...
        private void Update_resourceBody()
        {
            ...
            {
                this.Tag = (Microsoft.Azure.PowerShell.Cmdlets.AzureLargeInstance.Models.ITrackedResourceTags)(this.MyInvocation?.BoundParameters["Tag"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("AzureLargeStorageInstanceUniqueIdentifier")))
            {
                this.AzureLargeStorageInstanceUniqueIdentifier = (string)(this.MyInvocation?.BoundParameters["AzureLargeStorageInstanceUniqueIdentifier"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("StoragePropertyProvisioningState")))
            {
                this.StoragePropertyProvisioningState = (string)(this.MyInvocation?.BoundParameters["StoragePropertyProvisioningState"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("StoragePropertyOfferingType")))
            {
                this.StoragePropertyOfferingType = (string)(this.MyInvocation?.BoundParameters["StoragePropertyOfferingType"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("StoragePropertyStorageType")))
            {
                this.StoragePropertyStorageType = (string)(this.MyInvocation?.BoundParameters["StoragePropertyStorageType"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("StoragePropertyGeneration")))
            {
                this.StoragePropertyGeneration = (string)(this.MyInvocation?.BoundParameters["StoragePropertyGeneration"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("StoragePropertyHardwareType")))
            {
                this.StoragePropertyHardwareType = (string)(this.MyInvocation?.BoundParameters["StoragePropertyHardwareType"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("StoragePropertyWorkloadType")))
            {
                this.StoragePropertyWorkloadType = (string)(this.MyInvocation?.BoundParameters["StoragePropertyWorkloadType"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("StorageBillingPropertyBillingMode")))
            {
                this.StorageBillingPropertyBillingMode = (string)(this.MyInvocation?.BoundParameters["StorageBillingPropertyBillingMode"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("StorageBillingPropertySku")))
            {
                this.StorageBillingPropertySku = (string)(this.MyInvocation?.BoundParameters["StorageBillingPropertySku"]);
            }
        }
