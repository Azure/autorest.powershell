...
$dll = Join-Path $PSScriptRoot 'bin\Az.DeviceProvisioningServices.private.dll'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Az.DeviceProvisioningServices.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.DeviceProvisioningServices.psd1'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: DeviceProvisioningServices cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.DeviceProvisioningServices.format.ps1xml'
...
if (-not $DisableAfterBuildTasks){
  ...
  $afterBuildTasksArgs = ConvertFrom-Json '{"SubModuleName":"Az.DeviceProvisioningServices","ModuleRootName":"$(root-module-name)"}' -AsHashtable
