...
namespace Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] VerifyCertificate=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Devices/provisioningServices/{provisioningServiceName}/certificates/{certificateName}/verify"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Test, @"AzDeviceProvisioningServicesDpsCertificate_VerifyViaIdentity", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Description(@"Verifies the certificate's private key possession by providing the leaf cert issued by the verifying pre uploaded certificate.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Devices/provisioningServices/{provisioningServiceName}/certificates/{certificateName}/verify", ApiVersion = "2025-02-01-preview")]
    public partial class TestAzDeviceProvisioningServicesDpsCertificate_VerifyViaIdentity : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Runtime.IContext
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Indicates if the certificate contains private key.")]
        [Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Indicates if the certificate has been verified by owner of the private key.")]
        [Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Common Name for the certificate.")]
        [Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Describe the purpose of the certificate.")]
        [Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Raw data of certificate.")]
        [Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Models.IVerificationCodeRequest _request;

        /// <summary>The JSON-serialized leaf certificate</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The JSON-serialized leaf certificate", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"The JSON-serialized leaf certificate",
        SerializedName = @"request",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Models.IVerificationCodeRequest) })]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Models.IVerificationCodeRequest Request { get => this._request; set => this._request = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'DpsCertificateVerifyCertificate' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        await this.Client.DpsCertificateVerifyCertificate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ProvisioningServiceName ?? null, InputObject.CertificateName ?? null, IfMatch, this.InvocationInformation.BoundParameters.ContainsKey("CertificateName") ? CertificateName : null, this.InvocationInformation.BoundParameters.ContainsKey("CertificateRawByte") ? CertificateRawByte : null /* byte array */, this.InvocationInformation.BoundParameters.ContainsKey("CertificateIsVerified") ? CertificateIsVerified : default(global::System.Management.Automation.SwitchParameter?), this.InvocationInformation.BoundParameters.ContainsKey("CertificatePurpose") ? CertificatePurpose : null, this.InvocationInformation.BoundParameters.ContainsKey("CertificateCreated") ? CertificateCreated : default(global::System.DateTime?), this.InvocationInformation.BoundParameters.ContainsKey("CertificateLastUpdated") ? CertificateLastUpdated : default(global::System.DateTime?), this.InvocationInformation.BoundParameters.ContainsKey("CertificateHasPrivateKey") ? CertificateHasPrivateKey : default(global::System.Management.Automation.SwitchParameter?), this.InvocationInformation.BoundParameters.ContainsKey("CertificateNonce") ? CertificateNonce : null, Request, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TestAzDeviceProvisioningServicesDpsCertificate_VerifyViaIdentity" /> cmdlet
        /// class.
        /// </summary>
        public TestAzDeviceProvisioningServicesDpsCertificate_VerifyViaIdentity()
        {
