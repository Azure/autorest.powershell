...
namespace Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Devices/provisioningServices/{provisioningServiceName}/certificates/{certificateName}"
    /// [OpenAPI] CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Devices/provisioningServices/{provisioningServiceName}/certificates/{certificateName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzDeviceProvisioningServicesDpsCertificate_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Models.ICertificateResponse))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Description(@"Add new certificate or update an existing certificate.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Generated]
    public partial class UpdateAzDeviceProvisioningServicesDpsCertificate_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Models.ICertificateResponse _certificateDescriptionBody = new Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Models.CertificateResponse();
        ...
        internal byte[] Certificate { get => _certificateDescriptionBody.Certificate ?? null /* byte array */; set => _certificateDescriptionBody.Certificate = value; }

        /// <summary>
        /// Input File for Certificate (base-64 representation of X509 certificate .cer file or just .pem file content.)
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Input File for Certificate (base-64 representation of X509 certificate .cer file or just .pem file content.)")]
        ...
        public string CertificateInputFile
        {
         ...
         Certificate = global::System.IO.File.ReadAllBytes(paths[0]);
         }
        }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "ETag of the certificate. This is required to update an existing certificate, and ignored while creating a brand new certificate.")]
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Determines whether certificate has been verified.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Category(global::Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public global::System.Management.Automation.SwitchParameter IsVerified { get => _certificateDescriptionBody.IsVerified ?? default(global::System.Management.Automation.SwitchParameter); set => _certificateDescriptionBody.IsVerified = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Models.ICertificateResponse">Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Models.ICertificateResponse</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Models.ICertificateResponse> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'DpsCertificateCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        _certificateDescriptionBody = await this.Client.DpsCertificateGetViaIdentityWithResult(InputObject.Id, this, Pipeline);
                        this.Update_certificateDescriptionBody();
                        await this.Client.DpsCertificateCreateOrUpdateViaIdentity(InputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("IfMatch") ? IfMatch : null, _certificateDescriptionBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        _certificateDescriptionBody = await this.Client.DpsCertificateGetWithResult(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ProvisioningServiceName ?? null, InputObject.CertificateName ?? null, this, Pipeline);
                        this.Update_certificateDescriptionBody();
                        await this.Client.DpsCertificateCreateOrUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ProvisioningServiceName ?? null, InputObject.CertificateName ?? null, this.InvocationInformation.BoundParameters.ContainsKey("IfMatch") ? IfMatch : null, _certificateDescriptionBody, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Runtime.SerializationMode.IncludeCreate|Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzDeviceProvisioningServicesDpsCertificate_UpdateViaIdentityExpanded"
        /// /> cmdlet class.
        /// </summary>
        public UpdateAzDeviceProvisioningServicesDpsCertificate_UpdateViaIdentityExpanded()
        {

        }

        private void Update_certificateDescriptionBody()
        {
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("IsVerified")))
            {
                this.IsVerified = (global::System.Management.Automation.SwitchParameter)(this.MyInvocation?.BoundParameters["IsVerified"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("CertificateInputFile")))
            {
                this.CertificateInputFile = (string)(this.MyInvocation?.BoundParameters["CertificateInputFile"]);
            }
        }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Models.ICertificateResponse> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Models.ICertificateResponse
