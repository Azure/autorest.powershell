...
namespace Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListBySubscription=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.Devices/provisioningServices"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzDeviceProvisioningServicesIotDpsResource_List1")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Description(@"List all the provisioning services for a given subscription id.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Microsoft.Devices/provisioningServices", ApiVersion = "2025-02-01-preview")]
    public partial class GetAzDeviceProvisioningServicesIotDpsResource_List1 : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzDeviceProvisioningServicesIotDpsResource_List1" /> cmdlet class.
        /// </summary>
        public GetAzDeviceProvisioningServicesIotDpsResource_List1()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.IotDpsResourceListBySubscription(SubscriptionId, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.IotDpsResourceListBySubscription_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
