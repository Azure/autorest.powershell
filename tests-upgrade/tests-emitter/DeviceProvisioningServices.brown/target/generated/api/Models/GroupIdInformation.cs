...
namespace Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Models
{
    ...
    public partial class GroupIdInformation :
        Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Models.IGroupIdInformation,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Runtime.IValidates
    {
        ...
        public string GroupId { get => ((Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Models.IGroupIdInformationPropertiesInternal)Property).GroupId; set => ((Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Models.IGroupIdInformationPropertiesInternal)Property).GroupId = value ?? null; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Models.IGroupIdInformationProperties Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Models.IGroupIdInformationInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Models.GroupIdInformationProperties()); set { {_property = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Models.IGroupIdInformationProperties _property;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Models.IGroupIdInformationProperties Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Models.GroupIdInformationProperties()); set => this._property = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Models.IProxyResourceInternal
    {
        ...
        string GroupId { get; set; }
        /// <summary>The properties for a group information object</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.Models.IGroupIdInformationProperties Property { get; set; }
        /// <summary>The required members for a specific group id</summary>
        System.Collections.Generic.List<string> RequiredMember { get; set; }
        /// <summary>The required DNS zones for a specific group id</summary>
        System.Collections.Generic.List<string> RequiredZoneName { get; set; }
