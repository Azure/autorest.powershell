# Exports
This directory contains the cmdlets *exported by* `Az.DeviceProvisioningServices`. No other cmdlets in this repository are directly exported. What that means is the `Az.DeviceProvisioningServices` module will run [Export-ModuleMember](https://learn.microsoft.com/powershell/module/microsoft.powershell.core/export-modulemember) on the cmldets in this directory. The cmdlets in this directory are generated at **build-time**. Do not put any custom code, files, cmdlets, etc. into this directory. Please use `..\custom` for all custom implementation.
