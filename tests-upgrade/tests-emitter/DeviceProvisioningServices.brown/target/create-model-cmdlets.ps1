...
function CreateModelCmdlet {
    ...
    foreach ($Model in $Models)
    {
        ...
        if ($ObjectType.StartsWith('DeviceProvisioningServices')) {
            $ModulePrefix = ''
        } else {
            $ModulePrefix = 'DeviceProvisioningServices'
        }
...
#>
function ${cmdletName} {
    [Microsoft.Azure.PowerShell.Cmdlets.DeviceProvisioningServices.ModelCmdletAttribute()]
