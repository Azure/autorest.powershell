...
{
    using Microsoft.Azure.PowerShell.Cmdlets.HybridKubernetes.generated.runtime.Properties;
    using System;
    ...
    public class GenericBreakingChangeAttribute : Attribute
    {
        ...
        public string moduleName { get; set; } = String.IsNullOrEmpty(@"") ? @"Az.HybridKubernetes" : @"";
