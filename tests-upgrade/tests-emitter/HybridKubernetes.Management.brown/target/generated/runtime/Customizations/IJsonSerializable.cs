...
using Microsoft.Azure.PowerShell.Cmdlets.HybridKubernetes.Runtime.Json;
using System;
...
namespace Microsoft.Azure.PowerShell.Cmdlets.HybridKubernetes.Runtime
{
    ...
    internal static class JsonSerializable
    {
        ...
        internal static JsonNode ToJsonValue(object value)
        {
            ...
            if (value is Microsoft.Azure.PowerShell.Cmdlets.HybridKubernetes.Runtime.IJsonSerializable jsonSerializable)
            {
            ...
            {
                return Microsoft.Azure.PowerShell.Cmdlets.HybridKubernetes.Runtime.JsonSerializable.ToJson(dictionary, null);
            }
            ...
            if (value is System.Collections.Hashtable hashtable)
            {
                ...
                return Microsoft.Azure.PowerShell.Cmdlets.HybridKubernetes.Runtime.JsonSerializable.ToJson(dict, null);
            }
