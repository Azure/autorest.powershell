...
namespace Microsoft.Azure.PowerShell.Cmdlets.HybridKubernetes.Models
{
    ...
    public partial class CredentialResult :
        Microsoft.Azure.PowerShell.Cmdlets.HybridKubernetes.Models.ICredentialResult,
        Microsoft.Azure.PowerShell.Cmdlets.HybridKubernetes.Models.ICredentialResultInternal
    {

        /// <summary>Internal Acessors for Name</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.HybridKubernetes.Models.ICredentialResultInternal.Name { get => this._name; set { {_name = value;} } }

        /// <summary>Internal Acessors for Value</summary>
        byte[] Microsoft.Azure.PowerShell.Cmdlets.HybridKubernetes.Models.ICredentialResultInternal.Value { get => this._value; set { {_value = value;} } }
