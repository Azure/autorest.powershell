...
namespace Microsoft.Azure.PowerShell.Cmdlets.HybridKubernetes.Models
{
    ...
    public partial class HybridConnectionConfig :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.HybridKubernetes.Models.IHybridConnectionConfigInternal
    {
        ...
        long? Microsoft.Azure.PowerShell.Cmdlets.HybridKubernetes.Models.IHybridConnectionConfigInternal.ExpirationTime { get => this._expirationTime; set { {_expirationTime = value;} } }

        /// <summary>Internal Acessors for HybridConnectionName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.HybridKubernetes.Models.IHybridConnectionConfigInternal.HybridConnectionName { get => this._hybridConnectionName; set { {_hybridConnectionName = value;} } }

        /// <summary>Internal Acessors for Relay</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.HybridKubernetes.Models.IHybridConnectionConfigInternal.Relay { get => this._relay; set { {_relay = value;} } }

        /// <summary>Internal Acessors for RelayTid</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.HybridKubernetes.Models.IHybridConnectionConfigInternal.RelayTid { get => this._relayTid; set { {_relayTid = value;} } }

        /// <summary>Internal Acessors for RelayType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.HybridKubernetes.Models.IHybridConnectionConfigInternal.RelayType { get => this._relayType; set { {_relayType = value;} } }

        /// <summary>Internal Acessors for Token</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.HybridKubernetes.Models.IHybridConnectionConfigInternal.Token { get => this._token; set { {_token = value;} } }
