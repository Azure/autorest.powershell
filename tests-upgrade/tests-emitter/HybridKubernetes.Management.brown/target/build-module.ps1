...
$dll = Join-Path $PSScriptRoot 'bin\Az.HybridKubernetes.private.dll'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Az.HybridKubernetes.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.HybridKubernetes.psd1'
$guid = Get-ModuleGuid -Psd1Path $psd1
$moduleName = 'Az.HybridKubernetes'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: HybridKubernetes cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.HybridKubernetes.format.ps1xml'
...
if (-not $DisableAfterBuildTasks){
  ...
  $afterBuildTasksArgs = ConvertFrom-Json '{"SubModuleName":"Az.HybridKubernetes","ModuleRootName":"$(root-module-name)"}' -AsHashtable
