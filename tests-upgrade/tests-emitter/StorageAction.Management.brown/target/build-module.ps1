...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Az.StorageAction.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.StorageAction.psd1'
...
$modelCmdlets = @(@{modelName="StorageTaskOperation"; cmdletName="New-AzStorageActionTaskOperationObject"}, @{modelName="StorageTaskPreviewBlobProperties"; cmdletName="New-AzStorageActionTaskPreviewBlobPropertiesObject"}, @{modelName="StorageTaskPreviewKeyValueProperties"; cmdletName="New-AzStorageActionTaskPreviewKeyValuePropertiesObject"})
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: StorageAction cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.StorageAction.format.ps1xml'
...
if (-not $DisableAfterBuildTasks){
  ...
  $afterBuildTasksArgs = ConvertFrom-Json '{"SubModuleName":"Az.StorageAction","ModuleRootName":"$(root-module-name)"}' -AsHashtable
