...
$dll = Join-Path $PSScriptRoot 'bin\Az.RecoveryServicesDataReplication.private.dll'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Az.RecoveryServicesDataReplication.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.RecoveryServicesDataReplication.psd1'
$guid = Get-ModuleGuid -Psd1Path $psd1
$moduleName = 'Az.RecoveryServicesDataReplication'
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: RecoveryServicesDataReplication cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.RecoveryServicesDataReplication.format.ps1xml'
...
if (-not $DisableAfterBuildTasks){
  ...
  $afterBuildTasksArgs = ConvertFrom-Json '{"SubModuleName":"Az.RecoveryServicesDataReplication","ModuleRootName":"$(root-module-name)"}' -AsHashtable
