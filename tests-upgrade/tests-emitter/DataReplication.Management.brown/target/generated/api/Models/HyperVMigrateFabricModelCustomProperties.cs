...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesDataReplication.Models
{
    ...
    public partial class HyperVMigrateFabricModelCustomProperties :
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesDataReplication.Models.IHyperVMigrateFabricModelCustomProperties,
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesDataReplication.Models.IHyperVMigrateFabricModelCustomPropertiesInternal,
        Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesDataReplication.Runtime.IValidates
    {
        ...
        public string InstanceType { get => "HyperVMigrate"; set => ((Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesDataReplication.Models.IFabricModelCustomPropertiesInternal)__fabricModelCustomProperties).InstanceType = "HyperVMigrate"; }

        /// <summary>Internal Acessors for FabricContainerId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesDataReplication.Models.IHyperVMigrateFabricModelCustomPropertiesInternal.FabricContainerId { get => this._fabricContainerId; set { {_fabricContainerId = value;} } }

        /// <summary>Internal Acessors for FabricResourceId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesDataReplication.Models.IHyperVMigrateFabricModelCustomPropertiesInternal.FabricResourceId { get => this._fabricResourceId; set { {_fabricResourceId = value;} } }

        /// <summary>Internal Acessors for MigrationHubUri</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesDataReplication.Models.IHyperVMigrateFabricModelCustomPropertiesInternal.MigrationHubUri { get => this._migrationHubUri; set { {_migrationHubUri = value;} } }
