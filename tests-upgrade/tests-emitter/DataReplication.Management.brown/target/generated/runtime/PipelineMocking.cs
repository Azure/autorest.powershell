...
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesDataReplication.Runtime
{
    ...
    public class PipelineMock
    {
        ...
        public static implicit operator Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesDataReplication.Runtime.SendAsyncStep(PipelineMock instance) => instance.SendAsync;
