...
{
    using Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesDataReplication.generated.runtime.Properties;
    using System;
    ...
    public class GenericBreakingChangeAttribute : Attribute
    {
        ...
        public string moduleName { get; set; } = String.IsNullOrEmpty(@"") ? @"Az.RecoveryServicesDataReplication" : @"";
