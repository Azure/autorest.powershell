 ...
 *--------------------------------------------------------------------------------------------*/
namespace Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesDataReplication.Runtime.Json
{
    using System;
    ...
    {
        internal override object ToValue() => Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesDataReplication.Runtime.JsonSerializable.FromJson(this, new System.Collections.Generic.Dictionary<string, object>(), (obj) => obj.ToValue());
