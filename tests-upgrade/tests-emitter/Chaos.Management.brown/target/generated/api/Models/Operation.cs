...
namespace Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.IOperationInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.IOperationDisplay _display;

        /// <summary>Localized display information for this particular operation.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Chaos.Origin(Microsoft.Azure.PowerShell.Cmdlets.Chaos.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.IOperationDisplay Display { get => (this._display = this._display ?? new Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.OperationDisplay()); set => this._display = value; }
        ...
        public string DisplayDescription { get => ((Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.IOperationDisplayInternal)Display).Description; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Chaos.Origin(Microsoft.Azure.PowerShell.Cmdlets.Chaos.PropertyOrigin.Inlined)]
        public string DisplayOperation { get => ((Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.IOperationDisplayInternal)Display).Operation; }

        /// <summary>
        /// The localized friendly form of the resource provider name, e.g. "Microsoft Monitoring Insights" or "Microsoft Compute".
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Chaos.Origin(Microsoft.Azure.PowerShell.Cmdlets.Chaos.PropertyOrigin.Inlined)]
        public string DisplayProvider { get => ((Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.IOperationDisplayInternal)Display).Provider; }

        /// <summary>
        /// The localized friendly name of the resource type related to this operation. E.g. "Virtual Machines" or "Job Schedule Collections".
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Chaos.Origin(Microsoft.Azure.PowerShell.Cmdlets.Chaos.PropertyOrigin.Inlined)]
        public string DisplayResource { get => ((Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.IOperationDisplayInternal)Display).Resource; }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.IOperationInternal.ActionType { get => this._actionType; set { {_actionType = value;} } }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.IOperationInternal.Name { get => this._name; set { {_name = value;} } }

        /// <summary>Internal Acessors for Origin</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.IOperationInternal.Origin { get => this._origin; set { {_origin = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Chaos.Runtime.IJsonSerializable
    {
        ...
        [global::Microsoft.Azure.PowerShell.Cmdlets.Chaos.PSArgumentCompleterAttribute("Internal")]
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Chaos.PSArgumentCompleterAttribute("user", "system", "user,system")]
        string Origin { get;  }
...

    {
        ...
        /// <summary>Localized display information for this particular operation.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Chaos.Models.IOperationDisplay Display { get; set; }
        /// <summary>
        /// The short, localized friendly description of the operation; suitable for tool tips and detailed views.
        /// </summary>
