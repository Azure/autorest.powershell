...
namespace Microsoft.Azure.Sample.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the EventSourceUpdateParameters
        /// class.
        /// </summary>
        ...
        /// event source.</param>
        public EventSourceUpdateParameters(string tags = default(string))
        {
            this.Tags = tags;
            CustomInit();
        }
        ...
        /// <summary>
        /// Gets or sets key-value pairs of additional properties for the event
        /// source.
        /// </summary>
