...
namespace Microsoft.Azure.Sample.Models
{
    ...
    /// <summary>
    /// Parameters supplied to the Create or Update Event Source operation for
    /// an IoTHub event source.
    /// </summary>
    [Newtonsoft.Json.JsonObject("Microsoft.IoTHub")]
    [Microsoft.Rest.Serialization.JsonTransformation]
    public partial class IoTHubEventSourceCreateOrUpdateParameters : EventSourceCreateOrUpdateParameters
    {
        /// <summary>
        ...
        /// <param name="sharedAccessKey">The value of the Shared Access Policy
        /// key that grants the Time Series Insights service read access to the
        /// iot hub. This property is not shown in event source
        /// responses.</param>
        ...
        public IoTHubEventSourceCreateOrUpdateParameters(string location, string eventSourceResourceId, string iotHubName, string consumerGroupName, string keyName, string sharedAccessKey, string tags = default(string), ProvisioningState? provisioningState = default(ProvisioningState?), System.DateTime? creationTime = default(System.DateTime?), string timestampPropertyName = default(string))
            : base(location, tags)
        {
        ...
        /// <summary>
        /// Gets or sets the value of the Shared Access Policy key that grants
        ...
        public override void Validate()
        {
            ...
            {
                throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.CannotBeNull, "SharedAccessKey");
            }
        }
    }
}
