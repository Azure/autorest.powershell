...
namespace Microsoft.Azure.Sample.Models
{
    ...
    public partial class EventHubEventSourceResource : EventSourceResource
    {
        /// <summary>
        /// Initializes a new instance of the EventHubEventSourceResource
        /// class.
        /// </summary>
        ...
        public EventHubEventSourceResource(string location, string eventSourceResourceId, string serviceBusNamespace, string eventHubName, string consumerGroupName, string keyName, string id = default(string), string name = default(string), string type = default(string), string tags = default(string), ProvisioningState? provisioningState = default(ProvisioningState?), System.DateTime? creationTime = default(System.DateTime?), string timestampPropertyName = default(string), string sss = default(string))
        ...
        /// <summary>
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.sss")]
