...
namespace Microsoft.Azure.Sample.Models
{
    ...
    /// </summary>
    [Newtonsoft.Json.JsonObject("Microsoft.EventHub")]
    [Microsoft.Rest.Serialization.JsonTransformation]
    public partial class EventHubEventSourceCreateOrUpdateParameters : EventSourceCreateOrUpdateParameters
    {
        /// <summary>
        ...
        public EventHubEventSourceCreateOrUpdateParameters(string location, string eventSourceResourceId, string serviceBusNamespace, string eventHubName, string consumerGroupName, string keyName, string sharedAccessKey, string tags = default(string), ProvisioningState? provisioningState = default(ProvisioningState?), System.DateTime? creationTime = default(System.DateTime?), string timestampPropertyName = default(string))
            : base(location, tags)
        {
