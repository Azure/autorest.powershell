...
namespace Microsoft.Azure.Sample
{
    ...
    /// </summary>
    internal partial class ParameterGroupingOperations : Microsoft.Rest.IServiceOperations<DatabricksClient>, IParameterGroupingOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal ParameterGroupingOperations(DatabricksClient client)
        {
            if (client == null)
            {
