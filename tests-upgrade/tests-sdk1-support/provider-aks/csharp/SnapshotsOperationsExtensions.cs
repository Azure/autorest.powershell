...
namespace Microsoft.Azure.Management.ContainerService
{
    ...
    public static partial class SnapshotsOperationsExtensions
    {
            ...
            /// </param>
            public static Snapshot UpdateTags(this ISnapshotsOperations operations, string resourceGroupName, string resourceName, TagsObject parameters)
            {
                return ((ISnapshotsOperations)operations).UpdateTagsAsync(resourceGroupName, resourceName, parameters).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async System.Threading.Tasks.Task<Snapshot> UpdateTagsAsync(this ISnapshotsOperations operations, string resourceGroupName, string resourceName, TagsObject parameters, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
            {
