...
namespace Microsoft.Azure.Management.ContainerService.Models
{
    ...
    public partial class ContainerServiceNetworkProfile
    {
        ...
        public virtual void Validate()
        {
            ...
            if (this.DockerBridgeCidr != null)
            {
                if (!System.Text.RegularExpressions.Regex.IsMatch(this.DockerBridgeCidr, "^([0-9]{1,3}\\.){3}[0-9]{1,3}(\\/([0-9]|[1-2][0-9]|3[0-2]))?$"))
                {
                    throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.Pattern, "DockerBridgeCidr", "^([0-9]{1,3}\\.){3}[0-9]{1,3}(\\/([0-9]|[1-2][0-9]|3[0-2]))?$");
                }
            }
