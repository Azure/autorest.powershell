...
namespace Microsoft.Azure.Management.ContainerService
{
    ...
    internal partial class AgentPoolsOperations : Microsoft.Rest.IServiceOperations<ContainerServiceClient>, IAgentPoolsOperations
    {
        ...
        {
            // Send request
            Microsoft.Rest.Azure.AzureOperationResponse _response = await BeginDeleteWithHttpMessagesAsync(resourceGroupName, resourceName, agentPoolName, customHeaders, cancellationToken).ConfigureAwait(false);
