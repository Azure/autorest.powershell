...
namespace Microsoft.Azure.Management.ContainerRegistry
{
    ...
    public partial class ContainerRegistryManagementClient : Microsoft.Rest.ServiceClient<ContainerRegistryManagementClient>, IContainerRegistryManagementClient, IAzureClient
    {
        ...
        protected ContainerRegistryManagementClient(System.Net.Http.HttpClient httpClient, bool disposeHttpClient) : base(httpClient, disposeHttpClient)
        {
            this.Initialize();
        }
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public ContainerRegistryManagementClient(Microsoft.Rest.ServiceClientCredentials credentials, System.Net.Http.HttpClient httpClient, bool disposeHttpClient) : this(httpClient, disposeHttpClient)
        {
            if (credentials == null)
            {
                throw new System.ArgumentNullException("credentials");
        ...
        private void Initialize()
        {
            ...
            this.Replications = new ReplicationsOperations(this);
            this.Webhooks = new WebhooksOperations(this);
            this.Runs = new RunsOperations(this);
            ...
            SerializationSettings.Converters.Add(new Microsoft.Rest.Serialization.PolymorphicSerializeJsonConverter<RunRequest>("type"));
            DeserializationSettings.Converters.Add(new Microsoft.Rest.Serialization.PolymorphicDeserializeJsonConverter<RunRequest>("type"));
            SerializationSettings.Converters.Add(new Microsoft.Rest.Serialization.PolymorphicSerializeJsonConverter<TaskStepProperties>("type"));
            DeserializationSettings.Converters.Add(new Microsoft.Rest.Serialization.PolymorphicDeserializeJsonConverter<TaskStepProperties>("type"));
            SerializationSettings.Converters.Add(new Microsoft.Rest.Serialization.PolymorphicSerializeJsonConverter<TaskStepUpdateParameters>("type"));
            DeserializationSettings.Converters.Add(new Microsoft.Rest.Serialization.PolymorphicDeserializeJsonConverter<TaskStepUpdateParameters>("type"));
            CustomInitialize();
