...
namespace Microsoft.Azure.Management.ContainerRegistry.Models
{
    ...
    public partial class EncodedTaskStepUpdateParameters : TaskStepUpdateParameters
    {
        ...
        public EncodedTaskStepUpdateParameters(string contextPath = default(string), string contextAccessToken = default(string), string encodedTaskContent = default(string), string encodedValuesContent = default(string), System.Collections.Generic.IList<SetValue> values = default(System.Collections.Generic.IList<SetValue>))
