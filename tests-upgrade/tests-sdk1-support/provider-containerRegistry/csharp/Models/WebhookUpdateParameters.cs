...
namespace Microsoft.Azure.Management.ContainerRegistry.Models
{
    ...
    public partial class WebhookUpdateParameters
    {
        ...
        public WebhookUpdateParameters(System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), string serviceUri = default(string), System.Collections.Generic.IDictionary<string, string> customHeaders = default(System.Collections.Generic.IDictionary<string, string>), string status = default(string), string scope = default(string), System.Collections.Generic.IList<string> actions = default(System.Collections.Generic.IList<string>))
        {
            this.Tags = tags;
