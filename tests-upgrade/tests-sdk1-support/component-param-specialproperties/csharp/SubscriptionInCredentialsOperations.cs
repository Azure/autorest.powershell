...
namespace Microsoft.Azure.Sample
{
    ...
    /// </summary>
    internal partial class SubscriptionInCredentialsOperations : Microsoft.Rest.IServiceOperations<DatabricksClient>, ISubscriptionInCredentialsOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal SubscriptionInCredentialsOperations(DatabricksClient client)
        {
            if (client == null)
            {
