...
namespace Microsoft.Azure.Sample
{
    ...
    /// </summary>
    internal partial class HeaderOperations : Microsoft.Rest.IServiceOperations<DatabricksClient>, IHeaderOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal HeaderOperations(DatabricksClient client)
        {
            if (client == null)
            {
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<object, HeaderCustomNamedRequestIdHeadHeaders>> CustomNamedRequestIdHeadWithHttpMessagesAsync(string fooClientRequestId, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("fooClientRequestId", fooClientRequestId);
                tracingParameters.Add("cancellationToken", cancellationToken);
                Microsoft.Rest.ServiceClientTracing.Enter(_invocationId, this, "CustomNamedRequestIdHead", tracingParameters);
            }
            // Construct URL
            var _baseUrl = this.Client.BaseUri.AbsoluteUri;
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationResponse<object, HeaderCustomNamedRequestIdHeadHeaders>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            ...
            try
            {
                _result.Headers = _httpResponse.GetHeadersAsJson().ToObject<HeaderCustomNamedRequestIdHeadHeaders>(Newtonsoft.Json.JsonSerializer.Create(this.Client.DeserializationSettings));
            }
            catch (Newtonsoft.Json.JsonException ex)
            {
                _httpRequest.Dispose();
