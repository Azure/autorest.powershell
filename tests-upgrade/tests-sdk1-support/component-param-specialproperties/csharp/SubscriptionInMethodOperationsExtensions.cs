...
namespace Microsoft.Azure.Sample
{
    ...
    public static partial class SubscriptionInMethodOperationsExtensions
    {
            ...
            {
                ((ISubscriptionInMethodOperations)operations).PostMethodLocalValidAsync(subscriptionId).GetAwaiter().GetResult();
            }
            ...
            {
                ((ISubscriptionInMethodOperations)operations).PostMethodLocalNullAsync(subscriptionId).GetAwaiter().GetResult();
            }
            ...
            {
                ((ISubscriptionInMethodOperations)operations).PostPathLocalValidAsync(subscriptionId).GetAwaiter().GetResult();
            }
            ...
            {
                ((ISubscriptionInMethodOperations)operations).PostSwaggerLocalValidAsync(subscriptionId).GetAwaiter().GetResult();
            }
