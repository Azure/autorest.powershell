...
namespace Microsoft.Azure.Sample
{
    ...
    public static partial class HeaderOperationsExtensions
    {
            ...
            {
                return ((IHeaderOperations)operations).CustomNamedRequestIdAsync(fooClientRequestId).GetAwaiter().GetResult();
            }
            ...
            {
                return ((IHeaderOperations)operations).CustomNamedRequestIdParamGroupingAsync(headerCustomNamedRequestIdParamGroupingParameters).GetAwaiter().GetResult();
            }
