...
namespace Microsoft.Azure.Sample
{
    ...
    /// </summary>
    internal partial class ApiVersionLocalOperations : Microsoft.Rest.IServiceOperations<DatabricksClient>, IApiVersionLocalOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal ApiVersionLocalOperations(DatabricksClient client)
        {
            if (client == null)
            {
