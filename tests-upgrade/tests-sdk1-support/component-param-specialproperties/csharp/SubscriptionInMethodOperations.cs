...
namespace Microsoft.Azure.Sample
{
    ...
    /// </summary>
    internal partial class SubscriptionInMethodOperations : Microsoft.Rest.IServiceOperations<DatabricksClient>, ISubscriptionInMethodOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal SubscriptionInMethodOperations(DatabricksClient client)
        {
            if (client == null)
            {
