...
namespace Microsoft.Azure.Sample
{
    ...
    /// </summary>
    internal partial class OdataOperations : Microsoft.Rest.IServiceOperations<DatabricksClient>, IOdataOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal OdataOperations(DatabricksClient client)
        {
            if (client == null)
            {
