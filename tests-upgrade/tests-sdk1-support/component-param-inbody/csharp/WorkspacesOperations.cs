...
namespace Microsoft.Azure.Sample
{
    ...
    internal partial class WorkspacesOperations : Microsoft.Rest.IServiceOperations<DatabricksClient>, IWorkspacesOperations
    {
        ...
        /// </return>
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse> CreateOrUpdateWithHttpMessagesAsync(Workspace workspace, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            if (workspace == null)
            {
                throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.CannotBeNull, "workspace");
            }
            // Tracing
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/workspaces").ToString();
            ...
            if(workspace != null)
            {
                _requestContent = Microsoft.Rest.Serialization.SafeJsonConvert.SerializeObject(workspace, this.Client.SerializationSettings);
