...
namespace Microsoft.Azure.Management.Storage
{
    ...
    public static partial class PrivateEndpointConnectionsOperationsExtensions
    {
            ...
            {
                return ((IPrivateEndpointConnectionsOperations)operations).PutAsync(resourceGroupName, accountName, privateEndpointConnectionName, properties).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async System.Threading.Tasks.Task<PrivateEndpointConnection> PutAsync(this IPrivateEndpointConnectionsOperations operations, string resourceGroupName, string accountName, string privateEndpointConnectionName, PrivateEndpointConnection properties, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
            {
