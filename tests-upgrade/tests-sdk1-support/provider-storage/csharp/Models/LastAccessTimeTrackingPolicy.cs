...
namespace Microsoft.Azure.Management.Storage.Models
{
    ...
    public partial class LastAccessTimeTrackingPolicy
    {
        ...
        /// only</param>
        public LastAccessTimeTrackingPolicy(bool enable, string name = default(string), int? trackingGranularityInDays = default(int?), System.Collections.Generic.IList<string> blobType = default(System.Collections.Generic.IList<string>))
        {
            this.Enable = enable;
            this.Name = name;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "trackingGranularityInDays")]
