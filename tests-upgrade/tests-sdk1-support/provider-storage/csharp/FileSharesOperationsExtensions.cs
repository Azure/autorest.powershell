...
namespace Microsoft.Azure.Management.Storage
{
    ...
    public static partial class FileSharesOperationsExtensions
    {
            ...
            /// </param>
            public static void Restore(this IFileSharesOperations operations, string resourceGroupName, string accountName, string shareName, DeletedShare deletedShare)
            {
                ((IFileSharesOperations)operations).RestoreAsync(resourceGroupName, accountName, shareName, deletedShare).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async System.Threading.Tasks.Task RestoreAsync(this IFileSharesOperations operations, string resourceGroupName, string accountName, string shareName, DeletedShare deletedShare, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
            {
                (await operations.RestoreWithHttpMessagesAsync(resourceGroupName, accountName, shareName, deletedShare, null, cancellationToken).ConfigureAwait(false)).Dispose();
            }
