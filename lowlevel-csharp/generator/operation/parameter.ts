...
import { State } from "#lowlevel-csharp/generator/generator";
...
export const undefinedType: TypeDeclaration = new mscorlib.LibraryType("undefined");
...
export class CallbackParameter extends Parameter {
  ...
  public static async create(parent: Method, name: string, bodyType: codemodel.Schema | undefined  /*, headerType: codemodel.Schema*/, state: State): Promise<CallbackParameter> {
    ...
    const onResponseType = new mscorlib.LibraryType(`onResponse<${body.use},${header.use}>`);
