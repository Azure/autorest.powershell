...
Table is the default output format of cmdlets generated by autorest.powershell. Check out [these guidelines](https://github.com/Azure/azure-powershell/blob/main/documentation/development-docs/design-guidelines/cmdlet-best-practices.md#output-format) to design the output format.
