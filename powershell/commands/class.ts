...
type PreProcess = ((cmdlet: CommandClass, pathParameters: Array<Expression>, nonPathParameters: Array<Expression | Property>, viaIdentity: boolean) => Statements) | undefined;
type ProcessGetResponse = ((cmdlet: CommandClass) => Statements) | undefined;
export class CommandClass extends Class {
  ...
  private ManagedUserAssignedIdentityPreProcess(cmdlet: CommandClass, pathParams: Array<Expression> = [], nonPathParams: Array<Expression> = [], viaIdentity = false): Statements {
    const $this = cmdlet;
  ...
  private ManagedIdentityPreProcessForNewVerbCmdlet(cmdlet: CommandClass, pathParams: Array<Expression>, nonPathParams: Array<Expression>, viaIdentity: boolean): Statements {
    const $this = cmdlet;
  ...
  private ProcessGetResponseForManagedIdentityUpdateCmdlet(cmdlet: CommandClass): Statements {
    const $this = cmdlet;
  ...
  private ManagedIdentityUpdateCmdletPreProcess(cmdlet: CommandClass, pathParams: Array<Expression>, nonPathParams: Array<Expression>, viaIdentity: boolean): Statements {
  ...
  private GetPutPreProcess(cmdlet: CommandClass, pathParams: Array<Expression>, nonPathParams: Array<Expression>, viaIdentity: boolean, processGetResponse: ProcessGetResponse = undefined): Statements {
    const $this = cmdlet;
