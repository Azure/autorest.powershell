...
export function objectWithFormat(schema: Schema, state: NewState): boolean {
...
export function schemaHasEnum(schema: Schema, state: NewState): boolean {
...
export function hasXmsEnum(schema: Schema, state: NewState): boolean {
  if (length(schema.enum) > 0) {
...
export function arrayMissingItems(schema: Schema, state: NewState): boolean {
