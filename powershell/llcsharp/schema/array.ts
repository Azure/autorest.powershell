...
export class NewArrayOf implements NewEnhancedTypeDeclaration {
  public isXmlAttribute = false;
  public isNullable = true;
  get defaultOfType() {
    return toExpression('null /* arrayOf */');
  ...
  constructor(public schema: NewSchema, public isRequired: boolean, public elementType: NewEnhancedTypeDeclaration, protected minItems: number | undefined, protected maxItems: number | undefined, protected unique: boolean | undefined) {
  }
