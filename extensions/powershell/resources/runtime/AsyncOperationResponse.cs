namespace Microsoft.Rest.ClientRuntime.PowerShell
{
    ...
    public class AsyncOperationResponse
    {
        ...
        internal AsyncOperationResponse(Carbon.Json.JsonObject json)
        {
            // pull target 
            { Target = If(json?.PropertyT<Carbon.Json.JsonString>("target"), out var _v) ? (string)_v : (string)Target; }
        }
        ...
        public static AsyncOperationResponse FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new AsyncOperationResponse(json) : null;
        }
        ...
        public static AsyncOperationResponse FromJsonString(string jsonText) => FromJson(Carbon.Json.JsonNode.Parse(jsonText));
    ...
    public partial class AsyncOperationResponseTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static bool CanConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                ...
                return true == text?.StartsWith("{") && true == text?.EndsWith("}") && Carbon.Json.JsonNode.Parse(text).Type == Microsoft.Rest.ClientRuntime.Json.JsonType.Object;
            }
            catch
            {
